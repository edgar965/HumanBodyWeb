# -*- coding: utf-8 -*-
"""Effektbefehl — die Kommandozeile fuer den Unterprozess eines Effektauftrags.
...
class Effektbefehl:
    ...
    def parameter(self):
        ...
        return Effektparameter(
            bvh=self.auftrag.bvh_pfad, kleid=self.auftrag.kleid, ausgabe=self.auftrag.ausgabe, **werte
        )
