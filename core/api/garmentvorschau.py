# -*- coding: utf-8 -*-
"""Vorschau 3D — ein Schnitt am Körper, ohne Simulation.
...
class Garmentvorschauendpunkte:
    """Der schnelle 3D-Blick auf einen fertigen Schnitt."""
    ...
    @staticmethod
    def _koerper(wunsch):
        """Punkte (m, Y oben) und Dreiecke des Körpers, auf dem gerechnet wird.
    ...
    def _figurkoerper(wunsch):
        """Die OBJ der Szenenfigur: Netz aus Morphs, vermessen, abgelegt."""
    ...
    @staticmethod
    def _referenz(name):
        """Die OBJ eines Referenzkörpers — im Upstream oder als geformte
