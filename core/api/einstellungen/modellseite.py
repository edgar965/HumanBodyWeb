...
class ModellEinstellungen(Einstellungsseite):
    ...
    def uebernehmen(self, s, post):
        ...
        s.progress_update_interval = F.zahl(post, 'progress_update_interval', 50, mini=1, ganz=True)
    ...
    def kontext(self, s):
        return {
            ...
            **Animationsauswahl().seitenteil([s.default_anim_config, s.default_anim_animations]),
        }
