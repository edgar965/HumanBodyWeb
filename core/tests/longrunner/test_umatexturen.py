# -*- coding: utf-8 -*-
"""Die Overlay-Texturen einer UMA-Python-Figur.
...
class Texturen(unittest.TestCase):
    ...
    def _bilder(self):
        ...
        return Umatexturen(self.projektfigur().katalog, self.projektfigur().verweise).fuer_gebaut(self.bau())

    def test_jeder_slot_hat_eine_albedo(self):
        """Alle acht — Körper, Wimpern, Augen, Innenmund."""
        bilder = self._bilder()
    ...
    def test_die_uv_liegen_je_slot_in_null_bis_eins(self):
        """Deshalb braucht es keinen UDIM-Kachelversatz.
    ...
    def test_die_antwort_nennt_die_arten_nicht_die_pfade(self):
        """Ein Pfad in der JSON-Antwort wäre eine Einladung, ihn zu raten."""
