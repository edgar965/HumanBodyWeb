# -*- coding: utf-8 -*-
"""Zwei Quellen fuer denselben Ort duerfen nicht auseinanderlaufen.
...
class MhpfadeTest(SimpleTestCase):
    ...
    def test_der_bestand_liegt_da(self):
        ...
        self.assertTrue(Mhpfade.kleider_vorhanden(), Mhpfade.kleiderbibliothek())

    def test_umlenken_und_zuruecksetzen(self):
        """Beide Angaben muessen zurueckkommen.
        ...
        self.assertEqual(str(Mhpfade.kleiderbibliothek()), str(settings.HUMANBODY_GARMENT_LIBRARY_DIR))

    def test_das_paket_fragt_kein_django(self):
        """Die eigentliche Aussage des Umzugs — und sie ist pruefbar.
