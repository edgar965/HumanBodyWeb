# -*- coding: utf-8 -*-
"""SMPL-X-Modell: Eltern, A-Haltung, Hautgewichte, Regler-Vorzeichen, Segmentierung.
...
class SmplxModellTest(unittest.TestCase):
    ...
    def _naechste_mm(a, b):
        ...
        abstand, _ = cKDTree(SmplxModellTest._zentriert(b)).query(
            SmplxModellTest._zentriert(a), k=1, workers=-1
        )
