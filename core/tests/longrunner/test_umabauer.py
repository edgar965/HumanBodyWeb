# -*- coding: utf-8 -*-
"""Umabauer und die Bau-Endpunkte — mit einer Unity-Attrappe im Auftragsmodus (06.09.2026).
...
class UmabauerTest(SimpleTestCase):
    """Dienst und Endpunkte gegen die Attrappe."""
    ...
    def _abwarten(self, name=None):
        """Bis kein Lauf mehr läuft; liefert den letzten Stand des genannten Laufs."""
        stand = None
