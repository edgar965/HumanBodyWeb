# -*- coding: utf-8 -*-
"""Kein Backslash, den Python spaeter anders liest.
...
class JedeEigeneDatei(unittest.TestCase):
    """Keine Datei traegt eine ungueltige Escape-Sequenz."""
    ...
    def test_jeder_baum_liegt_da_wo_er_steht(self):
        """Ein verschobener Ordner faellt sonst STILL aus der Pruefung.
