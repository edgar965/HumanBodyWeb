# -*- coding: utf-8 -*-
"""Die Passform-Voreinstellungen — zeigen sie nur, was auch wirkt?
...
class PassformTest(SimpleTestCase):
    """Die Voreinstellungen fuer das ganze Kleidungsstueck."""
    ...
    def test_gegenprobe_ohne_filter_kaemen_tote_werte_durch(self):
        """Sabotage: Ohne die meta-Pruefung stuenden sie im Kleid.
    ...
    def _bereiche(self, vorlage):
        """Pfad -> (unten, oben), nur fuer Zahlenregler."""
        werte = {}
