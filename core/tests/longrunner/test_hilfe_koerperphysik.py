# -*- coding: utf-8 -*-
"""Hilfe → Kleidung → Körperphysik: die Seite steht, ihre Zahlen kommen aus Python.
...
class KoerperphysikDatenStehenInPython(unittest.TestCase):
    ...
    def test_die_drei_baustellen_sind_getrennt(self):
        """A, B und C brauchen verschiedene Lösungen — deshalb stehen sie
    ...
    def test_jede_pruefung_fuehrt_ihre_gegenprobe(self):
        """Eine Probe ohne Gegenprobe kann blind sein. Genau das ist hier
