# -*- coding: utf-8 -*-
"""Kleidung, die der Figur folgt — MakeHuman und GarmentCode/SMPL.
...
class MhkleidHautTest(unittest.TestCase):
    ...
    def test_die_knochen_sind_die_des_rigs(self):
        """Der Browser loest NAMEN auf — ein fremder Name bindet gar nicht."""
    ...
    def test_stuecke_der_bibliothek_bekommen_alle_gewichte(self):
        """Gemessen 162 von 181 (11.09.2026), 147 von 164 (17.09.2026 — die
...
class SmplTraegerTest(unittest.TestCase):
    ...
    def test_der_traeger_liegt_in_projektkoordinaten(self):
        """m, Z oben — so liest `Anziehen.netz_lesen` das Stoffnetz.
    ...
    def test_die_knochennamen_passen_zum_skelett_der_figur(self):
        """Der Browser ordnet ueber Namen zu — sonst bindet nichts."""
