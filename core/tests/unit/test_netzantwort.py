...
class NetzantwortTest(SimpleTestCase):
    ...
    def test_dreiecke_als_uint32(self):
        ...
        self.assertEqual(list(self.zurueck(antwort['faces'], np.uint32)), [0, 1, 2, 2, 3, 0])
    ...
    def test_nicht_zusammenhaengendes_feld(self):
        ...
        self.assertEqual(list(self.zurueck(antwort['faces'], np.uint32)), [0, 2, 1, 4, 6, 5])
    ...
    def test_weitere_felder_kommen_mit(self):
        ...
        self.assertEqual(list(self.zurueck(antwort['skin_weights'], np.float32)), [0.5, 0.5, 0.0, 0.0])
    ...
    def test_face_count_zaehlt_dreiecke_nicht_vierecke(self):
        ...
        self.assertEqual(Netzantwort.aus(np.zeros((4, 3)), faces=dreiecke)['face_count'], 12)
