# -*- coding: utf-8 -*-
"""Modellvorlagen — die Modellnamen ohne die Szenen.
...
class ModellvorlagenTest(SimpleTestCase):
    ...
    def _mit_ordner(self, dateien):
        """Ein Modellordner mit genau diesen Dateien, als Kontextverwalter."""
    ...
    def test_szenen_stehen_nicht_in_der_liste(self):
        self._mit_ordner(['Zimmer.scene.json', 'Female1.json', 'Rig2.json', 'Notiz.txt'])
