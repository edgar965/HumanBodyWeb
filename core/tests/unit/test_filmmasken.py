# -*- coding: utf-8 -*-
"""`Filmmasken` und `Feinkoerper`: Der Server-Videoweg rendert die Haut
...
class _Haut:
    def __init__(self, punkte, bilder=2):
        ...
        self.folge = np.array([self.punkte + np.array([0.0, 0.001 * k, 0.0]) for k in range(bilder)])


class _Unterteiler:
    """Verdoppelt nichts — schiebt nur um 1 mm, damit man den Weg sieht."""
