# -*- coding: utf-8 -*-
"""Die Spuren eines Retargets kommen immer in derselben Reihenfolge.
...
class ReihenfolgeTest(SimpleTestCase):
    """Die zugeordneten Knochen liegen geordnet, nicht in einem Set."""
...
class _Skelett:
    """Gerade so viel Skelett, wie `_zuordnung_bauen` anfasst."""
