# -*- coding: utf-8 -*-
"""Unsere eigenen Simulationsvorgaben gegen GarmentCodes.
...
class DerReglerZeigtWasWirklichGilt(TestCase):
    """Vorgabeklasse und Feldkatalog nennen dieselbe Zahl."""
    ...
    def test_der_kollisionsabstand_ist_kleiner_als_bei_garmentcode(self):
        """Das ist der ganze Zweck der Klasse.
...
class DerReglerGewinntGegenDieVorgabe(TestCase):
    """Wer von Hand stellt, bekommt seinen Wert — sonst waere es ein
...
class AufDemReferenzkoerperGiltGarmentCode(TestCase):
    """Der SMPL-Weg soll dem Online-Tool gleichen — das ist seine einzige
