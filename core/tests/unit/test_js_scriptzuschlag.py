# -*- coding: utf-8 -*-
u"""`Scriptzuschlag`: Was die Script-Clips eines Modells an einem Bild beitragen.
...
class ScriptzuschlagTest(SimpleTestCase):
    ...
    def test_modellmenue_zweigeteilt_und_scriptspur_verdrahtet(self):
        ...
        script = vorlage[vorlage.index('id="script-context-menu"'):
                         vorlage.index('id="mimik-context-menu"')]
