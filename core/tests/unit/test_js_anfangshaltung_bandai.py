# -*- coding: utf-8 -*-
"""`Anfangshaltung`, Bandai: die Wurzelbewegung sitzt an den Hüften.
...
class DerBandaiSonderfall(SimpleTestCase):
    """Gegeben: Wurzel und Hüften, beide mit Ortsspur."""
...
"""
    ...
    def test_bei_einem_anderen_format_bleibt_alles(self):
        """Die Gegenprobe: Nur Bandai legt zusammen."""
        self.assertEqual(
            MODUL.laufen(
                SKELETT
                + BANDAI_AUFBAU
...
"""
    ...
    def test_ohne_direkte_elternschaft_passiert_nichts(self):
        """Hängt `Hips` nicht unmittelbar an der Wurzel, ist es ein anderes
...
"""
    ...
    def test_ungleich_lange_spuren_brechen_nicht(self):
        """Kopiert wird nur, so weit BEIDE reichen — sonst schriebe die
