# -*- coding: utf-8 -*-
u"""Auftragskennung: Datum und Uhrzeit als Adresse der Auftragsseiten.
...
class AuftragskennungTest(SimpleTestCase):
    ...
    def test_kennung_ist_die_ortszeit_auf_die_sekunde(self):
        ...
        self.assertEqual(Auftragskennung.aus(datetime(2026, 1, 5, 7, 8, 9)),
                         '2026.01.05.07.08.09')
    ...
    def test_zwei_auftraege_in_einer_sekunde_ruecken_auf(self):
        ...
        self.assertEqual((erste, zweite, dritte),
                         ('2026.09.16.22.00.12', '2026.09.16.22.00.13',
                          '2026.09.16.22.00.14'))
    ...
    def test_konverter_nimmt_nur_die_kennungsform(self):
        ...
        for falsch in ('75b11525-e8ca-4fdb-903f-28467c7db670', '2026.09.16',
                       '2026-09-16-22-00-12', '2026.09.16.22.00.12x', ''):
    ...
    def test_urls_seiten_und_tabelle_nennen_die_kennung(self):
        ...
        for vorlage, marken in (
                ('job_status.html', ("{% url 'start_processing' job.kennung %}",
                                     "{% url 'job_result' job.kennung %}")),
