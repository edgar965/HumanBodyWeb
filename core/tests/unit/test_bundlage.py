# -*- coding: utf-8 -*-
"""Der Bund sitzt in der 2D-Vorschau auf dem Unterteil (11.09.2026).
...
class BundlageTest(SimpleTestCase):
    ...
    def test_der_bund_faellt_auf_die_oberkante_der_hose(self):
        ...
        panels = [
            BundlageTest._panel("pant_f_r", -0.2, 0.0, 0.08, 1.00, 0.25),
        ...
        naehte = [
            BundlageTest._naht("wb_front", "pant_f_r"),
            BundlageTest._naht("wb_back", "pant_b_r"),
    ...
    def test_ein_bund_ueber_dem_rumpf_wird_nicht_an_den_rumpf_gezogen(self):
        """Kleid: der Bund haengt oben am Rumpf UND unten am Rock. Er faellt
        auf den Rock, nicht an den Rumpf (der liegt ueber ihm)."""
        panels = [
            BundlageTest._panel("ftorso", -0.2, 0.2, 1.10, 1.40),
    ...
    def test_ohne_luecke_oder_ohne_naehte_passiert_nichts(self):
        panels = [
            BundlageTest._panel("pant_f_r", -0.2, 0.0, 0.08, 1.06),
    ...
    def test_die_vorschau_senkt_nur_auf_wunsch(self):
        ...
        quelle = io.open(settings.BASE_DIR / "core" / "api" / "schnittvorschau.py", encoding="utf-8").read()
