# -*- coding: utf-8 -*-
"""`Fehlerkurzfassung`: die eine Zeile, die in die Auftragsliste passt.
...
class KurzfassungTest(SimpleTestCase):
    ...
    def test_ersatztext_wenn_gar_nichts_brauchbar_ist(self):
        """Ein abgeschnittener Traceback ohne Vorspann — die Liste zeigt
...
class AmModellTest(SimpleTestCase):
    """Die Eigenschaft am Auftrag benutzt dieselbe Rechnung."""
