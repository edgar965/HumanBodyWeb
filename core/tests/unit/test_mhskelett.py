# -*- coding: utf-8 -*-
"""Mhskelett — das Rig, das MakeHuman selbst mitbringt.
...
class MhskelettTest(unittest.TestCase):
    ...
    def test_alle_knochen_der_datei_kommen_an(self):
        """163 Knochen — keiner faellt an fehlenden Gelenken heraus.
    ...
    def test_skelett_folgt_dem_groessenregler(self):
        """Der eigentliche Beleg: kleine Figur, kleines Skelett.
    ...
    def test_gegenprobe_ohne_formung_bleibt_es_gleich(self):
        """Ohne Regler darf sich NICHTS bewegen.
