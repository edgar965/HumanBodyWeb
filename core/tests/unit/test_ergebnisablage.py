# -*- coding: utf-8 -*-
u"""`Ergebnisablage`: die fertige BVH in den Bibliotheksordner `A_Results`.
...
class ErgebnisablageTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.auftrag = SimpleNamespace(name='005 DanceLang.mp4', pipeline='smplx',
                                       bvh_file=str(self.quelle))
    ...
    def test_pfad_und_kopieren(self):
        with override_settings(BVH_RESULTS_DIR=str(self.ziel)):
            ...
            kopie = Ergebnisablage.kopieren(str(self.quelle), '005 DanceLang.mp4',
                                            'smplx')
    ...
    def test_kopie_von_nur_wenn_sie_liegt(self):
        with override_settings(BVH_RESULTS_DIR=str(self.ziel)):
            ...
            self.assertEqual(Ergebnisablage.kopie_von(self.auftrag),
                             str(self.ziel / '005 DanceLang_smplx.bvh'))
