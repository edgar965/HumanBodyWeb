# -*- coding: utf-8 -*-
"""Ein Klick ins Leere wählt die Figur nicht ab — geprüft am Quelltext.
...
def _code(quelle):
    """Nur Codezeilen: Der Kommentar an der Stelle nennt die alte Zeile mit
...
class DerLeerklickBehaeltDieFigurTest(SimpleTestCase):
    ...
    def test_der_leerklick_loest_nur_die_markierung(self):
        """Teilnetz- und Knochenmarkierung gehen weg, die Figur bleibt."""
