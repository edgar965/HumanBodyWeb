# -*- coding: utf-8 -*-
"""Skriptbaum — die Skripte neben dem Projekt und ihre Importe.
...
class Skriptbaum:
    """Findet die Skripte und loest ihre Modulebenen-Importe auf."""
    ...
    @classmethod
    def dateien(cls):
        """Jede `.py`-Datei der geprueften Ordner, sortiert."""
    ...
    def importzeilen(baum):
        """(Modul, Name, Zeile) je Import auf Modulebene.
    ...
    def _gibt_es(cls, modul, name):
        """Laesst sich `from <modul> import <name>` aufloesen?
    ...
    def unaufloesbar(cls):
        """[(Datei:Zeile, Import, Grund)] — jeder tote Modulebenen-Import."""
        tot = []
    ...
    @classmethod
    def geprueft(cls):
        """Wie viele eigene Importzeilen ueberhaupt angesehen werden.
