# -*- coding: utf-8 -*-
"""Findet Bedienelemente, die kein Skript je anfasst.
...
class Bedienelemente:
    ...
    def kette(self, start):
        """Die Seite und alles, was sie einbindet — rekursiv."""
        offen, gesehen = [start], []
        while offen:
            name = offen.pop()
    ...
    def verzeichnis(code):
        """Den Code EINMAL zerlegen statt je Kennung zu durchsuchen.
    ...
    def ueber_marke(marken, waehler):
        """Greift ein Skript das Element über Klasse oder data-Attribut?
    ...
    def _grundindex(self):
        """Verzeichnis und Wähler des GEMEINSAMEN Codes — einmal je Lauf.
    ...
    def ohne_hoerer(self, seite):
        """Die Kennungen dieser Seite, die kein Skript anfasst."""
