# -*- coding: utf-8 -*-
"""Kein ES-Modul benutzt einen Namen, den es weder importiert noch definiert.
...
BEKANNT: set = set(
    """THREE JSON Math Object Number Array Promise Date String Boolean
...
class Jsimporte:
    """Findet in einem Modul die grossen Namen ohne Import und Definition."""
