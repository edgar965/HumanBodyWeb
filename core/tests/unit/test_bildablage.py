# -*- coding: utf-8 -*-
"""`Bildablage` — die drei Fälle einer Data-URL, und wohin die Datei kommt.
...
class BytesAusDataurlTest(SimpleTestCase):
    ...
    def test_auch_ohne_vorspann(self):
        """Manche Aufrufer schicken nur den Base64-Teil."""
        self.assertEqual(ROH, Bildablage.bytes_aus_dataurl(base64.b64encode(ROH).decode()))
...
class SichernAusDataurlTest(SimpleTestCase):
    """Der Weg, den beide Endpunkte gehen — in einem Wegwerf-Verzeichnis."""
