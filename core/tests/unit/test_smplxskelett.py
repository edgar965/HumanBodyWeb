# -*- coding: utf-8 -*-
"""SMPL-X-Skelett: Namen, Eltern, Retarget-Zuordnung, Segmentierungsuebertrag.
...
class SmplxskelettTest(SimpleTestCase):
    ...
    def test_eltern_gesicht_am_kopf_finger_am_handgelenk(self):
        ...
        self.assertTrue(all(e < i for i, e in enumerate(eltern)), 'Eltern stehen vor ihren Kindern')
