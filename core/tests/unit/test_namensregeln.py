# -*- coding: utf-8 -*-
"""Namensregeln — die drei Windows-Fallen, jede für sich.
...
from core.namensregeln import GERAETE, VERBOTEN, Namensregeln
...
class NamensregelnTest(unittest.TestCase):
    ...
    def grund(self, wert):
        """Der Ablehnungsgrund — und dass es einen gibt."""
