# -*- coding: utf-8 -*-
"""Der UMA-Klon als Quelle: wo er liegt, was er nach aussen zeigt.
...
class Umaquelle:
    """Der C#-Quelltext des Konformers und die Klassen des Ports."""
    ...
    def mitglieder(cls, text, klasse=None, privat=False):
        """Die Namen, die das Original nach aussen zeigt.
