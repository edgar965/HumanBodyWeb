# -*- coding: utf-8 -*-
"""AtomarSchreiber — ganz oder gar nicht, und die Windows-Sperre.
...
class AtomarSchreiberTest(unittest.TestCase):
    ...
    def test_json_kommt_an_und_nichts_bleibt_liegen(self):
        ...
        self.assertEqual(sorted(p.name for p in ziel.parent.iterdir()), ['projekt.studio.json'])
    ...
    def test_dauerhafte_sperre_laesst_das_original_stehen(self):
        ...
        with mock.patch('core.atomic_write.os.replace', side_effect=PermissionError('dauerhaft offen')):
