# -*- coding: utf-8 -*-
"""Schuhbau — einen Schuh gegen pygarment bauen, ohne Simulation.
...
class Schuhbau:
    """Entwurf und Körper einmal laden, dann beliebig oft bauen."""
    ...
    def vorbereiten(cls, fuss):
        """`fuss`: die Fussmasse (cm), die in den Körper gemischt werden."""
