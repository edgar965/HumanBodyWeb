# -*- coding: utf-8 -*-
u"""Hautverschiebung: MB-Labs Displacement-Formel und der Displace-Modifier.
...
class Formel(TestCase):
    ...
    BILD = np.array([[[0.5, 1.0, 0.0, 0.5], [0.2, 0.5, 1.0, 0.0]],
                     [[0.9, 0.0, 0.5, 1.0], [0.5, 0.5, 0.5, 0.5]]],
                    dtype=np.float32)
    ...
    def test_tonus_und_masse_teilen_sich_den_rest(self):
        ...
        erwartet = self.BILD[..., 0] + 0.5 * (self.BILD[..., 2] - 0.5) \
            + 0.5 * (self.BILD[..., 3] - 0.5)
...
class Modifier(TestCase):
    ...
    def test_abtastung_liest_unten_links_bei_uv_null(self):
        ...
        werte = Hautverschiebung.abtasten(textur, [[0.0, 0.0], [0.0, 1.0],
                                                   [0.5, 0.5]])
    ...
    def test_verschiebung_entlang_der_normale_mit_mitte(self):
        ...
        aus = Hautverschiebung.anwenden(punkte, normalen, uvs, textur,
                                        staerke=0.01)
