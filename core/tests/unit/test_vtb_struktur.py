# -*- coding: utf-8 -*-
"""Die Lehren, die der Wrapperbaum einhalten muss.
...
class KeineFestenPfade(unittest.TestCase):
    ...
    def test_die_pruefung_uebergeht_doku(self):
        """Und laesst den Docstring in Ruhe, der den Befund beschreibt."""
...
class KeineSystemablage(unittest.TestCase):
    ...
    def test_kein_zwischenspeicher_ohne_zielordner(self):
        """Auch `arbeitsablage.py` selbst — dort steht der einzige Aufruf.
    ...
    def test_die_arbeitsablage_liegt_im_projekt(self):
        """Verglichen werden PFADTEILE, nicht Zeichen.
...
class JederParameterWirkt(unittest.TestCase):
    """Ein entgegengenommener Wert, der nie gelesen wird, ist eine Luege.
