# -*- coding: utf-8 -*-
"""Quelltext einer Projektdatei lesen — fuer Pruefungen, die am Quelltext
...
class Quelltext:
    """Eine Datei relativ zum Projektstamm `A:\3DTools`, mit oder ohne Kommentare."""

    @staticmethod
    def lesen(*teile):
        """Ueber `settings.BASE_DIR` (`HumanBodyWeb`) und dessen Elternordner —
