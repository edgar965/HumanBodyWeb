# -*- coding: utf-8 -*-
u"""Theatre: Eine gemerkte Animation, die es nicht mehr gibt, blockiert nicht.
...
class TheatreAnimationFehltTest(SimpleTestCase):
    ...
    def test_404_ohne_alert_mit_hinweis_in_der_liste(self):
        ...
        self.assertLess(text.index('fehler.status === 404', fang),
    ...
    def test_bundle_ist_gebaut(self):
        u"""`npm run build` nach der Änderung — sonst läuft die alte Fassung."""
