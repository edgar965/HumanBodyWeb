...
urlpatterns = [
    ...
    path('api/character/retarget-bvh/<str:category>/<str:name>/', character_api.retarget_bvh, name='retarget_bvh'),
    path('api/character/retarget-merge/', character_api.retarget_merge, name='retarget_merge'),
    path('api/character/retarget-job/<uuid:job_id>/', character_api.retarget_job_bvh, name='retarget_job_bvh'),
