...
urlpatterns = [
    ...
    path('tests/', views.testcases_page, name='testcases'),
    path('api/tests/run/', views.run_testcases_api, name='run_testcases'),
    path('api/studio/theatre-presets/', character_api.studio_theatre_presets, name='studio_theatre_presets'),
    path('api/studio/theatre-preset/<str:name>/', character_api.studio_theatre_preset_detail, name='studio_theatre_preset_detail'),
    path('api/studio/scene-object-upload/', character_api.studio_scene_object_upload, name='studio_scene_object_upload'),
    path('api/studio/floor-textures/', character_api.studio_floor_textures, name='studio_floor_textures'),
