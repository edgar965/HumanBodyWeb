# -*- coding: utf-8 -*-
"""Die 3D- und Hybrid-Pipelines des Vergleichs (Hilfe -> Video to BVH).
...
class Pipelines3d:
    ...
    EINTRAEGE = [
        {
            "schluessel": "hybrid_gem",
            "art": "Hybrid",
            "rang": 1,
            "variante": "Finger aus GEM-X",
            "variante_kennung": "hands_source: gemx",
            "video": "hybrid_gem_gemx_skelett.mp4",
            ...
            "haende": True,
            "gesicht": True,
            "kamera": "statisch (Kameraraum)",
            "dauer_s": 348,
            "ueberlagerung_px": 24.3,
            "ruhe_wurzel": 3.1,
            "ruhe_pose": 0.20,
            "boden_cm": -103,
            "zustand": "laeuft",
            "zustand_grund": "",
            "vorteile": [
                "Der GEM-SMPL-Körper (24,3 px, Pose 0,20) plus 30 Fingerspuren aus derselben "
            ...
            "nachteile": [
                "Langsamste Pipeline: drei Läufe, GEM und GEM-X nacheinander auf der GPU (348 s)",
        ...
        },
        {
            ...
            "zustand_grund": "",
            "vorteile": [
                "Der GEM-SMPL-Körper (24,5 px) plus Gesicht und Hände",
                "v4 läuft parallel auf der CPU — nur 60 s länger als GEM-SMPL allein",
                "Gesicht aus SMPLest-X (seit 12.09.2026 wieder auf dem Rig): Kiefer als gemessene Drehung (hier max 2,8°, der Mund bleibt zu), 72 Marken im Video (gelb)",
            ],
            "nachteile": [
                "Hände aus MocapNET v4 (MediaPipe) — hier nicht gemessen (keine Referenz)",
                "Gesicht 37 px hoch im 720p-Bild — die zehn Ausdruckswerte drehen die Knochen um höchstens 0,9°, im Viewer kaum sichtbar",
                "Wurzel und Boden wie GEM-SMPL; Lizenz NVIDIA OneWay",
            ],
        ...
        },
        {
            ...
            "zustand_grund": "",
            "vorteile": [
                "Ruhigste Pose der SMPL-Familie (0,22)",
                "Deckung mit dem Video wie GVHMR (24,5 px)",
                "Schnellste SMPL-Pipeline (111 s)",
            ],
            "nachteile": [
                "Wurzel zittert wie GVHMR (3,1 cm/Bild²)",
        ...
        },
        {
            ...
            "zustand_grund": "",
            "vorteile": [
                "Beste Deckung mit dem Video (23,4 px)",
                "Bewährter Referenzweg, auch für bewegte Kameras (SLAM)",
                "Bildweise Vorstufe auch für lange Videos",
            ],
            "nachteile": [
                'Wurzel zittert (3,4 cm/Bild²) — die 6 m „Hüftweg" sind Rauschen',
                "Boden nicht bei y = 0",
                "Langsamste laufende 3D-Pipeline (159 s)",
                "Keine Hände, kein Gesicht",
            ],
        ...
        },
        {
            ...
            "zustand_grund": "",
            "vorteile": [
                "Vollständigste Ausgabe: Körper, Gesicht, Hände",
            ...
            "nachteile": [
                "Zwei Läufe hintereinander (145 s)",
        ...
        },
        {
            ...
            "zustand_grund": "",
            "vorteile": [
                "Finger im BVH (77 Gelenke, 38 davon Finger), Retarget legt sie auf 30 DEF-Knochen",
            ...
            "nachteile": [
                '„Ruhe Pose" 0,25 mittelt über alle 77 Gelenke, die Finger zittern mit',
        ...
        },
        {
            ...
            "zustand_grund": "",
            "vorteile": [
                "Der GEM-SMPL-Körper: Deckung 24,3 px wie GEM, Körper-Ruhe 0,187 cm/Bild² "
            ...
            "nachteile": [
                "431 s mit GEM-X-Fingern und Video (240 s mit SMPLest-X-Fingern ohne "
        ...
        },
        {
            ...
            "zustand_grund": "",
            "vorteile": [
                "Ruhigste Wurzelbahn aller Pipelines (0,2 cm/Bild²)",
                "Boden bei y = 0, physikalisch plausible Weltbahn",
                "Schnellste 3D-Pipeline (50 s)",
            ],
            "nachteile": [
                "Weltbahn weicht von der Kamerabahn ab: Deckung 41,6 px mit statischer Kamera, "
        ...
        },
        {
            ...
            "haende": True,
            "gesicht": True,
            "kamera": "statisch (MocapNET-Kamera)",
            "dauer_s": 46,
            "ueberlagerung_px": 31.6,
            "ruhe_wurzel": 0.55,
            "ruhe_pose": 1.02,
            "boden_cm": -90,
            "zustand": "laeuft",
            "zustand_grund": "",
            "vorteile": [
                "Schnell (46 s), läuft ohne CUDA-Bibliotheken (ONNX)",
                "Volles Rig: Gesicht, Hände, Zehen in einer Datei",
                "Median der Deckung so gut wie SMPL (21 px)",
            ],
            "nachteile": [
                "Pose viermal so unruhig wie die SMPL-Familie (1,0 cm/Bild²)",
