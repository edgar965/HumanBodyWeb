# -*- coding: utf-8 -*-
u"""Mimikvorschau — ein Kopfbild je Pose für den Dialog „Pose setzen".
...
class Mimikvorschau:
    ...
    def verschoben(self, gewichte):
        u"""Das Netz mit den Verschiebungen der Pose (Blender-Achsen)."""
    ...
    def _rendern(self, renderer, punkte):
        ...
        szene = pyrender.Scene(bg_color=(0.10, 0.10, 0.18, 1.0),
