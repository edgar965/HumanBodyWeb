# -*- coding: utf-8 -*-
"""Die 2D-Pipelines des Vergleichs (Hilfe -> Video to BVH): ein 2D-Erkenner
...
class Pipelines2d:
    ...
    BILDRATE = (
        'BVH nennt 25 fps (Frame Time 0,04) bei einem 60-fps-Video — v4 korrigiert das, der v2.1-Weg nicht'
    )

    # Dictionary gewollt: geht ueber `Pipelinevergleich.alle()` in die Vorlage.
    EINTRAEGE = [
        {
            'schluessel': 'mediapipe',
            'art': '2D + Lifter',
            'rang': 10,
            ...
            'zustand_grund': '',
            'vorteile': [
                'Schnell (53 s), reine CPU-Erkennung',
                'Beste Deckung der 2D-Wege (30,6 px, Median 16)',
                'Volles MocapNET-Rig mit Gesicht und Händen',
            ],
            'nachteile': [
                'Links und rechts vertauscht gegenüber ViTPose (gemessen)',
        ...
        },
        {
            ...
            'kamera': 'statisch (MocapNET-Kamera)',
            'dauer_s': 164,
            'ueberlagerung_px': 78.1,
            'ruhe_wurzel': 3.57,
            'ruhe_pose': 3.08,
            'boden_cm': -102,
            'zustand': 'laeuft',
            'zustand_grund': '',
            'vorteile': ['Median der Deckung so gut wie SMPL (15 px)', 'Kein MediaPipe nötig'],
            'nachteile': [
                'Einzelne Bilder fliegen weg: Mittel 78 px bei Median 15, Hüftweg 19 m',
                'Langsamster laufender 2D-Weg (164 s)',
                BILDRATE,
                LIFTER,
            ],
        ...
        },
        {
            ...
            'nachteile': [
                'CSV und BVH sind Byte für Byte dieselben wie bei RTMPose — kein eigener Erkenner',
                BILDRATE,
                LIFTER,
            ],
        ...
        },
        {
            ...
            'nachteile': [
                'Schlechteste Deckung (113 px im Mittel, Median 22), Hüftweg 27 m',
                'Unruhigste Wurzel (5,9 cm/Bild²)',
                BILDRATE,
                LIFTER,
            ],
