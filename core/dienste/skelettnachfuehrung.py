# -*- coding: utf-8 -*-
"""Skelettnachfuehrung — die Gelenkanpassung je Geschlecht bereithalten.
...
class Skelettnachfuehrung:
    """Zugriff auf die `Gelenkanpassung` — eine je Geschlecht."""
    ...
    def bewegte(cls, geschlecht, netz):
        """``{Knochenname: [x,y,z]}`` der bewegten Knochen — oder ``{}``.
