...
class Bildmodellbildtypen:
    ...
    HAUPT = (
        ...
        ('koerper/vorne', 'Körper von vorn', 'koerper', 'vorne'),
        ('koerper/seite', 'Körper von der Seite', 'koerper', 'seite'),
        ('koerper/hinten', 'Körper von hinten', 'koerper', 'hinten'),
        ('koerper/dreiviertel', 'Körper dreiviertel', 'koerper', 'dreiviertel'),
        ('kopf/vorne', 'Kopf von vorn', 'kopf', 'vorne'),
        ('kopf/seite', 'Kopf von der Seite', 'kopf', 'seite'),
    ...
    NEBEN = (
        ...
        ('neben', 'Nebenbild ohne Zuordnung', 'neben', None, ()),
        ('neben/haende', 'Hände — Fingerlänge, Textur', 'neben', 'haende', ('l_hand', 'r_hand')),
        ('neben/gesicht', 'Gesicht, Detail — Textur', 'neben', 'gesicht', ('kopf',)),
        ('neben/oberkoerper', 'Oberkörper — Textur', 'neben', 'oberkoerper',
         ('hals', 'rumpf', 'l_schulter', 'r_schulter')),
        ('neben/ruecken', 'Rücken — Textur', 'neben', 'ruecken',
         ('rumpf', 'becken', 'l_schulter', 'r_schulter')),
        ('neben/becken', 'Hüfte und Gesäß — Textur', 'neben', 'becken', ('becken',)),
        ('neben/arme', 'Arme — Textur', 'neben', 'arme',
         ('l_oberarm', 'l_unterarm', 'l_hand', 'r_oberarm', 'r_unterarm', 'r_hand')),
        ('neben/beine', 'Beine — Textur', 'neben', 'beine',
         ('l_oberschenkel', 'l_unterschenkel', 'r_oberschenkel', 'r_unterschenkel')),
        ('neben/fuesse', 'Füße — Textur', 'neben', 'fuesse', ('l_fuss', 'r_fuss')),
