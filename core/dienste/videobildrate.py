# -*- coding: utf-8 -*-
"""Mit wie vielen Bildern je Sekunde wurde ein Video aufgenommen?
...
class Videobildrate:
    """Liest die Bildrate aus der Videodatei eines Auftrags."""
    ...
    @classmethod
    def zu(cls, auftrag):
        """Bildrate des Auftragsvideos — oder ``VORGABE``.
