# -*- coding: utf-8 -*-
"""Animationseffekte — Mimik, Haare, Kleidung, Wind: die Stammdaten der Seite.
...
class Animationseffekte:
    """Die Tabellen der Seite „Hilfe — Animationseffekte"."""
    ...
    @staticmethod
    def schichten():
        """Wie die Studios es machen — eine Schicht je Zeile."""
        return [
            {
                'schicht': 'Körper',
            ...
            },
            {
                ...
                'werkzeuge': 'Marvelous Designer/CLO (Schnitt), Houdini Vellum, Maya nCloth',
                'hier': 'GarmentCode (Ruhelage) + Newton SolverStyle3D (Dynamik) — siehe Kleiderphysik',
            },
            {
                'schicht': 'Wind',
    ...
    @staticmethod
    def bestand():
        """Was im Projekt schon liegt — im Code nachgesehen (12.09.2026)."""
        return [
            {
            ...
            },
            {
                ...
                'stand': 'starr',
                'bemerkung': 'Im Theatre als Netz mit der Figur bewegt, keine Strähnen-Dynamik',
            },
            {
    ...
    @classmethod
    def weg(cls):
        """Der Weg, der zu diesem Projekt passt — je Schicht ein Vorschlag."""
        return [
            (
                ...
                'Frage; MPFB-Figuren bringen eigene Ausdrucksziele mit.' % (cls.MIMIK_WERTE, cls.MIMIK_WERTE),
            ),
            (
    ...
    def effekte():
        ...
        return [
            ...
            (
                'Falle 2: Selbstkollisionsabstand',
                'Blenders 6 mm auf dem '
            ...
            (
                'Falle 3: Windstärke',
                'Bei 6 (Blender-Einheit) wickelte sich der '
                'Rock in 100 Bildern um die Hüfte; Vorgabe jetzt 2.',
            ),
            (
                'Falle 4: Reibung',
                'Blenders Vorgabe 5 hält den Rock am Bein, '
            ...
            (
                'Was bleibt',
                'Bei hohen Beinschwüngen rutscht ein knielanger Rock '
    ...
    @staticmethod
    def nicht():
        """Was ausdruecklich nicht vorgeschlagen wird — und warum."""
        return [
            (
                'Blender Cloth für das Theatre',
                'Edgar, 10.09.2026: „blenderCloth '
    ...
    def offen():
        ...
        return [
            (
                'Welche Figur bekommt die Mimik?',
                'Die 52 Werte brauchen 52 '
            ...
            (
                'Liefert das Modell hier die Werte?',
                'Die Datei '
            ...
            (
                'Stoff auf Stoff',
                'Style3D behandelt Shirt und Rock in EINEM Netz; '
