# -*- coding: utf-8 -*-
"""Umaformregler — UMAs Form-Regler, je Geschlecht einmal gelesen.
...
class UmaformreglerFehlt(Exception):
    """Kein UMA-Projekt mit Regler-Dateien am erwarteten Ort."""


class Umaformregler:
    """Regler-Gruppen aus `settings.UMA_UMA3_ORDNER`, zwischengespeichert."""
    ...
    @classmethod
    def vergessen(cls):
        """Den Speicher leeren — für Tests und nach einem Wechsel des Ordners."""
        cls._stand = {}
