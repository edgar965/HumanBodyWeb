# -*- coding: utf-8 -*-
u"""Figurquellenlinks — die Adressen zu jeder Zeile der Figur-Rangliste.
...
class Figurquellenlinks:
    u"""`(Beschriftung, Adresse)` je Bilderordner."""
    ...
    LINKS = {
        '19_TexturingXYZ_VFace_Kopf': [
            ...
            ('Was im Paket ist',
             'https://texturing.xyz/pages/vface-docs-whats-in-the-pack'),
        ],
        '15_3DScanStore_AnimationReady_Scans': [
            ...
            ('Female 01', _3DSS + 'retopologised-body-models/'
        ...
        '01_3DScanStore_Morphable_Frau_Mann': [
            ('Morphable Frau + Mann', _3DSS + 'base-mesh-3d-models-and-textures/'
             'morphable-male-female-base-mesh'),
            ('Morphable Frau', _3DSS + 'base-mesh-3d-models-and-textures/'
             'morphable-female-base-mesh'),
        ],
        '02_3DScanStore_Ultimate_Textured': [
            ('Ultimate Textured Frau', _3DSS + 'base-mesh-3d-models-and-textures/'
             'female-base-mesh-textured'),
            ('Bundle Frau + Mann', _3DSS + 'base-mesh-3d-models-and-textures/'
             'textured-male-female-base-mesh'),
            ('kostenloser Scan (Tutorial)',
             _3DSS + 'download-free-3d-bodyscan-for-tutorial'),
            ('Multi-Expression-Basemesh (Blog)',
             _3DSS + 'blog/multi-expression-basemesh'),
        ],
        ...
        'ten24_kopf': [
            ('CG Channel (2023): freier Kopfscan', 'https://www.cgchannel.com/'
        ...
        '16_Triplegangers': [
            ...
            ('Beispiel Sadie Lehman',
             'https://triplegangers.com/browse/scans/full-body/sadie-lehman-body'),
            ('Gratis-Samples',
             'https://triplegangers.com/blog/technology/free-scan-samples'),
            ('Lizenz', 'https://triplegangers.com/terms-and-conditions-of-supply'),
            ('80.lv über Triplegangers', 'https://80.lv/articles/'
             'create-realistic-3d-digital-humans-with-this-enormous-database'),
        ],
        '04_Ten24_SampleScan': [
            ('Sample Scan', 'https://ten24.info/sample-scan/'),
            ('CG Channel (2016)', 'https://www.cgchannel.com/2016/03/'
             'download-ten24s-free-full-body-scan-of-an-adult-male/'),
        ],
        '17_Ten24_Shop': [
            ('Shop', 'https://ten24.info/shop/'),
            ('Ganzkörper-Scans im Shop',
             'https://ten24.info/new-full-colour-full-body-scans-on-the-store/'),
        ],
        '06_Blender_HumanBaseMeshes_CC0': [
            ('Blender Demo-Dateien',
             'https://www.blender.org/download/demo-files/#assets'),
            ('Spiegel (ZIP)', 'https://mirror.blender.org/demo/asset-bundles/'
             'human-base-meshes/human-base-meshes-bundle-v1.4.1.zip'),
            ('CG Channel (2023)', 'https://www.cgchannel.com/2023/06/'
             'download-blender-studios-free-human-base-meshes/'),
        ],
        '11_Daz_Genesis9': [
        ...
        '18_CharacterCreator5_HD': [
            ('HD Character Base',
             'https://www.reallusion.com/character-creator/hd-character-base.html'),
            ('CG Channel (2025)', 'https://www.cgchannel.com/2025/08/'
             'reallusion-releases-character-creator-5/'),
            ('Preis', 'https://www.reallusion.com/plan-and-pricing/individual/'
             'perpetual/character-creator-5-3101'),
        ],
        '05_MetaHuman': [
            ('MetaHuman', 'https://www.metahuman.com/'),
            ('Lizenz', 'https://www.metahuman.com/license'),
            ('CG Channel: außerhalb Unreal', 'https://www.cgchannel.com/2025/06/'
             'you-can-now-sell-metahumans-or-use-them-in-unity-or-godot/'),
            ('Export: MetaHumanMeshTools',
             'https://github.com/Ignifex/MetaHumanMeshTools'),
            ('80.lv: MetaHuman 5.6', 'https://80.lv/articles/'
             'explore-new-metahuman-features-in-unreal-engine-5-6'),
        ],
        ...
        '12_Reallusion_CC_Base': [
            ('CC-Basis', 'https://www.reallusion.com/character-creator/'
             'free-3d-character-base.html'),
        ],
    ...
    AUSGESCHIEDEN = [
        ('Anatomy 360', 'https://anatomy360.info/product/female-01-pose-pack/',
