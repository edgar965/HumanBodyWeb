# -*- coding: utf-8 -*-
"""Figurkoepfe — Kopfmodelle ohne Körper, getrennt von den Ganzkörpern.
...
class Figurkoepfe:
    """Rangliste der Kopfmodelle, absteigend nach Dreiecken der höchsten Stufe."""

    ZEILEN = [
        {
            "ordner": "19_TexturingXYZ_VFace_Kopf",
            "name": "Texturing.xyz VFace",
            "zusatz": "Sammlung echter Köpfe",
            "punkte": None,
            "vierecke": None,
            "dreiecke": None,
            "stufen": 7,
            ...
            "geschlecht": "beide (Sammlung)",
            "rig": "–",
            "preis": "39,90 $ je Kopf",
            "lizenz": "privat; kommerziell 299,90 $",
            "urteil": "Das dichteste Netz der ganzen Suche — Haut in Porenqualität, aber nur der Kopf.",
        },
        {
            "ordner": "09_Eisko_Louise_FreakyHoody",
            "bildmuster": "Louise",
            "linkschluessel": "eisko_louise",
            "name": "Eisko Louise",
            "zusatz": "eine Frau",
            "punkte": None,
            "vierecke": None,
            ...
            "texturen": "4K PBR (Diffuse, Spec, Normal, Displacement, Gloss, Rauheit)",
            "geschlecht": "nur Frau",
            "rig": "FACS, 236 Blendshapes",
            "preis": "kostenlos",
            "lizenz": "CC-BY-NC-ND — keine Ableitungen",
            "urteil": "Referenz für Mimik (236 Blendshapes); die Lizenz verbietet Ableitungen.",
        },
        {
            "ordner": "03_3DScanStore_frei",
            "linkschluessel": "3dss_kopf_frei",
            ...
            "dreiecke": None,
            "stufen": 3,
            "stufen_text": "Stufen 1–3 (Basis nicht angegeben)",
            "texturen": "passend zu 16K Albedo + HD-Displacement (nicht enthalten)",
            "geschlecht": "nicht angegeben",
            "rig": "Ausdrücke als Netze",
            "preis": "kostenlos (Newsletter)",
            "lizenz": "privat (Personal Single User)",
            "urteil": "Dasselbe Haus wie die Ganzkörper-Basen; ohne Netzzahl kein Rang.",
        },
        {
            ...
            "dreiecke": None,
            "stufen": None,
            "stufen_text": "ZTL, OBJ, FBX (Zahl nicht angegeben)",
            "texturen": "8K Albedo, Normal, Displacement (16-bit TIFF), Rauheit, Spec",
            "geschlecht": "nur Frau",
            "rig": "–",
            "preis": "kostenlos (Newsletter)",
