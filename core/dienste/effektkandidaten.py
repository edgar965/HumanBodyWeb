# -*- coding: utf-8 -*-
"""Effektkandidaten — offener Code fuer Mimik, Haare, Kleidung und Wind.
...
class Effektkandidaten:
    """Die Kandidatentabelle und ihre Quellen."""

    @staticmethod
    def kandidaten():
        """Eine Zeile je Kandidat; `schicht` ordnet ihn der Tabelle oben zu."""
        return [
            {
                "name": "MediaPipe Face Landmarker",
                "schicht": "Mimik",
                "lizenz": "Apache-2.0 (Code und Gewichte)",
                "laeuft": "installiert (python14, `mediapipe`); Modell liegt in MocapNET v4",
            ...
            },
            {
                ...
                "schicht": "Mimik",
                "lizenz": "SDK MIT; Modelle NVIDIA Open Model License (Hugging Face, Klick-Lizenz)",
            ...
            },
            {
                ...
                "laeuft": "ja — 2.0.14 als Blender-Erweiterung, siehe Effekte-Pipeline (Bestand)",
            ...
            },
            {
                ...
                "liefert": "BVH auf bekannte Rigs (SMPL-Namen → CMU MB), T-Pose und Skalierung automatisch",
    ...
    def quellen():
        return [
            ...
            ("NVIDIA Audio2Face-3D (Sammelrepo, Lizenzen)", "https://github.com/NVIDIA/Audio2Face-3D"),
            ("NVIDIA Audio2Face-3D SDK (MIT)", "https://github.com/NVIDIA/Audio2Face-3D-SDK"),
            ("OpenSeeFace (BSD-2-Clause)", "https://github.com/emilianavt/OpenSeeFace"),
            ...
            ("MPFB 2 (GPLv3, Assets CC0)", "https://github.com/makehumancommunity/mpfb2"),
            ("MPFB als Blender-Erweiterung", "https://extensions.blender.org/add-ons/mpfb/"),
            ("BVH Retargeter (ehemals MakeWalk, GPL)", "https://github.com/Diffeomorphic/retarget-bvh"),
            ("Gaussian Haircut (CC BY-NC-SA 4.0)", "https://github.com/eth-ait/GaussianHaircut"),
            ("Im2Haircut (ICCV 2025)", "https://github.com/Vanessik/Im2Haircut"),
        ]
