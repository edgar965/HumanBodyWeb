# -*- coding: utf-8 -*-
"""Die Kleiderbibliothek einmal vermessen und als Voreinstellungen ablegen.
...
class Vorbilderlauf:
    ...
    def _material(kennung):
        """Farbe und Glanz aus der Materialdatei neben dem Netz.
    ...
    def _hinweis(titel, deutung):
        """Was gemessen wurde — ohne Zahl waere das Preset eine Behauptung.
