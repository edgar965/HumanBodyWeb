...
BEREICHE = [
    {
        'slug': 'blender',
        'name': 'Blender-Addon: Rig und Operatoren',
    ...
    {
        'slug': 'blender_cloth',
        'name': 'Blender-Addon: Kleidungsbau',
        'dateien': [
            {
                'pfad': 'HumanBodyBlender/cloth_builder.py',
                'funktionen': [
                    '_create_garment',
                    '_add_cloth',
                    '_add_pin',
                    '_bmesh_body_ring',
                    '_transfer_bone_weights',
                    '_create_prim_puffer',
                    '_create_tpl_pants',
    ...
    {
        'slug': 'blender_ui',
        'name': 'Blender: Bedienfelder, Timer, Handler',
        'dateien': [
            {
                'pfad': 'HumanBodyBlender/ui.py',
                'funktionen': [
                    'HUMANBODY_OT_pick_part',
                    '_deferred_mesh_update',
                    '_on_depsgraph_update',
                    'register',
                    'unregister',
                    '_draw_cloth_builder_body',
                    '_draw_parts_body',
                ],
            }
        ],
        'hinweis': (
            'Blender-Bedienfelder. Zwei Dinge laufen NEBEN der Bedienung: ein '
    ...
    {
        'slug': 'blender_anim',
        'name': 'Blender: Animation und BVH-Import',
        'dateien': [
            {
                'pfad': 'HumanBodyBlender/animation.py',
                'funktionen': [
        ...
        'hinweis': (
            'Laedt BVH ueber Blenders eigenen Importer, legt Actions an, raeumt '
    ...
    {
        'slug': 'blender_retarget',
        'name': 'Blender: eigener Retargeter',
        'dateien': ['HumanBodyBlender/retarget.py'],
        'hinweis': (
            'Der DRITTE Retargeter im Projekt (neben '
    ...
    {
        'slug': 'blender_hair',
        'name': 'Blender: Haare, Morphing, Charakteraufbau',
        'dateien': [
            'HumanBodyBlender/hair.py',
            'HumanBodyBlender/morphing.py',
            'HumanBodyBlender/human_body.py',
        ],
        'hinweis': (
            'Haare als Partikel-/Kurvenobjekte, Morph-Anwendung im Addon, Aufbau '
