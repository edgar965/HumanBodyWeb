...
BEREICHE = [
    {
        "slug": "warp",
        "name": "Stoffsimulation (Warp, GPU)",
        "dateien": ["HumanBody/collision/warp_sim.py", "HumanBody/collision/warp_only.py"],
        "hinweis": (
    ...
    {
        "slug": "coll_bridge",
        "name": "Kollision: Brücke vom Browser zur Pipeline",
        "dateien": ["HumanBody/collision/bridge.py", "HumanBody/collision/scene_input.py"],
        "hinweis": (
            "Der Browser schickt eine ganze Szene als JSON: Netze base64-kodiert "
        ...
        "fragen": [
            ...
            ("save_npz: Was passiert bei ungleich langen Spuren, und was liest der Unterprozess dann?"),
        ],
    },
    {
        "slug": "coll_splitter",
        "name": "Kollision: Szene aufteilen, Ton anhängen",
        "dateien": ["HumanBody/collision/splitter.py", "HumanBody/collision/audio_mux.py"],
        "hinweis": (
            "splitter.split_scene trennt die Szene in Koerper und Stoff und "
            "bestimmt die "
    ...
    {
        "slug": "coll_skinning",
        "name": "Kollision: rigides Skinning und Body-Push-Out",
        "dateien": ["HumanBody/collision/skinning_only.py", "HumanBody/collision/skinning_blender.py"],
        "hinweis": (
            "Die schnellste der vier Pipelines: keine Stoffsimulation, sondern "
            "der Stoff "
    ...
    {
        "slug": "coll_render",
        "name": "Kollision: Bilder rendern (pyrender und Blender)",
        "dateien": ["HumanBody/collision/warp_render.py", "HumanBody/collision/blender_render_from_bake.py"],
        "hinweis": (
            "Zwei Renderwege aus derselben Bake-Datei: pyrender offscreen (Python "
            "3.14) "
        ...
        "fragen": [
            ...
            ("_fit_camera bei entarteten Eingaben (ein Punkt, NaN, leere Liste) — was kommt heraus?"),
            (
