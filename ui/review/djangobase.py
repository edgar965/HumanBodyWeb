...
BEREICHE = [
    {
        "slug": "werkzeug",
        "name": "Das Review-Werkzeug selbst (djangoBase)",
        "wurzel": r"A:\shared\djangoBase",
        "dateien": [
            "djangobase/review/partner.py",
    ...
    },
    {
        ...
        "fragen": [
            ...
            "Wo ist die Laufzeit von der Länge der Log-Datei abhängig, ohne dass es begrenzt ist?",
        ],
    },
    {
        "slug": "db_logs",
        "name": "djangoBase: Logs-Seite",
        "wurzel": r"A:\shared\djangoBase",
        "dateien": ["djangobase/views/logs.py"],
        "hinweis": (
            "Zeigt rotierende Logdateien in zwei Reitern (Ausnahmen/Allgemeines), "
    ...
    {
        "slug": "db_versions",
        "name": "djangoBase: Versionen-Seite (GitHub)",
        "wurzel": r"A:\shared\djangoBase",
        "dateien": ["djangobase/views/versions.py"],
        "hinweis": (
            "Holt Commit-Listen aus der GitHub-API und zeigt sie je Repo — ein "
    ...
    {
        "slug": "db_stats",
        "name": "djangoBase: Auslastungsanzeige, Jobs, Verkehr",
        "wurzel": r"A:\shared\djangoBase",
        "dateien": ["djangobase/system_stats.py", "djangobase/jobs.py", "djangobase/traffic.py"],
        "hinweis": (
            "system_stats liefert die Zahlen der Auslastungsleiste (GPU ueber "
    ...
    {
        "slug": "db_benutzer",
        "name": "djangoBase: Benutzerverwaltung und Rollen",
        "wurzel": "A:\\shared\\djangoBase",
        "dateien": ["djangobase/views/benutzer.py", "djangobase/forms.py", "djangobase/mixins.py"],
        "hinweis": (
            "GETEILTER CODE — dieselbe Datei laeuft in sechs Projekten, ein "
            "Fehler wirkt "
    ...
    {
        "slug": "db_uebersetzung",
        "name": "djangoBase: Übersetzungs-Katalog",
        "wurzel": "A:\\shared\\djangoBase",
        "dateien": [
            "djangobase/uebersetzung.py",
            "djangobase/templatetags/uebersetzung.py",
            "djangobase/views/uebersetzung.py",
        ],
        "hinweis": (
            "GETEILTER CODE. Texte werden zur Laufzeit uebersetzt und in einem "
            "Katalog in "
    ...
    },
    {
        ...
        "hinweis": (
            "GETEILTER CODE. HintergrundCache liefert einen alten Wert sofort und "
