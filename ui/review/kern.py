...
BEREICHE = [
    {
        ...
        "fragen": [
            ...
            "Die Höhenskalierung nimmt die Ausdehnung in Y aus Frame 0. Wann ist das falsch?",
            "Was passiert bei Knochen, die in der Zuordnung fehlen?",
        ],
    },
    {
        "slug": "geometrie",
        "name": "Geometrie & Unterteilung",
    ...
    },
    {
        ...
        "dateien": ["HumanBody/humanbody_core/morphing/", "HumanBody/humanbody_core/character.py"],
        "hinweis": (
        ...
        "fragen": [
            ...
            "Was passiert bei Reglerwerten ausserhalb des Bereichs, bei NaN, bei float32 gegen float64?",
            "Ist die Reihenfolge der angewandten Morphs bedeutsam — und ist sie stabil?",
        ],
    },
    {
        "slug": "stoff",
        "name": "Stoff- und Kleidungsgeometrie",
        ...
        "fragen": [
            ...
            "den Beinen)?",
            "_compute_normals: Wo kann die Orientierung umklappen, ohne dass es in der Ruhelage auffällt?",
        ],
    },
    {
        "slug": "pose",
        "name": "Pose-System und Koordinaten-Umrechnung",
        "dateien": ["HumanBody/humanbody_core/pose/pose_data.py", "HumanBody/humanbody_core/coordinates.py"],
        "hinweis": (
    ...
    {
        "slug": "skelett",
        "name": "Skelett-Klasse und IK",
        "dateien": [
            "HumanBody/humanbody_core/skeleton/skeleton.py",
    ...
    {
        "slug": "zuordnung",
        "name": "Formaterkennung und Knochen-Zuordnung",
        ...
        # der Dateipfad nicht.
        "dateien": [
            "HumanBody/humanbody_core/skeleton/formats/",
