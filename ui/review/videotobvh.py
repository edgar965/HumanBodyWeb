...
BEREICHE = [
    {
        "slug": "lifting",
        "name": "Video-nach-BVH: 3D-Lifting (GVHMR)",
        ...
        "fragen": [
            ...
            "Wurzel-Verschiebung: Wird sie skaliert, und passt die Einheit zum BVH-Kopf?",
        ],
    },
    {
        "slug": "vtb_detect",
        "name": "VideoToBVH: 2D-Erkennung und Lifting-Wrapper",
        "dateien": [
            "VideoToBVH/wrappers/detect_2d.py",
            "VideoToBVH/wrappers/yolo_det.py",
            "VideoToBVH/wrappers/wham_lift.py",
        ],
        "hinweis": (
            "Diese Skripte laufen als Subprozess in Python 3.10 und schreiben "
    ...
    {
        "slug": "vtb_smplestx",
        "name": "VideoToBVH: SMPLest-X (Körperschätzung)",
        "dateien": ["VideoToBVH/wrappers/smplest_x_wrapper.py", "VideoToBVH/wrappers/_run_smplest_x.py"],
        "hinweis": (
            "Der Wrapper startet einen Unterprozess (Python 3.10, CUDA) und liest "
            "dessen "
        ...
        "fragen": [
            ...
            ("Wo wird die Vertex- oder Gelenkzahl NICHT geprueft, bevor damit gerechnet wird?"),
            (
    ...
    {
        "slug": "vtb_foto",
        "name": "VideoToBVH: Foto-Analyse und 2D-Erkennung",
        "dateien": [
            "VideoToBVH/wrappers/mediapipe_photo.py",
            "VideoToBVH/wrappers/photo_analyzer.py",
            "VideoToBVH/wrappers/rtmpose_det.py",
        ],
        "hinweis": (
            "Aus einem Foto Koerpermasse schaetzen: MediaPipe findet Landmarken, "
        ...
        "fragen": [
            ...
            ("Was passiert bei einem Foto ohne Person, mit zwei Personen oder mit abgeschnittenen Beinen?"),
        ],
    },
]
