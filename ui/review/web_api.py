...
BEREICHE = [
    {
        "slug": "mesh_api",
        "name": "Mesh-Auslieferung und Zwischenspeicher",
        "dateien": [
            "HumanBodyWeb/core/dienste/charakterdaten.py",
            {"pfad": "HumanBodyWeb/core/api/netz.py", "funktionen": ["Netzendpunkte"]},
            {"pfad": "HumanBodyWeb/core/api/kleidung.py", "funktionen": ["Kleidung"]},
            {"pfad": "HumanBodyWeb/core/api/mhproxy.py", "funktionen": ["Mhproxy"]},
            {"pfad": "HumanBodyWeb/core/api/kleidungsbibliothek.py", "funktionen": ["Kleiderbibliothek"]},
        ],
        "hinweis": (
        ...
        "fragen": [
            ...
            "Was wächst unbegrenzt? Achte auf Zwischenspeicher mit Schlüsseln aus Anfragedaten.",
            "Welche Anfrage kann den Server für alle anderen blockieren (langer Rechenweg im Anfrage-Faden)?",
        ],
    },
    {
        "slug": "jobstate",
        "name": "Job-Zustandsmaschine (Start, Stopp, Aufräumen)",
        "dateien": [
            {"pfad": "HumanBodyWeb/core/api/auftraege.py", "funktionen": ["Auftragsendpunkte"]},
            "HumanBodyWeb/core/dienste/auftragssteuerung.py",
            {"pfad": "HumanBodyWeb/core/models/auftrag.py", "funktionen": ["BVHJob"]},
        ],
        "hinweis": (
        ...
        "fragen": [
            ...
            "Die PID-Datei: Was, wenn das Betriebssystem die PID inzwischen neu vergeben hat?",
        ],
    },
    {
        "slug": "foto3d",
        "name": "Foto-nach-3D: Ausrichtung und Textur",
        "dateien": [
            "HumanBodyWeb/core/dienste/fotoausrichtung.py",
            {"pfad": "HumanBodyWeb/core/api/fotoauftraege.py", "funktionen": ["Fotoauftraege"]},
            {"pfad": "HumanBodyWeb/core/api/fotoabgleich.py", "funktionen": ["Fotoabgleich"]},
            {"pfad": "HumanBodyWeb/core/api/smplx_ausgabe.py", "funktionen": ["SmplxAusgabe"]},
        ],
        "hinweis": (
    ...
    {
        "slug": "video",
        "name": "Video-Ausgabe (Theatre, ffmpeg)",
        "dateien": [
            {"pfad": "HumanBodyWeb/core/api/studio_video.py", "funktionen": ["Theatrevideo"]},
    ...
    {
        "slug": "web_models",
        "name": "Web: Datenmodell und Einstellungen",
        "dateien": [
            "HumanBodyWeb/core/models/auftrag.py",
            "HumanBodyWeb/core/models/bvhdatei.py",
            "HumanBodyWeb/core/models/einstellungen.py",
            "HumanBodyWeb/core/models/fotoauftrag.py",
        ],
        "hinweis": (
            "Die Django-Modelle: BVHJob (Auftraege mit Zustand und Fortschritt), "
    ...
    {
        "slug": "api_bvh",
        "name": "API: BVH-Bibliothek und Studio-Bearbeitung",
        ...
        "dateien": [
            "HumanBodyWeb/core/api/bvhtext.py",
            {"pfad": "HumanBodyWeb/core/api/retarget.py", "funktionen": ["bvh_verwalten"]},
        ...
        "hinweis": (
            "Verwaltung und Bearbeitung der BVH-Bibliothek. ERLEDIGT und nicht "
    ...
    {
        "slug": "api_pattern",
        "name": "API: Schnittmuster-Editor",
        "dateien": [
            {"pfad": "HumanBodyWeb/core/api/schnittmuster.py", "funktionen": ["Schnittmuster"]},
            {"pfad": "HumanBodyWeb/core/api/schnittmuster_ablage.py", "funktionen": ["Schnittmusterablage"]},
            {"pfad": "HumanBodyWeb/core/api/netzbearbeitung.py", "funktionen": ["Netzbearbeitung"]},
            "HumanBodyWeb/core/dienste/kleidungswerkzeuge.py",
        ],
        "hinweis": (
            "Aus 2D-Umrissen (Bezier-Kanten) werden Kleidungsteile im Raum "
    ...
    {
        "slug": "api_smpl",
        "name": "API: SMPL-Koerper und Kleidungsbibliothek",
        "dateien": [
            "HumanBodyWeb/core/api/smpl.py",
            {"pfad": "HumanBodyWeb/core/api/kleidungsbibliothek.py", "funktionen": ["Kleiderendpunkte"]},
        ],
        "hinweis": (
            "SMPL-Koerper aus Formparametern (betas) erzeugen und Kleidung "
