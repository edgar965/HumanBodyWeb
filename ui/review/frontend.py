...
BEREICHE = [
    {
        ...
        'fragen': [
            ...
            'Wo bleiben Event-Zuhörer oder Zeitgeber nach einem Szenenwechsel hängen?',
    ...
    {
        'slug': 'fe_modelgen',
        'name': 'Frontend: Modellgenerator',
        'dateien': [
            'HumanBodyWeb/static/viewer/modellbau/modellnetz.js',
            'HumanBodyWeb/static/viewer/modellbau/formenbauer.js',
            'HumanBodyWeb/static/viewer/modellbau/netzverschmelzung.js',
        ],
        'hinweis': (
            'Erzeugt aus dem Skelett ein Netz im Browser (Three.js, ES-Module, '
    ...
    {
        'slug': 'fe_animations',
        'name': 'Frontend: Animations-Bibliothek',
        'dateien': ['HumanBodyWeb/static/viewer/animations.js'],
        'hinweis': (
            'Die BVH-Bibliothek im Browser: Liste laden, Verwaltung (loeschen, '
    ...
    {
        'slug': 'fe_compare',
        'name': 'Frontend: Vergleich und Skelett-Test',
        'dateien': [
            'HumanBodyWeb/static/viewer/viewer_compare.js',
            'HumanBodyWeb/static/viewer/skeleton_test.js',
        ],
        'hinweis': (
            'Zwei Seiten, die ZWEI Skelette bzw. Modelle gleichzeitig zeigen — '
    ...
    },
    {
        ...
        'fragen': [
            ('Was passiert, wenn Stufe 2 (Fit) ohne Stufe 1 gerufen wird oder Stufe 1 zweimal laeuft?'),
            (
    ...
    },
    {
        ...
        'fragen': [
            ('Feld fuer Feld: Was sammelt gatherSceneState, das loadSceneFromData nicht wiederherstellt?'),
            (
            ...
            ('resetScene/newScene: Was bleibt von der alten Szene im Speicher und in der Renderschleife?'),
        ],
    },
    {
        'slug': 'viewer_editors',
        'name': 'Viewer: Schnittmuster- und Vertex-Editor',
        'dateien': [
            'HumanBodyWeb/static/viewer/viewer/pattern_editor.js',
            'HumanBodyWeb/static/viewer/viewer/vertex_editor.js',
        ],
        'hinweis': (
            'Zwei Werkzeuge, die direkt auf Geometrie schreiben. Der '
