...
BEREICHE = [
    {
        'slug': 'views_serve',
        'name': 'Web: Auslieferung von Dateien und Overlays',
        'dateien': [
            {
                'pfad': 'HumanBodyWeb/core/api/dateien.py',
                'funktionen': [
                    'serve_bvh_file',
                    'serve_bvh_face',
                    'video_thumbnail',
                    'serve_detection_data',
                    'save_rig_video',
                    'save_overlay_video',
                ],
            }
        ...
        'hinweis': (
            'KEINE ANMELDUNG, KEIN MEHRBENUTZERBETRIEB — bitte NICHT als Befund '
    ...
    {
        'slug': 'views_pipelines',
        'name': 'Web: Pipeline-Laeufe und Fortschritt',
        'dateien': [
            'HumanBodyWeb/core/pipelines/erkennung2d.py',
            {'pfad': 'HumanBodyWeb/core/pipelines/mocapnet4.py', 'funktionen': ['_run_v4_pipeline']},
        ],
        'hinweis': (
            'Die vier Pipeline-Laeufe. Sie starten Subprozesse ueber '
    ...
    {
        'slug': 'web_infra',
        'name': 'Web: Einstellungen, Middleware, ASGI',
        'dateien': [
            'HumanBodyWeb/ui/settings/__init__.py',
            'HumanBodyWeb/ui/same_origin.py',
            'HumanBodyWeb/ui/asgi.py',
        ],
        'hinweis': (
            'Grundeinstellungen und drei Middleware-Schichten. Bekannt und '
    ...
    },
    {
        ...
        'dateien': [
            'HumanBodyWeb/core/safe_paths.py',
            'HumanBodyWeb/core/atomic_write.py',
            'HumanBodyWeb/core/projekt_temp.py',
        ],
        'hinweis': (
            'DIESE DREI DATEIEN SIND DIE ABSICHERUNG SELBST — hier zaehlt jeder '
            'Fehler '
    ...
    {
        'slug': 'web_sockets',
        'name': 'Web: WebSockets, App-Start, Job-Protokoll',
        'dateien': [
            'HumanBodyWeb/core/consumers.py',
            'HumanBodyWeb/core/apps.py',
            'HumanBodyWeb/core/logging_utils.py',
        ],
        'hinweis': (
            'CharacterConsumer haelt je Verbindung einen eigenen Morph-Zustand '
            'und '
        ...
        'fragen': [
            ...
            ('apps.ready: Was gehoert dort nicht hin, weil es bei jedem Reload nochmal passiert?'),
        ],
    },
    {
        'slug': 'web_urls',
        'name': 'Web: Routen-Tabelle (139 Endpunkte)',
        'dateien': ['HumanBodyWeb/core/urls.py'],
        'hinweis': (
            'Die vollstaendige Routen-Tabelle. Hier sieht man auf einen Blick, '
            'was ohne '
    ...
    {
        'slug': 'jobs',
        'name': 'Job- und Prozess-Lebenszyklus',
        ...
        'fragen': [
            ...
            'Was passiert bei zwei gleichzeitigen Läufen, was beim Django-Autoreload mitten im Lauf?',
        ],
    },
]
