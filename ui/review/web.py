...
BEREICHE = [
    ...
    {'slug': 'web_infra', 'name': 'Web: Einstellungen, Middleware, ASGI',
     ...
     'hinweis': ('Grundeinstellungen und drei Middleware-Schichten. Bekannt und gewollt: DEBUG=True, keine Anmeldung, ALLOWED_HOSTS nur localhost, DATA_UPLOAD_MAX_MEMORY_SIZE 500 MB (ganze Bildfolgen in einer Anfrage), Cache-Header aus djangoBase (HTML nie aus dem Cache, versionierte Statik lange — die eigene pauschale No-Cache-Schicht ist am 28.08.2026 entfallen), Ursprungspruefung fuer schreibende Methoden (neu am 13.08.2026). Einzelplatz-Entwicklungssystem, kein Produktivbetrieb — bewerte danach.'),
     'fragen': [
         'Die Ursprungspruefung: Welcher Browser-Ablauf kommt trotzdem durch, welcher legitime wird faelschlich abgewiesen?',
         'Cache-Header: Kommt eine geaenderte JS-Datei beim Browser wirklich an, seit die pauschale No-Cache-Schicht weg ist?',
