...
from .wurzeln import BASE_DIR, HUMANBODY_ROOT, MOCAPNET_ROOT, OBJECTS_ROOT, TOOLS_ROOT, VIDEOTOBVH_ROOT
...
RHUBARB_EXE = os.environ.get("RHUBARB_EXE") or str(TOOLS_ROOT / "tools" / "rhubarb" / "rhubarb.exe")
