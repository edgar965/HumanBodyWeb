...
TEST_BEFEHLE = [
    ...
    },
    {
        ...
        "name": "Component",
        "gruppe": "Schnell",
        "cmd": [PYTHON14, "manage.py", "test", "core.tests.component", "-v", "2"],
    },
    {
        "slug": "ui",
        "name": "UI (Oberflächenfälle)",
        "gruppe": "Schnell",
        "cmd": [PYTHON14, "manage.py", "test", "core.tests.ui", "-v", "2"],
    },
    {
        "slug": "automated",
        "name": "Grundabsicherung",
        "gruppe": "Schnell",
        "cmd": [PYTHON14, "manage.py", "test", "core.tests.automated", "-v", "2"],
    },
    {
        "slug": "performance",
        "name": "Ladezeiten",
        "gruppe": "Messen",
        "cmd": [PYTHON14, "manage.py", "test", "core.tests.performance", "-v", "2"],
    },
    ...
    {
        "slug": "longrunner",
        "name": "Longrunner (über 1 s je Modul)",
        "gruppe": "Langsam",
        "cmd": [PYTHON14, "manage.py", "test", "core.tests.longrunner", "-v", "2"],
    },
...
TEST_BEREICHE = [
    {
        ...
        "praefixe": [
            "core.tests.unit.test_netzanfrage",
            "core.tests.unit.test_netzantwort",
            "core.tests.unit.test_materialgruppen",
            "core.tests.unit.test_charakterdaten",
            "core.tests.unit.test_skin_cache",
    ...
    },
    {
        ...
        "praefixe": [
            "core.tests.unit.test_hybridlauf",
            "core.tests.longrunner.test_v4lauf",
    ...
    },
    {
        ...
        "praefixe": ["core.tests.unit.test_fotoausrichtung", "core.tests.unit.test_bildrahmen"],
    },
    {
        "slug": "oberflaeche",
        "name": "Oberfläche & Infrastruktur",
