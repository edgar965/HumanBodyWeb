...
MENUE = [
    {'label': 'Dashboard', 'icon': 'bi-speedometer2', 'untermenu': [
        ...
        {'label': 'Szene - Modell', 'icon': 'bi-person-gear',
         'url': '/humanbody/scene-model/'},
    ...
    {'label': 'HumanBody', 'icon': 'bi-person', 'untermenu': [
        ...
        {'label': 'Animationen', 'icon': 'bi-person-walking',
         'url': '/humanbody/animations/'},
        {'label': 'Pattern Editor', 'icon': 'bi-compass',
         'url': '/humanbody/config/#tab-creator'},
    ]},
    ...
    {'label': 'Test', 'icon': 'bi-eyedropper', 'untermenu': [
        ...
        {'label': 'Test Animation', 'icon': 'bi-collection-play',
         'url': '/humanbody/test-animation/'},
        {'label': 'Test Charakter', 'icon': 'bi-person-check',
         'url': '/humanbody/test-character/'},
...
EINSTELLUNGEN_EXTRA = [
    ...
    {'label': 'Video to BVH: 2D', 'url': '/settings/video-to-bvh-2d/',
     'icon': 'bi-film'},
    {'label': 'Video to BVH: 3D', 'url': '/settings/video-to-bvh-3d/',
     'icon': 'bi-box'},
