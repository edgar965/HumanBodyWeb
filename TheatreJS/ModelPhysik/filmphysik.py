# -*- coding: utf-8 -*-
"""Der Weichgewebe-Zuschlag fuer Koerper und Kleider eines Films.
...
class Filmphysik:
    """Velocity Skinning als Zuschlag auf fertige LBS-Bahnen."""
    ...
    def anwenden(self):
        """Velocity Skinning als ZUSCHLAG auf die fertige LBS-Bahn.
    ...
    def _grenze(self, koerper, nummer):
        ...
        if nummer not in self._grenzen:
            ...
            self._grenzen[nummer] = Stoffgrenze(
                Feinkoerper.bild(koerper, nummer), Feinkoerper.dreiecke(koerper)
            )
        return self._grenzen[nummer]

    def _stoff_mit_grenze(self, teil, motor, koerper):
        """Zuschlag fuer ein Kleidungsstueck, aus dem Koerper gehalten.
        ...
        soll = Stoffgrenze(Feinkoerper.ruhe(koerper), Feinkoerper.dreiecke(koerper)).sollabstand(haut.punkte)
