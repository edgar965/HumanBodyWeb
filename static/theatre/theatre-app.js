...
}`;function dP(r,e,t){let n=new xd;const i=new mt,s=new mt,a=new Vt,l=new lP({depthPacking:WM}),u=new cP,h={},f=t.maxTextureSize,p={[ir]:Qn,[Qn]:ir,[Zn]:Zn},m=new Tr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new mt},radius:{value:4}},vertexShader:uP,fragmentShader:hP}),g=m.clone();g.defines.HORIZONTAL_PASS=1;const x=new xn;x.setAttribute("position",new dn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new Re(x,m),v=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ug;let _=this.type;this.render=function(N,O,H){if(v.enabled===!1||v.autoUpdate===!1&&v.needsUpdate===!1||N.length===0)return;const D=r.getRenderTarget(),w=r.getActiveCubeFace(),U=r.getActiveMipmapLevel(),Q=r.state;Q.setBlending(Er),Q.buffers.color.setClear(1,1,1,1),Q.buffers.depth.setTest(!0),Q.setScissorTest(!1);const Z=_!==Zi&&this.type===Zi,re=_===Zi&&this.type!==Zi;for(let le=0,X=N.length;le<X;le++){const de=N[le],te=de.shadow;if(te===void 0){console.warn("THREE.WebGLShadowMap:",de,"has no shadow.");continue}if(te.autoUpdate===!1&&te.needsUpdate===!1)continue;i.copy(te.mapSize);const ve=te.getFrameExtents();if(i.multiply(ve),s.copy(te.mapSize),(i.x>f||i.y>f)&&(i.x>f&&(s.x=Math.floor(f/ve.x),i.x=s.x*ve.x,te.mapSize.x=s.x),i.y>f&&(s.y=Math.floor(f/ve.y),i.y=s.y*ve.y,te.mapSize.y=s.y)),te.map===null||Z===!0||re===!0){const Be=this.type!==Zi?{minFilter:jn,magFilter:jn}:{};te.map!==null&&te.map.dispose(),te.map=new us(i.x,i.y,Be),te.map.texture.name=de.name+".shadowMap",te.camera.updateProjectionMatrix()}r.setRenderTarget(te.map),r.clear();const Se=te.getViewportCount();for(let Be=0;Be<Se;Be++){const je=te.getViewport(Be);a.set(s.x*je.x,s.y*je.y,s.x*je.z,s.y*je.w),Q.viewport(a),te.updateMatrices(de,Be),n=te.getFrustum(),S(O,H,te.camera,de,this.type)}te.isPointLightShadow!==!0&&this.type===Zi&&R(te,H),te.needsUpdate=!1}_=this.type,v.needsUpdate=!1,r.setRenderTarget(D,w,U)};function R(N,O){const H=e.update(E);m.defines.VSM_SAMPLES!==N.blurSamples&&(m.defines.VSM_SAMPLES=N.blurSamples,g.defines.VSM_SAMPLES=N.blurSamples,m.needsUpdate=!0,g.needsUpdate=!0),N.mapPass===null&&(N.mapPass=new us(i.x,i.y)),m.uniforms.shadow_pass.value=N.map.texture,m.uniforms.resolution.value=N.mapSize,m.uniforms.radius.value=N.radius,r.setRenderTarget(N.mapPass),r.clear(),r.renderBufferDirect(O,null,H,m,E,null),g.uniforms.shadow_pass.value=N.mapPass.texture,g.uniforms.resolution.value=N.mapSize,g.uniforms.radius.value=N.radius,r.setRenderTarget(N.map),r.clear(),r.renderBufferDirect(O,null,H,g,E,null)}function A(N,O,H,D){let w=null;const U=H.isPointLight===!0?N.customDistanceMaterial:N.customDepthMaterial;if(U!==void 0)w=U;else if(w=H.isPointLight===!0?u:l,r.localClippingEnabled&&O.clipShadows===!0&&Array.isArray(O.clippingPlanes)&&O.clippingPlanes.length!==0||O.displacementMap&&O.displacementScale!==0||O.alphaMap&&O.alphaTest>0||O.map&&O.alphaTest>0){const Q=w.uuid,Z=O.uuid;let re=h[Q];re===void 0&&(re={},h[Q]=re);let le=re[Z];le===void 0&&(le=w.clone(),re[Z]=le,O.addEventListener("dispose",k)),w=le}if(w.visible=O.visible,w.wireframe=O.wireframe,D===Zi?w.side=O.shadowSide!==null?O.shadowSide:O.side:w.side=O.shadowSide!==null?O.shadowSide:p[O.side],w.alphaMap=O.alphaMap,w.alphaTest=O.alphaTest,w.map=O.map,w.clipShadows=O.clipShadows,w.clippingPlanes=O.clippingPlanes,w.clipIntersection=O.clipIntersection,w.displacementMap=O.displacementMap,w.displacementScale=O.displacementScale,w.displacementBias=O.displacementBias,w.wireframeLinewidth=O.wireframeLinewidth,w.linewidth=O.linewidth,H.isPointLight===!0&&w.isMeshDistanceMaterial===!0){const Q=r.properties.get(w);Q.light=H}return w}function S(N,O,H,D,w){if(N.visible===!1)return;if(N.layers.test(O.layers)&&(N.isMesh||N.isLine||N.isPoints)&&(N.castShadow||N.receiveShadow&&w===Zi)&&(!N.frustumCulled||n.intersectsObject(N))){N.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,N.matrixWorld);const Z=e.update(N),re=N.material;if(Array.isArray(re)){const le=Z.groups;for(let X=0,de=le.length;X<de;X++){const te=le[X],ve=re[te.materialIndex];if(ve&&ve.visible){const Se=A(N,ve,D,w);N.onBeforeShadow(r,N,O,H,Z,Se,te),r.renderBufferDirect(H,null,Z,Se,N,te),N.onAfterShadow(r,N,O,H,Z,Se,te)}}}else if(re.visible){const le=A(N,re,D,w);N.onBeforeShadow(r,N,O,H,Z,le,null),r.renderBufferDirect(H,null,Z,le,N,null),N.onAfterShadow(r,N,O,H,Z,le,null)}}const Q=N.children;for(let Z=0,re=Q.length;Z<re;Z++)S(Q[Z],O,H,D,w)}function k(N){N.target.removeEventListener("dispose",k);for(const H in h){const D=h[H],w=N.target.uuid;w in D&&(D[w].dispose(),delete D[w])}}}const fP={[vh]:yh,[xh]:Eh,[bh]:Mh,[Zs]:Sh,[yh]:vh,[Eh]:xh,[Mh]:bh,[Sh]:Zs};function pP(r,e){function t(){let W=!1;const Ae=new Vt;let ae=null;const me=new Vt(0,0,0,0);return{setMask:function(Fe){ae!==Fe&&!W&&(r.colorMask(Fe,Fe,Fe,Fe),ae=Fe)},setLocked:function(Fe){W=Fe},setClear:function(Fe,Ie,_t,z,J){J===!0&&(Fe*=z,Ie*=z,_t*=z),Ae.set(Fe,Ie,_t,z),me.equals(Ae)===!1&&(r.clearColor(Fe,Ie,_t,z),me.copy(Ae))},reset:function(){W=!1,ae=null,me.set(-1,0,0,0)}}}function n(){let W=!1,Ae=!1,ae=null,me=null,Fe=null;return{setReversed:function(Ie){if(Ae!==Ie){const _t=e.get("EXT_clip_control");Ae?_t.clipControlEXT(_t.LOWER_LEFT_EXT,_t.ZERO_TO_ONE_EXT):_t.clipControlEXT(_t.LOWER_LEFT_EXT,_t.NEGATIVE_ONE_TO_ONE_EXT);const z=Fe;Fe=null,this.setClear(z)}Ae=Ie},getReversed:function(){return Ae},setTest:function(Ie){Ie?Ee(r.DEPTH_TEST):Ye(r.DEPTH_TEST)},setMask:function(Ie){ae!==Ie&&!W&&(r.depthMask(Ie),ae=Ie)},setFunc:function(Ie){if(Ae&&(Ie=fP[Ie]),me!==Ie){switch(Ie){case vh:r.depthFunc(r.NEVER);break;case yh:r.depthFunc(r.ALWAYS);break;case xh:r.depthFunc(r.LESS);break;case Zs:r.depthFunc(r.LEQUAL);break;case bh:r.depthFunc(r.EQUAL);break;case Sh:r.depthFunc(r.GEQUAL);break;case Eh:r.depthFunc(r.GREATER);break;case Mh:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}me=Ie}},setLocked:function(Ie){W=Ie},setClear:function(Ie){Fe!==Ie&&(Ae&&(Ie=1-Ie),r.clearDepth(Ie),Fe=Ie)},reset:function(){W=!1,ae=null,me=null,Fe=null,Ae=!1}}}function i(){let W=!1,Ae=null,ae=null,me=null,Fe=null,Ie=null,_t=null,z=null,J=null;return{setTest:function(ie){W||(ie?Ee(r.STENCIL_TEST):Ye(r.STENCIL_TEST))},setMask:function(ie){Ae!==ie&&!W&&(r.stencilMask(ie),Ae=ie)},setFunc:function(ie,_e,Ze){(ae!==ie||me!==_e||Fe!==Ze)&&(r.stencilFunc(ie,_e,Ze),ae=ie,me=_e,Fe=Ze)},setOp:function(ie,_e,Ze){(Ie!==ie||_t!==_e||z!==Ze)&&(r.stencilOp(ie,_e,Ze),Ie=ie,_t=_e,z=Ze)},setLocked:function(ie){W=ie},setClear:function(ie){J!==ie&&(r.clearStencil(ie),J=ie)},reset:function(){W=!1,Ae=null,ae=null,me=null,Fe=null,Ie=null,_t=null,z=null,J=null}}}const s=new t,a=new n,l=new i,u=new WeakMap,h=new WeakMap;let f={},p={},m=new WeakMap,g=[],x=null,E=!1,v=null,_=null,R=null,A=null,S=null,k=null,N=null,O=new ht(0,0,0),H=0,D=!1,w=null,U=null,Q=null,Z=null,re=null;const le=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let X=!1,de=0;const te=r.getParameter(r.VERSION);te.indexOf("WebGL")!==-1?(de=parseFloat(/^WebGL (\d)/.exec(te)[1]),X=de>=1):te.indexOf("OpenGL ES")!==-1&&(de=parseFloat(/^OpenGL ES (\d)/.exec(te)[1]),X=de>=2);let ve=null,Se={};const Be=r.getParameter(r.SCISSOR_BOX),je=r.getParameter(r.VIEWPORT),Tt=new Vt().fromArray(Be),ue=new Vt().fromArray(je);function ge(W,Ae,ae,me){const Fe=new Uint8Array(4),Ie=r.createTexture();r.bindTexture(W,Ie),r.texParameteri(W,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(W,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let _t=0;_t<ae;_t++)W===r.TEXTURE_3D||W===r.TEXTURE_2D_ARRAY?r.texImage3D(Ae,0,r.RGBA,1,1,me,0,r.RGBA,r.UNSIGNED_BYTE,Fe):r.texImage2D(Ae+_t,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,Fe);return Ie}const ke={};ke[r.TEXTURE_2D]=ge(r.TEXTURE_2D,r.TEXTURE_2D,1),ke[r.TEXTURE_CUBE_MAP]=ge(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),ke[r.TEXTURE_2D_ARRAY]=ge(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),ke[r.TEXTURE_3D]=ge(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),l.setClear(0),Ee(r.DEPTH_TEST),a.setFunc(Zs),st(!1),$e(wp),Ee(r.CULL_FACE),V(Er);function Ee(W){f[W]!==!0&&(r.enable(W),f[W]=!0)}function Ye(W){f[W]!==!1&&(r.disable(W),f[W]=!1)}function at(W,Ae){return p[W]!==Ae?(r.bindFramebuffer(W,Ae),p[W]=Ae,W===r.DRAW_FRAMEBUFFER&&(p[r.FRAMEBUFFER]=Ae),W===r.FRAMEBUFFER&&(p[r.DRAW_FRAMEBUFFER]=Ae),!0):!1}function rt(W,Ae){let ae=g,me=!1;if(W){ae=m.get(Ae),ae===void 0&&(ae=[],m.set(Ae,ae));const Fe=W.textures;if(ae.length!==Fe.length||ae[0]!==r.COLOR_ATTACHMENT0){for(let Ie=0,_t=Fe.length;Ie<_t;Ie++)ae[Ie]=r.COLOR_ATTACHMENT0+Ie;ae.length=Fe.length,me=!0}}else ae[0]!==r.BACK&&(ae[0]=r.BACK,me=!0);me&&r.drawBuffers(ae)}function fe(W){return x!==W?(r.useProgram(W),x=W,!0):!1}const Me={[os]:r.FUNC_ADD,[fM]:r.FUNC_SUBTRACT,[pM]:r.FUNC_REVERSE_SUBTRACT};Me[mM]=r.MIN,Me[gM]=r.MAX;const De={[_M]:r.ZERO,[vM]:r.ONE,[yM]:r.SRC_COLOR,[gh]:r.SRC_ALPHA,[TM]:r.SRC_ALPHA_SATURATE,[EM]:r.DST_COLOR,[bM]:r.DST_ALPHA,[xM]:r.ONE_MINUS_SRC_COLOR,[_h]:r.ONE_MINUS_SRC_ALPHA,[MM]:r.ONE_MINUS_DST_COLOR,[SM]:r.ONE_MINUS_DST_ALPHA,[wM]:r.CONSTANT_COLOR,[AM]:r.ONE_MINUS_CONSTANT_COLOR,[RM]:r.CONSTANT_ALPHA,[PM]:r.ONE_MINUS_CONSTANT_ALPHA};function V(W,Ae,ae,me,Fe,Ie,_t,z,J,ie){if(W===Er){E===!0&&(Ye(r.BLEND),E=!1);return}if(E===!1&&(Ee(r.BLEND),E=!0),W!==dM){if(W!==v||ie!==D){if((_!==os||S!==os)&&(r.blendEquation(r.FUNC_ADD),_=os,S=os),ie)switch(W){case qs:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Ap:r.blendFunc(r.ONE,r.ONE);break;case Rp:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Pp:r.blendFuncSeparate(r.ZERO,r.SRC_COLOR,r.ZERO,r.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",W);break}else switch(W){case qs:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Ap:r.blendFunc(r.SRC_ALPHA,r.ONE);break;case Rp:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Pp:r.blendFunc(r.ZERO,r.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",W);break}R=null,A=null,k=null,N=null,O.set(0,0,0),H=0,v=W,D=ie}return}Fe=Fe||Ae,Ie=Ie||ae,_t=_t||me,(Ae!==_||Fe!==S)&&(r.blendEquationSeparate(Me[Ae],Me[Fe]),_=Ae,S=Fe),(ae!==R||me!==A||Ie!==k||_t!==N)&&(r.blendFuncSeparate(De[ae],De[me],De[Ie],De[_t]),R=ae,A=me,k=Ie,N=_t),(z.equals(O)===!1||J!==H)&&(r.blendColor(z.r,z.g,z.b,J),O.copy(z),H=J),v=W,D=!1}function ct(W,Ae){W.side===Zn?Ye(r.CULL_FACE):Ee(r.CULL_FACE);let ae=W.side===Qn;Ae&&(ae=!ae),st(ae),W.blending===qs&&W.transparent===!1?V(Er):V(W.blending,W.blendEquation,W.blendSrc,W.blendDst,W.blendEquationAlpha,W.blendSrcAlpha,W.blendDstAlpha,W.blendColor,W.blendAlpha,W.premultipliedAlpha),a.setFunc(W.depthFunc),a.setTest(W.depthTest),a.setMask(W.depthWrite),s.setMask(W.colorWrite);const me=W.stencilWrite;l.setTest(me),me&&(l.setMask(W.stencilWriteMask),l.setFunc(W.stencilFunc,W.stencilRef,W.stencilFuncMask),l.setOp(W.stencilFail,W.stencilZFail,W.stencilZPass)),dt(W.polygonOffset,W.polygonOffsetFactor,W.polygonOffsetUnits),W.alphaToCoverage===!0?Ee(r.SAMPLE_ALPHA_TO_COVERAGE):Ye(r.SAMPLE_ALPHA_TO_COVERAGE)}function st(W){w!==W&&(W?r.frontFace(r.CW):r.frontFace(r.CCW),w=W)}function $e(W){W!==cM?(Ee(r.CULL_FACE),W!==U&&(W===wp?r.cullFace(r.BACK):W===uM?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Ye(r.CULL_FACE),U=W}function ze(W){W!==Q&&(X&&r.lineWidth(W),Q=W)}function dt(W,Ae,ae){W?(Ee(r.POLYGON_OFFSET_FILL),(Z!==Ae||re!==ae)&&(r.polygonOffset(Ae,ae),Z=Ae,re=ae)):Ye(r.POLYGON_OFFSET_FILL)}function He(W){W?Ee(r.SCISSOR_TEST):Ye(r.SCISSOR_TEST)}function L(W){W===void 0&&(W=r.TEXTURE0+le-1),ve!==W&&(r.activeTexture(W),ve=W)}function T(W,Ae,ae){ae===void 0&&(ve===null?ae=r.TEXTURE0+le-1:ae=ve);let me=Se[ae];me===void 0&&(me={type:void 0,texture:void 0},Se[ae]=me),(me.type!==W||me.texture!==Ae)&&(ve!==ae&&(r.activeTexture(ae),ve=ae),r.bindTexture(W,Ae||ke[W]),me.type=W,me.texture=Ae)}function K(){const W=Se[ve];W!==void 0&&W.type!==void 0&&(r.bindTexture(W.type,null),W.type=void 0,W.texture=void 0)}function ce(){try{r.compressedTexImage2D.apply(r,arguments)}catch(W){console.error("THREE.WebGLState:",W)}}function pe(){try{r.compressedTexImage3D.apply(r,arguments)}catch(W){console.error("THREE.WebGLState:",W)}}function he(){try{r.texSubImage2D.apply(r,arguments)}catch(W){console.error("THREE.WebGLState:",W)}}function Ge(){try{r.texSubImage3D.apply(r,arguments)}catch(W){console.error("THREE.WebGLState:",W)}}function we(){try{r.compressedTexSubImage2D.apply(r,arguments)}catch(W){console.error("THREE.WebGLState:",W)}}function Pe(){try{r.compressedTexSubImage3D.apply(r,arguments)}catch(W){console.error("THREE.WebGLState:",W)}}function gt(){try{r.texStorage2D.apply(r,arguments)}catch(W){console.error("THREE.WebGLState:",W)}}function ye(){try{r.texStorage3D.apply(r,arguments)}catch(W){console.error("THREE.WebGLState:",W)}}function Ve(){try{r.texImage2D.apply(r,arguments)}catch(W){console.error("THREE.WebGLState:",W)}}function qe(){try{r.texImage3D.apply(r,arguments)}catch(W){console.error("THREE.WebGLState:",W)}}function ut(W){Tt.equals(W)===!1&&(r.scissor(W.x,W.y,W.z,W.w),Tt.copy(W))}function Ue(W){ue.equals(W)===!1&&(r.viewport(W.x,W.y,W.z,W.w),ue.copy(W))}function St(W,Ae){let ae=h.get(Ae);ae===void 0&&(ae=new WeakMap,h.set(Ae,ae));let me=ae.get(W);me===void 0&&(me=r.getUniformBlockIndex(Ae,W.name),ae.set(W,me))}function xt(W,Ae){const me=h.get(Ae).get(W);u.get(Ae)!==me&&(r.uniformBlockBinding(Ae,me,W.__bindingPointIndex),u.set(Ae,me))}function kt(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),a.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),f={},ve=null,Se={},p={},m=new WeakMap,g=[],x=null,E=!1,v=null,_=null,R=null,A=null,S=null,k=null,N=null,O=new ht(0,0,0),H=0,D=!1,w=null,U=null,Q=null,Z=null,re=null,Tt.set(0,0,r.canvas.width,r.canvas.height),ue.set(0,0,r.canvas.width,r.canvas.height),s.reset(),a.reset(),l.reset()}return{buffers:{color:s,depth:a,stencil:l},enable:Ee,disable:Ye,bindFramebuffer:at,drawBuffers:rt,useProgram:fe,setBlending:V,setMaterial:ct,setFlipSided:st,setCullFace:$e,setLineWidth:ze,setPolygonOffset:dt,setScissorTest:He,activeTexture:L,bindTexture:T,unbindTexture:K,compressedTexImage2D:ce,compressedTexImage3D:pe,texImage2D:Ve,texImage3D:qe,updateUBOMapping:St,uniformBlockBinding:xt,texStorage2D:gt,texStorage3D:ye,texSubImage2D:he,texSubImage3D:Ge,compressedTexSubImage2D:we,compressedTexSubImage3D:Pe,scissor:ut,viewport:Ue,reset:kt}}function Mm(r,e,t,n){const i=mP(n);switch(t){case vg:return r*e;case xg:return r*e;case bg:return r*e*2;case dd:return r*e/i.components*i.byteLength;case fd:return r*e/i.components*i.byteLength;case Sg:return r*e*2/i.components*i.byteLength;case pd:return r*e*2/i.components*i.byteLength;case yg:return r*e*3/i.components*i.byteLength;case fi:return r*e*4/i.components*i.byteLength;case md:return r*e*4/i.components*i.byteLength;case Tl:case wl:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case Al:case Rl:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Rh:case Ch:return Math.max(r,16)*Math.max(e,8)/4;case Ah:case Ph:return Math.max(r,8)*Math.max(e,8)/2;case Dh:case Ih:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*8;case Lh:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Fh:return Math.floor((r+3)/4)*Math.floor((e+3)/4)*16;case Nh:return Math.floor((r+4)/5)*Math.floor((e+3)/4)*16;case Oh:return Math.floor((r+4)/5)*Math.floor((e+4)/5)*16;case Uh:return Math.floor((r+5)/6)*Math.floor((e+4)/5)*16;case Bh:return Math.floor((r+5)/6)*Math.floor((e+5)/6)*16;case kh:return Math.floor((r+7)/8)*Math.floor((e+4)/5)*16;case zh:return Math.floor((r+7)/8)*Math.floor((e+5)/6)*16;case Hh:return Math.floor((r+7)/8)*Math.floor((e+7)/8)*16;case Vh:return Math.floor((r+9)/10)*Math.floor((e+4)/5)*16;case Gh:return Math.floor((r+9)/10)*Math.floor((e+5)/6)*16;case Wh:return Math.floor((r+9)/10)*Math.floor((e+7)/8)*16;case jh:return Math.floor((r+9)/10)*Math.floor((e+9)/10)*16;case Xh:return Math.floor((r+11)/12)*Math.floor((e+9)/10)*16;case qh:return Math.floor((r+11)/12)*Math.floor((e+11)/12)*16;case Pl:case Yh:case Kh:return Math.ceil(r/4)*Math.ceil(e/4)*16;case Eg:case $h:return Math.ceil(r/4)*Math.ceil(e/4)*8;case Zh:case Qh:return Math.ceil(r/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function mP(r){switch(r){case rr:case mg:return{byteLength:1,components:1};case Jo:case gg:case ia:return{byteLength:2,components:1};case ud:case hd:return{byteLength:2,components:4};case cs:case cd:case Ei:return{byteLength:4,components:1};case _g:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${r}.`)}function gP(r,e,t,n,i,s,a){const l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,u=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new mt,f=new WeakMap;let p;const m=new WeakMap;let g=!1;try{g=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function x(L,T){return g?new OffscreenCanvas(L,T):na("canvas")}function E(L,T,K){let ce=1;const pe=He(L);if((pe.width>K||pe.height>K)&&(ce=K/Math.max(pe.width,pe.height)),ce<1)if(typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&L instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&L instanceof ImageBitmap||typeof VideoFrame<"u"&&L instanceof VideoFrame){const he=Math.floor(ce*pe.width),Ge=Math.floor(ce*pe.height);p===void 0&&(p=x(he,Ge));const we=T?x(he,Ge):p;return we.width=he,we.height=Ge,we.getContext("2d").drawImage(L,0,0,he,Ge),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+pe.width+"x"+pe.height+") to ("+he+"x"+Ge+")."),we}else return"data"in L&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+pe.width+"x"+pe.height+")."),L;return L}function v(L){return L.generateMipmaps}function _(L){r.generateMipmap(L)}function R(L){return L.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:L.isWebGL3DRenderTarget?r.TEXTURE_3D:L.isWebGLArrayRenderTarget||L.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function A(L,T,K,ce,pe=!1){if(L!==null){if(r[L]!==void 0)return r[L];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+L+"'")}let he=T;if(T===r.RED&&(K===r.FLOAT&&(he=r.R32F),K===r.HALF_FLOAT&&(he=r.R16F),K===r.UNSIGNED_BYTE&&(he=r.R8)),T===r.RED_INTEGER&&(K===r.UNSIGNED_BYTE&&(he=r.R8UI),K===r.UNSIGNED_SHORT&&(he=r.R16UI),K===r.UNSIGNED_INT&&(he=r.R32UI),K===r.BYTE&&(he=r.R8I),K===r.SHORT&&(he=r.R16I),K===r.INT&&(he=r.R32I)),T===r.RG&&(K===r.FLOAT&&(he=r.RG32F),K===r.HALF_FLOAT&&(he=r.RG16F),K===r.UNSIGNED_BYTE&&(he=r.RG8)),T===r.RG_INTEGER&&(K===r.UNSIGNED_BYTE&&(he=r.RG8UI),K===r.UNSIGNED_SHORT&&(he=r.RG16UI),K===r.UNSIGNED_INT&&(he=r.RG32UI),K===r.BYTE&&(he=r.RG8I),K===r.SHORT&&(he=r.RG16I),K===r.INT&&(he=r.RG32I)),T===r.RGB_INTEGER&&(K===r.UNSIGNED_BYTE&&(he=r.RGB8UI),K===r.UNSIGNED_SHORT&&(he=r.RGB16UI),K===r.UNSIGNED_INT&&(he=r.RGB32UI),K===r.BYTE&&(he=r.RGB8I),K===r.SHORT&&(he=r.RGB16I),K===r.INT&&(he=r.RGB32I)),T===r.RGBA_INTEGER&&(K===r.UNSIGNED_BYTE&&(he=r.RGBA8UI),K===r.UNSIGNED_SHORT&&(he=r.RGBA16UI),K===r.UNSIGNED_INT&&(he=r.RGBA32UI),K===r.BYTE&&(he=r.RGBA8I),K===r.SHORT&&(he=r.RGBA16I),K===r.INT&&(he=r.RGBA32I)),T===r.RGB&&K===r.UNSIGNED_INT_5_9_9_9_REV&&(he=r.RGB9_E5),T===r.RGBA){const Ge=pe?zl:Bt.getTransfer(ce);K===r.FLOAT&&(he=r.RGBA32F),K===r.HALF_FLOAT&&(he=r.RGBA16F),K===r.UNSIGNED_BYTE&&(he=Ge===$t?r.SRGB8_ALPHA8:r.RGBA8),K===r.UNSIGNED_SHORT_4_4_4_4&&(he=r.RGBA4),K===r.UNSIGNED_SHORT_5_5_5_1&&(he=r.RGB5_A1)}return(he===r.R16F||he===r.R32F||he===r.RG16F||he===r.RG32F||he===r.RGBA16F||he===r.RGBA32F)&&e.get("EXT_color_buffer_float"),he}function S(L,T){let K;return L?T===null||T===cs||T===to?K=r.DEPTH24_STENCIL8:T===Ei?K=r.DEPTH32F_STENCIL8:T===Jo&&(K=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===cs||T===to?K=r.DEPTH_COMPONENT24:T===Ei?K=r.DEPTH_COMPONENT32F:T===Jo&&(K=r.DEPTH_COMPONENT16),K}function k(L,T){return v(L)===!0||L.isFramebufferTexture&&L.minFilter!==jn&&L.minFilter!==li?Math.log2(Math.max(T.width,T.height))+1:L.mipmaps!==void 0&&L.mipmaps.length>0?L.mipmaps.length:L.isCompressedTexture&&Array.isArray(L.image)?T.mipmaps.length:1}function N(L){const T=L.target;T.removeEventListener("dispose",N),H(T),T.isVideoTexture&&f.delete(T)}function O(L){const T=L.target;T.removeEventListener("dispose",O),w(T)}function H(L){const T=n.get(L);if(T.__webglInit===void 0)return;const K=L.source,ce=m.get(K);if(ce){const pe=ce[T.__cacheKey];pe.usedTimes--,pe.usedTimes===0&&D(L),Object.keys(ce).length===0&&m.delete(K)}n.remove(L)}function D(L){const T=n.get(L);r.deleteTexture(T.__webglTexture);const K=L.source,ce=m.get(K);delete ce[T.__cacheKey],a.memory.textures--}function w(L){const T=n.get(L);if(L.depthTexture&&(L.depthTexture.dispose(),n.remove(L.depthTexture)),L.isWebGLCubeRenderTarget)for(let ce=0;ce<6;ce++){if(Array.isArray(T.__webglFramebuffer[ce]))for(let pe=0;pe<T.__webglFramebuffer[ce].length;pe++)r.deleteFramebuffer(T.__webglFramebuffer[ce][pe]);else r.deleteFramebuffer(T.__webglFramebuffer[ce]);T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer[ce])}else{if(Array.isArray(T.__webglFramebuffer))for(let ce=0;ce<T.__webglFramebuffer.length;ce++)r.deleteFramebuffer(T.__webglFramebuffer[ce]);else r.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&r.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&r.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let ce=0;ce<T.__webglColorRenderbuffer.length;ce++)T.__webglColorRenderbuffer[ce]&&r.deleteRenderbuffer(T.__webglColorRenderbuffer[ce]);T.__webglDepthRenderbuffer&&r.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const K=L.textures;for(let ce=0,pe=K.length;ce<pe;ce++){const he=n.get(K[ce]);he.__webglTexture&&(r.deleteTexture(he.__webglTexture),a.memory.textures--),n.remove(K[ce])}n.remove(L)}let U=0;function Q(){U=0}function Z(){const L=U;return L>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+L+" texture units while this GPU supports only "+i.maxTextures),U+=1,L}function re(L){const T=[];return T.push(L.wrapS),T.push(L.wrapT),T.push(L.wrapR||0),T.push(L.magFilter),T.push(L.minFilter),T.push(L.anisotropy),T.push(L.internalFormat),T.push(L.format),T.push(L.type),T.push(L.generateMipmaps),T.push(L.premultiplyAlpha),T.push(L.flipY),T.push(L.unpackAlignment),T.push(L.colorSpace),T.join()}function le(L,T){const K=n.get(L);if(L.isVideoTexture&&ze(L),L.isRenderTargetTexture===!1&&L.version>0&&K.__version!==L.version){const ce=L.image;if(ce===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ce.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ue(K,L,T);return}}t.bindTexture(r.TEXTURE_2D,K.__webglTexture,r.TEXTURE0+T)}function X(L,T){const K=n.get(L);if(L.version>0&&K.__version!==L.version){ue(K,L,T);return}t.bindTexture(r.TEXTURE_2D_ARRAY,K.__webglTexture,r.TEXTURE0+T)}function de(L,T){const K=n.get(L);if(L.version>0&&K.__version!==L.version){ue(K,L,T);return}t.bindTexture(r.TEXTURE_3D,K.__webglTexture,r.TEXTURE0+T)}function te(L,T){const K=n.get(L);if(L.version>0&&K.__version!==L.version){ge(K,L,T);return}t.bindTexture(r.TEXTURE_CUBE_MAP,K.__webglTexture,r.TEXTURE0+T)}const ve={[eo]:r.REPEAT,[br]:r.CLAMP_TO_EDGE,[Fl]:r.MIRRORED_REPEAT},Se={[jn]:r.NEAREST,[pg]:r.NEAREST_MIPMAP_NEAREST,[Wo]:r.NEAREST_MIPMAP_LINEAR,[li]:r.LINEAR,[Ml]:r.LINEAR_MIPMAP_NEAREST,[Ji]:r.LINEAR_MIPMAP_LINEAR},Be={[XM]:r.NEVER,[QM]:r.ALWAYS,[qM]:r.LESS,[wg]:r.LEQUAL,[YM]:r.EQUAL,[ZM]:r.GEQUAL,[KM]:r.GREATER,[$M]:r.NOTEQUAL};function je(L,T){if(T.type===Ei&&e.has("OES_texture_float_linear")===!1&&(T.magFilter===li||T.magFilter===Ml||T.magFilter===Wo||T.magFilter===Ji||T.minFilter===li||T.minFilter===Ml||T.minFilter===Wo||T.minFilter===Ji)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(L,r.TEXTURE_WRAP_S,ve[T.wrapS]),r.texParameteri(L,r.TEXTURE_WRAP_T,ve[T.wrapT]),(L===r.TEXTURE_3D||L===r.TEXTURE_2D_ARRAY)&&r.texParameteri(L,r.TEXTURE_WRAP_R,ve[T.wrapR]),r.texParameteri(L,r.TEXTURE_MAG_FILTER,Se[T.magFilter]),r.texParameteri(L,r.TEXTURE_MIN_FILTER,Se[T.minFilter]),T.compareFunction&&(r.texParameteri(L,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(L,r.TEXTURE_COMPARE_FUNC,Be[T.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===jn||T.minFilter!==Wo&&T.minFilter!==Ji||T.type===Ei&&e.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||n.get(T).__currentAnisotropy){const K=e.get("EXT_texture_filter_anisotropic");r.texParameterf(L,K.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,i.getMaxAnisotropy())),n.get(T).__currentAnisotropy=T.anisotropy}}}function Tt(L,T){let K=!1;L.__webglInit===void 0&&(L.__webglInit=!0,T.addEventListener("dispose",N));const ce=T.source;let pe=m.get(ce);pe===void 0&&(pe={},m.set(ce,pe));const he=re(T);if(he!==L.__cacheKey){pe[he]===void 0&&(pe[he]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,K=!0),pe[he].usedTimes++;const Ge=pe[L.__cacheKey];Ge!==void 0&&(pe[L.__cacheKey].usedTimes--,Ge.usedTimes===0&&D(T)),L.__cacheKey=he,L.__webglTexture=pe[he].texture}return K}function ue(L,T,K){let ce=r.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(ce=r.TEXTURE_2D_ARRAY),T.isData3DTexture&&(ce=r.TEXTURE_3D);const pe=Tt(L,T),he=T.source;t.bindTexture(ce,L.__webglTexture,r.TEXTURE0+K);const Ge=n.get(he);if(he.version!==Ge.__version||pe===!0){t.activeTexture(r.TEXTURE0+K);const we=Bt.getPrimaries(Bt.workingColorSpace),Pe=T.colorSpace===xr?null:Bt.getPrimaries(T.colorSpace),gt=T.colorSpace===xr||we===Pe?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,gt);let ye=E(T.image,!1,i.maxTextureSize);ye=dt(T,ye);const Ve=s.convert(T.format,T.colorSpace),qe=s.convert(T.type);let ut=A(T.internalFormat,Ve,qe,T.colorSpace,T.isVideoTexture);je(ce,T);let Ue;const St=T.mipmaps,xt=T.isVideoTexture!==!0,kt=Ge.__version===void 0||pe===!0,W=he.dataReady,Ae=k(T,ye);if(T.isDepthTexture)ut=S(T.format===no,T.type),kt&&(xt?t.texStorage2D(r.TEXTURE_2D,1,ut,ye.width,ye.height):t.texImage2D(r.TEXTURE_2D,0,ut,ye.width,ye.height,0,Ve,qe,null));else if(T.isDataTexture)if(St.length>0){xt&&kt&&t.texStorage2D(r.TEXTURE_2D,Ae,ut,St[0].width,St[0].height);for(let ae=0,me=St.length;ae<me;ae++)Ue=St[ae],xt?W&&t.texSubImage2D(r.TEXTURE_2D,ae,0,0,Ue.width,Ue.height,Ve,qe,Ue.data):t.texImage2D(r.TEXTURE_2D,ae,ut,Ue.width,Ue.height,0,Ve,qe,Ue.data);T.generateMipmaps=!1}else xt?(kt&&t.texStorage2D(r.TEXTURE_2D,Ae,ut,ye.width,ye.height),W&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,ye.width,ye.height,Ve,qe,ye.data)):t.texImage2D(r.TEXTURE_2D,0,ut,ye.width,ye.height,0,Ve,qe,ye.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){xt&&kt&&t.texStorage3D(r.TEXTURE_2D_ARRAY,Ae,ut,St[0].width,St[0].height,ye.depth);for(let ae=0,me=St.length;ae<me;ae++)if(Ue=St[ae],T.format!==fi)if(Ve!==null)if(xt){if(W)if(T.layerUpdates.size>0){const Fe=Mm(Ue.width,Ue.height,T.format,T.type);for(const Ie of T.layerUpdates){const _t=Ue.data.subarray(Ie*Fe/Ue.data.BYTES_PER_ELEMENT,(Ie+1)*Fe/Ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,ae,0,0,Ie,Ue.width,Ue.height,1,Ve,_t)}T.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,ae,0,0,0,Ue.width,Ue.height,ye.depth,Ve,Ue.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,ae,ut,Ue.width,Ue.height,ye.depth,0,Ue.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else xt?W&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,ae,0,0,0,Ue.width,Ue.height,ye.depth,Ve,qe,Ue.data):t.texImage3D(r.TEXTURE_2D_ARRAY,ae,ut,Ue.width,Ue.height,ye.depth,0,Ve,qe,Ue.data)}else{xt&&kt&&t.texStorage2D(r.TEXTURE_2D,Ae,ut,St[0].width,St[0].height);for(let ae=0,me=St.length;ae<me;ae++)Ue=St[ae],T.format!==fi?Ve!==null?xt?W&&t.compressedTexSubImage2D(r.TEXTURE_2D,ae,0,0,Ue.width,Ue.height,Ve,Ue.data):t.compressedTexImage2D(r.TEXTURE_2D,ae,ut,Ue.width,Ue.height,0,Ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):xt?W&&t.texSubImage2D(r.TEXTURE_2D,ae,0,0,Ue.width,Ue.height,Ve,qe,Ue.data):t.texImage2D(r.TEXTURE_2D,ae,ut,Ue.width,Ue.height,0,Ve,qe,Ue.data)}else if(T.isDataArrayTexture)if(xt){if(kt&&t.texStorage3D(r.TEXTURE_2D_ARRAY,Ae,ut,ye.width,ye.height,ye.depth),W)if(T.layerUpdates.size>0){const ae=Mm(ye.width,ye.height,T.format,T.type);for(const me of T.layerUpdates){const Fe=ye.data.subarray(me*ae/ye.data.BYTES_PER_ELEMENT,(me+1)*ae/ye.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,me,ye.width,ye.height,1,Ve,qe,Fe)}T.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,ye.width,ye.height,ye.depth,Ve,qe,ye.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,ut,ye.width,ye.height,ye.depth,0,Ve,qe,ye.data);else if(T.isData3DTexture)xt?(kt&&t.texStorage3D(r.TEXTURE_3D,Ae,ut,ye.width,ye.height,ye.depth),W&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,ye.width,ye.height,ye.depth,Ve,qe,ye.data)):t.texImage3D(r.TEXTURE_3D,0,ut,ye.width,ye.height,ye.depth,0,Ve,qe,ye.data);else if(T.isFramebufferTexture){if(kt)if(xt)t.texStorage2D(r.TEXTURE_2D,Ae,ut,ye.width,ye.height);else{let ae=ye.width,me=ye.height;for(let Fe=0;Fe<Ae;Fe++)t.texImage2D(r.TEXTURE_2D,Fe,ut,ae,me,0,Ve,qe,null),ae>>=1,me>>=1}}else if(St.length>0){if(xt&&kt){const ae=He(St[0]);t.texStorage2D(r.TEXTURE_2D,Ae,ut,ae.width,ae.height)}for(let ae=0,me=St.length;ae<me;ae++)Ue=St[ae],xt?W&&t.texSubImage2D(r.TEXTURE_2D,ae,0,0,Ve,qe,Ue):t.texImage2D(r.TEXTURE_2D,ae,ut,Ve,qe,Ue);T.generateMipmaps=!1}else if(xt){if(kt){const ae=He(ye);t.texStorage2D(r.TEXTURE_2D,Ae,ut,ae.width,ae.height)}W&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,Ve,qe,ye)}else t.texImage2D(r.TEXTURE_2D,0,ut,Ve,qe,ye);v(T)&&_(ce),Ge.__version=he.version,T.onUpdate&&T.onUpdate(T)}L.__version=T.version}function ge(L,T,K){if(T.image.length!==6)return;const ce=Tt(L,T),pe=T.source;t.bindTexture(r.TEXTURE_CUBE_MAP,L.__webglTexture,r.TEXTURE0+K);const he=n.get(pe);if(pe.version!==he.__version||ce===!0){t.activeTexture(r.TEXTURE0+K);const Ge=Bt.getPrimaries(Bt.workingColorSpace),we=T.colorSpace===xr?null:Bt.getPrimaries(T.colorSpace),Pe=T.colorSpace===xr||Ge===we?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,T.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,T.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Pe);const gt=T.isCompressedTexture||T.image[0].isCompressedTexture,ye=T.image[0]&&T.image[0].isDataTexture,Ve=[];for(let me=0;me<6;me++)!gt&&!ye?Ve[me]=E(T.image[me],!0,i.maxCubemapSize):Ve[me]=ye?T.image[me].image:T.image[me],Ve[me]=dt(T,Ve[me]);const qe=Ve[0],ut=s.convert(T.format,T.colorSpace),Ue=s.convert(T.type),St=A(T.internalFormat,ut,Ue,T.colorSpace),xt=T.isVideoTexture!==!0,kt=he.__version===void 0||ce===!0,W=pe.dataReady;let Ae=k(T,qe);je(r.TEXTURE_CUBE_MAP,T);let ae;if(gt){xt&&kt&&t.texStorage2D(r.TEXTURE_CUBE_MAP,Ae,St,qe.width,qe.height);for(let me=0;me<6;me++){ae=Ve[me].mipmaps;for(let Fe=0;Fe<ae.length;Fe++){const Ie=ae[Fe];T.format!==fi?ut!==null?xt?W&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,Fe,0,0,Ie.width,Ie.height,ut,Ie.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,Fe,St,Ie.width,Ie.height,0,Ie.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):xt?W&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,Fe,0,0,Ie.width,Ie.height,ut,Ue,Ie.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,Fe,St,Ie.width,Ie.height,0,ut,Ue,Ie.data)}}}else{if(ae=T.mipmaps,xt&&kt){ae.length>0&&Ae++;const me=He(Ve[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,Ae,St,me.width,me.height)}for(let me=0;me<6;me++)if(ye){xt?W&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,0,0,Ve[me].width,Ve[me].height,ut,Ue,Ve[me].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,St,Ve[me].width,Ve[me].height,0,ut,Ue,Ve[me].data);for(let Fe=0;Fe<ae.length;Fe++){const _t=ae[Fe].image[me].image;xt?W&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,Fe+1,0,0,_t.width,_t.height,ut,Ue,_t.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,Fe+1,St,_t.width,_t.height,0,ut,Ue,_t.data)}}else{xt?W&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,0,0,ut,Ue,Ve[me]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,0,St,ut,Ue,Ve[me]);for(let Fe=0;Fe<ae.length;Fe++){const Ie=ae[Fe];xt?W&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,Fe+1,0,0,ut,Ue,Ie.image[me]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+me,Fe+1,St,ut,Ue,Ie.image[me])}}}v(T)&&_(r.TEXTURE_CUBE_MAP),he.__version=pe.version,T.onUpdate&&T.onUpdate(T)}L.__version=T.version}function ke(L,T,K,ce,pe,he){const Ge=s.convert(K.format,K.colorSpace),we=s.convert(K.type),Pe=A(K.internalFormat,Ge,we,K.colorSpace),gt=n.get(T),ye=n.get(K);if(ye.__renderTarget=T,!gt.__hasExternalTextures){const Ve=Math.max(1,T.width>>he),qe=Math.max(1,T.height>>he);pe===r.TEXTURE_3D||pe===r.TEXTURE_2D_ARRAY?t.texImage3D(pe,he,Pe,Ve,qe,T.depth,0,Ge,we,null):t.texImage2D(pe,he,Pe,Ve,qe,0,Ge,we,null)}t.bindFramebuffer(r.FRAMEBUFFER,L),$e(T)?l.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,ce,pe,ye.__webglTexture,0,st(T)):(pe===r.TEXTURE_2D||pe>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&pe<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,ce,pe,ye.__webglTexture,he),t.bindFramebuffer(r.FRAMEBUFFER,null)}function Ee(L,T,K){if(r.bindRenderbuffer(r.RENDERBUFFER,L),T.depthBuffer){const ce=T.depthTexture,pe=ce&&ce.isDepthTexture?ce.type:null,he=S(T.stencilBuffer,pe),Ge=T.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,we=st(T);$e(T)?l.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,we,he,T.width,T.height):K?r.renderbufferStorageMultisample(r.RENDERBUFFER,we,he,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,he,T.width,T.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Ge,r.RENDERBUFFER,L)}else{const ce=T.textures;for(let pe=0;pe<ce.length;pe++){const he=ce[pe],Ge=s.convert(he.format,he.colorSpace),we=s.convert(he.type),Pe=A(he.internalFormat,Ge,we,he.colorSpace),gt=st(T);K&&$e(T)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,gt,Pe,T.width,T.height):$e(T)?l.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,gt,Pe,T.width,T.height):r.renderbufferStorage(r.RENDERBUFFER,Pe,T.width,T.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Ye(L,T){if(T&&T.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,L),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const ce=n.get(T.depthTexture);ce.__renderTarget=T,(!ce.__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),le(T.depthTexture,0);const pe=ce.__webglTexture,he=st(T);if(T.depthTexture.format===Ys)$e(T)?l.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,pe,0,he):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,pe,0);else if(T.depthTexture.format===no)$e(T)?l.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,pe,0,he):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,pe,0);else throw new Error("Unknown depthTexture format")}function at(L){const T=n.get(L),K=L.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==L.depthTexture){const ce=L.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),ce){const pe=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,ce.removeEventListener("dispose",pe)};ce.addEventListener("dispose",pe),T.__depthDisposeCallback=pe}T.__boundDepthTexture=ce}if(L.depthTexture&&!T.__autoAllocateDepthBuffer){if(K)throw new Error("target.depthTexture not supported in Cube render targets");Ye(T.__webglFramebuffer,L)}else if(K){T.__webglDepthbuffer=[];for(let ce=0;ce<6;ce++)if(t.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer[ce]),T.__webglDepthbuffer[ce]===void 0)T.__webglDepthbuffer[ce]=r.createRenderbuffer(),Ee(T.__webglDepthbuffer[ce],L,!1);else{const pe=L.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,he=T.__webglDepthbuffer[ce];r.bindRenderbuffer(r.RENDERBUFFER,he),r.framebufferRenderbuffer(r.FRAMEBUFFER,pe,r.RENDERBUFFER,he)}}else if(t.bindFramebuffer(r.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=r.createRenderbuffer(),Ee(T.__webglDepthbuffer,L,!1);else{const ce=L.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,pe=T.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,pe),r.framebufferRenderbuffer(r.FRAMEBUFFER,ce,r.RENDERBUFFER,pe)}t.bindFramebuffer(r.FRAMEBUFFER,null)}function rt(L,T,K){const ce=n.get(L);T!==void 0&&ke(ce.__webglFramebuffer,L,L.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),K!==void 0&&at(L)}function fe(L){const T=L.texture,K=n.get(L),ce=n.get(T);L.addEventListener("dispose",O);const pe=L.textures,he=L.isWebGLCubeRenderTarget===!0,Ge=pe.length>1;if(Ge||(ce.__webglTexture===void 0&&(ce.__webglTexture=r.createTexture()),ce.__version=T.version,a.memory.textures++),he){K.__webglFramebuffer=[];for(let we=0;we<6;we++)if(T.mipmaps&&T.mipmaps.length>0){K.__webglFramebuffer[we]=[];for(let Pe=0;Pe<T.mipmaps.length;Pe++)K.__webglFramebuffer[we][Pe]=r.createFramebuffer()}else K.__webglFramebuffer[we]=r.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){K.__webglFramebuffer=[];for(let we=0;we<T.mipmaps.length;we++)K.__webglFramebuffer[we]=r.createFramebuffer()}else K.__webglFramebuffer=r.createFramebuffer();if(Ge)for(let we=0,Pe=pe.length;we<Pe;we++){const gt=n.get(pe[we]);gt.__webglTexture===void 0&&(gt.__webglTexture=r.createTexture(),a.memory.textures++)}if(L.samples>0&&$e(L)===!1){K.__webglMultisampledFramebuffer=r.createFramebuffer(),K.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,K.__webglMultisampledFramebuffer);for(let we=0;we<pe.length;we++){const Pe=pe[we];K.__webglColorRenderbuffer[we]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,K.__webglColorRenderbuffer[we]);const gt=s.convert(Pe.format,Pe.colorSpace),ye=s.convert(Pe.type),Ve=A(Pe.internalFormat,gt,ye,Pe.colorSpace,L.isXRRenderTarget===!0),qe=st(L);r.renderbufferStorageMultisample(r.RENDERBUFFER,qe,Ve,L.width,L.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+we,r.RENDERBUFFER,K.__webglColorRenderbuffer[we])}r.bindRenderbuffer(r.RENDERBUFFER,null),L.depthBuffer&&(K.__webglDepthRenderbuffer=r.createRenderbuffer(),Ee(K.__webglDepthRenderbuffer,L,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(he){t.bindTexture(r.TEXTURE_CUBE_MAP,ce.__webglTexture),je(r.TEXTURE_CUBE_MAP,T);for(let we=0;we<6;we++)if(T.mipmaps&&T.mipmaps.length>0)for(let Pe=0;Pe<T.mipmaps.length;Pe++)ke(K.__webglFramebuffer[we][Pe],L,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+we,Pe);else ke(K.__webglFramebuffer[we],L,T,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+we,0);v(T)&&_(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ge){for(let we=0,Pe=pe.length;we<Pe;we++){const gt=pe[we],ye=n.get(gt);t.bindTexture(r.TEXTURE_2D,ye.__webglTexture),je(r.TEXTURE_2D,gt),ke(K.__webglFramebuffer,L,gt,r.COLOR_ATTACHMENT0+we,r.TEXTURE_2D,0),v(gt)&&_(r.TEXTURE_2D)}t.unbindTexture()}else{let we=r.TEXTURE_2D;if((L.isWebGL3DRenderTarget||L.isWebGLArrayRenderTarget)&&(we=L.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(we,ce.__webglTexture),je(we,T),T.mipmaps&&T.mipmaps.length>0)for(let Pe=0;Pe<T.mipmaps.length;Pe++)ke(K.__webglFramebuffer[Pe],L,T,r.COLOR_ATTACHMENT0,we,Pe);else ke(K.__webglFramebuffer,L,T,r.COLOR_ATTACHMENT0,we,0);v(T)&&_(we),t.unbindTexture()}L.depthBuffer&&at(L)}function Me(L){const T=L.textures;for(let K=0,ce=T.length;K<ce;K++){const pe=T[K];if(v(pe)){const he=R(L),Ge=n.get(pe).__webglTexture;t.bindTexture(he,Ge),_(he),t.unbindTexture()}}}const De=[],V=[];function ct(L){if(L.samples>0){if($e(L)===!1){const T=L.textures,K=L.width,ce=L.height;let pe=r.COLOR_BUFFER_BIT;const he=L.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Ge=n.get(L),we=T.length>1;if(we)for(let Pe=0;Pe<T.length;Pe++)t.bindFramebuffer(r.FRAMEBUFFER,Ge.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Pe,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,Ge.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Pe,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,Ge.__webglMultisampledFramebuffer),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ge.__webglFramebuffer);for(let Pe=0;Pe<T.length;Pe++){if(L.resolveDepthBuffer&&(L.depthBuffer&&(pe|=r.DEPTH_BUFFER_BIT),L.stencilBuffer&&L.resolveStencilBuffer&&(pe|=r.STENCIL_BUFFER_BIT)),we){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Ge.__webglColorRenderbuffer[Pe]);const gt=n.get(T[Pe]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,gt,0)}r.blitFramebuffer(0,0,K,ce,0,0,K,ce,pe,r.NEAREST),u===!0&&(De.length=0,V.length=0,De.push(r.COLOR_ATTACHMENT0+Pe),L.depthBuffer&&L.resolveDepthBuffer===!1&&(De.push(he),V.push(he),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,V)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,De))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),we)for(let Pe=0;Pe<T.length;Pe++){t.bindFramebuffer(r.FRAMEBUFFER,Ge.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Pe,r.RENDERBUFFER,Ge.__webglColorRenderbuffer[Pe]);const gt=n.get(T[Pe]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,Ge.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Pe,r.TEXTURE_2D,gt,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ge.__webglMultisampledFramebuffer)}else if(L.depthBuffer&&L.resolveDepthBuffer===!1&&u){const T=L.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[T])}}}function st(L){return Math.min(i.maxSamples,L.samples)}function $e(L){const T=n.get(L);return L.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function ze(L){const T=a.render.frame;f.get(L)!==T&&(f.set(L,T),L.update())}function dt(L,T){const K=L.colorSpace,ce=L.format,pe=L.type;return L.isCompressedTexture===!0||L.isVideoTexture===!0||K!==Xn&&K!==xr&&(Bt.getTransfer(K)===$t?(ce!==fi||pe!==rr)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",K)),T}function He(L){return typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement?(h.width=L.naturalWidth||L.width,h.height=L.naturalHeight||L.height):typeof VideoFrame<"u"&&L instanceof VideoFrame?(h.width=L.displayWidth,h.height=L.displayHeight):(h.width=L.width,h.height=L.height),h}this.allocateTextureUnit=Z,this.resetTextureUnits=Q,this.setTexture2D=le,this.setTexture2DArray=X,this.setTexture3D=de,this.setTextureCube=te,this.rebindTextures=rt,this.setupRenderTarget=fe,this.updateRenderTargetMipmap=Me,this.updateMultisampleRenderTarget=ct,this.setupDepthRenderbuffer=at,this.setupFrameBufferTexture=ke,this.useMultisampledRTT=$e}function _P(r,e){function t(n,i=xr){let s;const a=Bt.getTransfer(i);if(n===rr)return r.UNSIGNED_BYTE;if(n===ud)return r.UNSIGNED_SHORT_4_4_4_4;if(n===hd)return r.UNSIGNED_SHORT_5_5_5_1;if(n===_g)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===mg)return r.BYTE;if(n===gg)return r.SHORT;if(n===Jo)return r.UNSIGNED_SHORT;if(n===cd)return r.INT;if(n===cs)return r.UNSIGNED_INT;if(n===Ei)return r.FLOAT;if(n===ia)return r.HALF_FLOAT;if(n===vg)return r.ALPHA;if(n===yg)return r.RGB;if(n===fi)return r.RGBA;if(n===xg)return r.LUMINANCE;if(n===bg)return r.LUMINANCE_ALPHA;if(n===Ys)return r.DEPTH_COMPONENT;if(n===no)return r.DEPTH_STENCIL;if(n===dd)return r.RED;if(n===fd)return r.RED_INTEGER;if(n===Sg)return r.RG;if(n===pd)return r.RG_INTEGER;if(n===md)return r.RGBA_INTEGER;if(n===Tl||n===wl||n===Al||n===Rl)if(a===$t)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Tl)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===wl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Al)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Rl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Tl)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===wl)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Al)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Rl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ah||n===Rh||n===Ph||n===Ch)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ah)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Rh)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ph)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ch)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Dh||n===Ih||n===Lh)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Dh||n===Ih)return a===$t?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Lh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Fh||n===Nh||n===Oh||n===Uh||n===Bh||n===kh||n===zh||n===Hh||n===Vh||n===Gh||n===Wh||n===jh||n===Xh||n===qh)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Fh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Nh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Oh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Uh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Bh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===kh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===zh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Hh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Vh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Gh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Wh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===jh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Xh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===qh)return a===$t?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Pl||n===Yh||n===Kh)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Pl)return a===$t?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Yh)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Kh)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Eg||n===$h||n===Zh||n===Qh)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===Pl)return s.COMPRESSED_RED_RGTC1_EXT;if(n===$h)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Zh)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Qh)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===to?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}class vP extends Wn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class tr extends on{constructor(){super(),this.isGroup=!0,this.type="Group"}}const yP={type:"move"};class $u{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new tr,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new tr,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new F,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new F),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new tr,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new F,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new F),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let i=null,s=null,a=null;const l=this._targetRay,u=this._grip,h=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(h&&e.hand){a=!0;for(const E of e.hand.values()){const v=t.getJointPose(E,n),_=this._getHandJoint(h,E);v!==null&&(_.matrix.fromArray(v.transform.matrix),_.matrix.decompose(_.position,_.rotation,_.scale),_.matrixWorldNeedsUpdate=!0,_.jointRadius=v.radius),_.visible=v!==null}const f=h.joints["index-finger-tip"],p=h.joints["thumb-tip"],m=f.position.distanceTo(p.position),g=.02,x=.005;h.inputState.pinching&&m>g+x?(h.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!h.inputState.pinching&&m<=g-x&&(h.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else u!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(u.matrix.fromArray(s.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,s.linearVelocity?(u.hasLinearVelocity=!0,u.linearVelocity.copy(s.linearVelocity)):u.hasLinearVelocity=!1,s.angularVelocity?(u.hasAngularVelocity=!0,u.angularVelocity.copy(s.angularVelocity)):u.hasAngularVelocity=!1));l!==null&&(i=t.getPose(e.targetRaySpace,n),i===null&&s!==null&&(i=s),i!==null&&(l.matrix.fromArray(i.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,i.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(i.linearVelocity)):l.hasLinearVelocity=!1,i.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(i.angularVelocity)):l.hasAngularVelocity=!1,this.dispatchEvent(yP)))}return l!==null&&(l.visible=i!==null),u!==null&&(u.visible=s!==null),h!==null&&(h.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new tr;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const xP=`
void main() {
...
Note that it **is okay** to import '@theatre/core' multiple times. But those imports should point to the same module.`):new Error("The variable window.".concat(Jc," seems to be already set by a module other than @theatre/core."));const c=new aM;window[Jc]=c;const d=window[nE];d&&d!==null&&d.type==="Theatre_StudioBundle"&&d.registerCoreBundle(c)}/*! Bundled license information:
		...
		*/})(Ko,Ko.exports)),Ko.exports}var hn=UC();let lh=null,sd=null;const r_=new Map;function BC(){return lh=hn.getProject("HumanBody Theatre"),sd=lh.sheet("Main"),{project:lh,sheet:sd}}function Id(){return sd}function kC(r,e){const t=r.object("Camera",{position:hn.types.compound({x:hn.types.number(e.position.x,{range:[-50,50]}),y:hn.types.number(e.position.y,{range:[-10,20]}),z:hn.types.number(e.position.z,{range:[-50,50]})}),fov:hn.types.number(e.fov,{range:[10,120]})});return t.onValuesChange(n=>{e.position.set(n.position.x,n.position.y,n.position.z),e.fov=n.fov,e.updateProjectionMatrix()}),r_.set("Camera",t),t}function El(r,e,t){const n={position:hn.types.compound({x:hn.types.number(t.position.x,{range:[-20,20]}),y:hn.types.number(t.position.y,{range:[0,20]}),z:hn.types.number(t.position.z,{range:[-20,20]})}),intensity:hn.types.number(t.intensity,{range:[0,100]}),color:hn.types.rgba({r:t.color.r,g:t.color.g,b:t.color.b,a:1})},i=r.object(e,n);return i.onValuesChange(s=>{t.position.set(s.position.x,s.position.y,s.position.z),t.intensity=s.intensity,t.color.setRGB(s.color.r,s.color.g,s.color.b)}),r_.set(e,i),i}function Ld(r,e,t){const n=r.object(e,{position:hn.types.compound({x:hn.types.number(t.position.x,{range:[-20,20]}),y:hn.types.number(t.position.y,{range:[-5,10]}),z:hn.types.number(t.position.z,{range:[-20,20]})}),rotation:hn.types.compound({x:hn.types.number(0,{range:[-180,180]}),y:hn.types.number(0,{range:[-180,180]}),z:hn.types.number(0,{range:[-180,180]})}),scale:hn.types.number(1,{range:[.01,10]})});return n.onValuesChange(i=>{t.position.set(i.position.x,i.position.y,i.position.z),t.rotation.set(i.rotation.x*Math.PI/180,i.rotation.y*Math.PI/180,i.rotation.z*Math.PI/180),t.scale.setScalar(i.scale)}),n}function rg(r,e){if(e===VM)return console.warn("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles."),r;if(e===Jh||e===Mg){let t=r.getIndex();if(t===null){const a=[],l=r.getAttribute("position");if(l!==void 0){for(let u=0;u<l.count;u++)a.push(u);r.setIndex(a),t=r.getIndex()}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible."),r}const n=t.count-2,i=[];if(e===Jh)for(let a=1;a<=n;a++)i.push(t.getX(0)),i.push(t.getX(a)),i.push(t.getX(a+1));else for(let a=0;a<n;a++)a%2===0?(i.push(t.getX(a)),i.push(t.getX(a+1)),i.push(t.getX(a+2))):(i.push(t.getX(a+2)),i.push(t.getX(a+1)),i.push(t.getX(a)));i.length/3!==n&&console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.");const s=r.clone();return s.setIndex(i),s.clearGroups(),s}else return console.error("THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:",e),r}class zC extends ds{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(t){return new jC(t)}),this.register(function(t){return new XC(t)}),this.register(function(t){return new tD(t)}),this.register(function(t){return new nD(t)}),this.register(function(t){return new iD(t)}),this.register(function(t){return new YC(t)}),this.register(function(t){return new KC(t)}),this.register(function(t){return new $C(t)}),this.register(function(t){return new ZC(t)}),this.register(function(t){return new WC(t)}),this.register(function(t){return new QC(t)}),this.register(function(t){return new qC(t)}),this.register(function(t){return new eD(t)}),this.register(function(t){return new JC(t)}),this.register(function(t){return new VC(t)}),this.register(function(t){return new rD(t)}),this.register(function(t){return new sD(t)})}load(e,t,n,i){const s=this;let a;if(this.resourcePath!=="")a=this.resourcePath;else if(this.path!==""){const h=Qo.extractUrlBase(e);a=Qo.resolveURL(h,this.path)}else a=Qo.extractUrlBase(e);this.manager.itemStart(e);const l=function(h){i?i(h):console.error(h),s.manager.itemError(e),s.manager.itemEnd(e)},u=new Ad(this.manager);u.setPath(this.path),u.setResponseType("arraybuffer"),u.setRequestHeader(this.requestHeader),u.setWithCredentials(this.withCredentials),u.load(e,function(h){try{s.parse(h,a,function(f){t(f),s.manager.itemEnd(e)},l)}catch(f){l(f)}},n,l)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,i){let s;const a={},l={},u=new TextDecoder;if(typeof e=="string")s=JSON.parse(e);else if(e instanceof ArrayBuffer)if(u.decode(new Uint8Array(e,0,4))===s_){try{a[Lt.KHR_BINARY_GLTF]=new oD(e)}catch(p){i&&i(p);return}s=JSON.parse(a[Lt.KHR_BINARY_GLTF].content)}else s=JSON.parse(u.decode(e));else s=e;if(s.asset===void 0||s.asset.version[0]<2){i&&i(new Error("THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported."));return}const h=new yD(s,{path:t||this.resourcePath||"",crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});h.fileLoader.setRequestHeader(this.requestHeader);for(let f=0;f<this.pluginCallbacks.length;f++){const p=this.pluginCallbacks[f](h);p.name||console.error("THREE.GLTFLoader: Invalid plugin found: missing name"),l[p.name]=p,a[p.name]=!0}if(s.extensionsUsed)for(let f=0;f<s.extensionsUsed.length;++f){const p=s.extensionsUsed[f],m=s.extensionsRequired||[];switch(p){case Lt.KHR_MATERIALS_UNLIT:a[p]=new GC;break;case Lt.KHR_DRACO_MESH_COMPRESSION:a[p]=new aD(s,this.dracoLoader);break;case Lt.KHR_TEXTURE_TRANSFORM:a[p]=new lD;break;case Lt.KHR_MESH_QUANTIZATION:a[p]=new cD;break;default:m.indexOf(p)>=0&&l[p]===void 0&&console.warn('THREE.GLTFLoader: Unknown extension "'+p+'".')}}h.setExtensions(a),h.setPlugins(l),h.parse(n,i)}parseAsync(e,t){const n=this;return new Promise(function(i,s){n.parse(e,t,i,s)})}}function HC(){let r={};return{get:function(e){return r[e]},add:function(e,t){r[e]=t},remove:function(e){delete r[e]},removeAll:function(){r={}}}}const Lt={KHR_BINARY_GLTF:"KHR_binary_glTF",KHR_DRACO_MESH_COMPRESSION:"KHR_draco_mesh_compression",KHR_LIGHTS_PUNCTUAL:"KHR_lights_punctual",KHR_MATERIALS_CLEARCOAT:"KHR_materials_clearcoat",KHR_MATERIALS_DISPERSION:"KHR_materials_dispersion",KHR_MATERIALS_IOR:"KHR_materials_ior",KHR_MATERIALS_SHEEN:"KHR_materials_sheen",KHR_MATERIALS_SPECULAR:"KHR_materials_specular",KHR_MATERIALS_TRANSMISSION:"KHR_materials_transmission",KHR_MATERIALS_IRIDESCENCE:"KHR_materials_iridescence",KHR_MATERIALS_ANISOTROPY:"KHR_materials_anisotropy",KHR_MATERIALS_UNLIT:"KHR_materials_unlit",KHR_MATERIALS_VOLUME:"KHR_materials_volume",KHR_TEXTURE_BASISU:"KHR_texture_basisu",KHR_TEXTURE_TRANSFORM:"KHR_texture_transform",KHR_MESH_QUANTIZATION:"KHR_mesh_quantization",KHR_MATERIALS_EMISSIVE_STRENGTH:"KHR_materials_emissive_strength",EXT_MATERIALS_BUMP:"EXT_materials_bump",EXT_TEXTURE_WEBP:"EXT_texture_webp",EXT_TEXTURE_AVIF:"EXT_texture_avif",EXT_MESHOPT_COMPRESSION:"EXT_meshopt_compression",EXT_MESH_GPU_INSTANCING:"EXT_mesh_gpu_instancing"};class VC{constructor(e){this.parser=e,this.name=Lt.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){const e=this.parser,t=this.parser.json.nodes||[];for(let n=0,i=t.length;n<i;n++){const s=t[n];s.extensions&&s.extensions[this.name]&&s.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,s.extensions[this.name].light)}}_loadLight(e){const t=this.parser,n="light:"+e;let i=t.cache.get(n);if(i)return i;const s=t.json,u=((s.extensions&&s.extensions[this.name]||{}).lights||[])[e];let h;const f=new ht(16777215);u.color!==void 0&&f.setRGB(u.color[0],u.color[1],u.color[2],Xn);const p=u.range!==void 0?u.range:0;switch(u.type){case"directional":h=new Dl(f),h.target.position.set(0,0,-1),h.add(h.target);break;case"point":h=new $g(f),h.distance=p;break;case"spot":h=new KP(f),h.distance=p,u.spot=u.spot||{},u.spot.innerConeAngle=u.spot.innerConeAngle!==void 0?u.spot.innerConeAngle:0,u.spot.outerConeAngle=u.spot.outerConeAngle!==void 0?u.spot.outerConeAngle:Math.PI/4,h.angle=u.spot.outerConeAngle,h.penumbra=1-u.spot.innerConeAngle/u.spot.outerConeAngle,h.target.position.set(0,0,-1),h.add(h.target);break;default:throw new Error("THREE.GLTFLoader: Unexpected light type: "+u.type)}return h.position.set(0,0,0),h.decay=2,Qi(h,u),u.intensity!==void 0&&(h.intensity=u.intensity),h.name=t.createUniqueName(u.name||"light_"+e),i=Promise.resolve(h),t.cache.add(n,i),i}getDependency(e,t){if(e==="light")return this._loadLight(t)}createNodeAttachment(e){const t=this,n=this.parser,s=n.json.nodes[e],l=(s.extensions&&s.extensions[this.name]||{}).light;return l===void 0?null:this._loadLight(l).then(function(u){return n._getNodeRef(t.cache,l,u)})}}class GC{constructor(){this.name=Lt.KHR_MATERIALS_UNLIT}getMaterialType(){return pi}extendParams(e,t,n){const i=[];e.color=new ht(1,1,1),e.opacity=1;const s=t.pbrMetallicRoughness;if(s){if(Array.isArray(s.baseColorFactor)){const a=s.baseColorFactor;e.color.setRGB(a[0],a[1],a[2],Xn),e.opacity=a[3]}s.baseColorTexture!==void 0&&i.push(n.assignTexture(e,"map",s.baseColorTexture,wn))}return Promise.all(i)}}class WC{constructor(e){this.parser=e,this.name=Lt.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){const i=this.parser.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=i.extensions[this.name].emissiveStrength;return s!==void 0&&(t.emissiveIntensity=s),Promise.resolve()}}class jC{constructor(e){this.parser=e,this.name=Lt.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Fi}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];if(a.clearcoatFactor!==void 0&&(t.clearcoat=a.clearcoatFactor),a.clearcoatTexture!==void 0&&s.push(n.assignTexture(t,"clearcoatMap",a.clearcoatTexture)),a.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=a.clearcoatRoughnessFactor),a.clearcoatRoughnessTexture!==void 0&&s.push(n.assignTexture(t,"clearcoatRoughnessMap",a.clearcoatRoughnessTexture)),a.clearcoatNormalTexture!==void 0&&(s.push(n.assignTexture(t,"clearcoatNormalMap",a.clearcoatNormalTexture)),a.clearcoatNormalTexture.scale!==void 0)){const l=a.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new mt(l,l)}return Promise.all(s)}}class XC{constructor(e){this.parser=e,this.name=Lt.KHR_MATERIALS_DISPERSION}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Fi}extendMaterialParams(e,t){const i=this.parser.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=i.extensions[this.name];return t.dispersion=s.dispersion!==void 0?s.dispersion:0,Promise.resolve()}}class qC{constructor(e){this.parser=e,this.name=Lt.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Fi}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];return a.iridescenceFactor!==void 0&&(t.iridescence=a.iridescenceFactor),a.iridescenceTexture!==void 0&&s.push(n.assignTexture(t,"iridescenceMap",a.iridescenceTexture)),a.iridescenceIor!==void 0&&(t.iridescenceIOR=a.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),a.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=a.iridescenceThicknessMinimum),a.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=a.iridescenceThicknessMaximum),a.iridescenceThicknessTexture!==void 0&&s.push(n.assignTexture(t,"iridescenceThicknessMap",a.iridescenceThicknessTexture)),Promise.all(s)}}class YC{constructor(e){this.parser=e,this.name=Lt.KHR_MATERIALS_SHEEN}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Fi}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[];t.sheenColor=new ht(0,0,0),t.sheenRoughness=0,t.sheen=1;const a=i.extensions[this.name];if(a.sheenColorFactor!==void 0){const l=a.sheenColorFactor;t.sheenColor.setRGB(l[0],l[1],l[2],Xn)}return a.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=a.sheenRoughnessFactor),a.sheenColorTexture!==void 0&&s.push(n.assignTexture(t,"sheenColorMap",a.sheenColorTexture,wn)),a.sheenRoughnessTexture!==void 0&&s.push(n.assignTexture(t,"sheenRoughnessMap",a.sheenRoughnessTexture)),Promise.all(s)}}class KC{constructor(e){this.parser=e,this.name=Lt.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Fi}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];return a.transmissionFactor!==void 0&&(t.transmission=a.transmissionFactor),a.transmissionTexture!==void 0&&s.push(n.assignTexture(t,"transmissionMap",a.transmissionTexture)),Promise.all(s)}}class $C{constructor(e){this.parser=e,this.name=Lt.KHR_MATERIALS_VOLUME}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Fi}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];t.thickness=a.thicknessFactor!==void 0?a.thicknessFactor:0,a.thicknessTexture!==void 0&&s.push(n.assignTexture(t,"thicknessMap",a.thicknessTexture)),t.attenuationDistance=a.attenuationDistance||1/0;const l=a.attenuationColor||[1,1,1];return t.attenuationColor=new ht().setRGB(l[0],l[1],l[2],Xn),Promise.all(s)}}class ZC{constructor(e){this.parser=e,this.name=Lt.KHR_MATERIALS_IOR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Fi}extendMaterialParams(e,t){const i=this.parser.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=i.extensions[this.name];return t.ior=s.ior!==void 0?s.ior:1.5,Promise.resolve()}}class QC{constructor(e){this.parser=e,this.name=Lt.KHR_MATERIALS_SPECULAR}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Fi}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];t.specularIntensity=a.specularFactor!==void 0?a.specularFactor:1,a.specularTexture!==void 0&&s.push(n.assignTexture(t,"specularIntensityMap",a.specularTexture));const l=a.specularColorFactor||[1,1,1];return t.specularColor=new ht().setRGB(l[0],l[1],l[2],Xn),a.specularColorTexture!==void 0&&s.push(n.assignTexture(t,"specularColorMap",a.specularColorTexture,wn)),Promise.all(s)}}class JC{constructor(e){this.parser=e,this.name=Lt.EXT_MATERIALS_BUMP}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Fi}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];return t.bumpScale=a.bumpFactor!==void 0?a.bumpFactor:1,a.bumpTexture!==void 0&&s.push(n.assignTexture(t,"bumpMap",a.bumpTexture)),Promise.all(s)}}class eD{constructor(e){this.parser=e,this.name=Lt.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){const n=this.parser.json.materials[e];return!n.extensions||!n.extensions[this.name]?null:Fi}extendMaterialParams(e,t){const n=this.parser,i=n.json.materials[e];if(!i.extensions||!i.extensions[this.name])return Promise.resolve();const s=[],a=i.extensions[this.name];return a.anisotropyStrength!==void 0&&(t.anisotropy=a.anisotropyStrength),a.anisotropyRotation!==void 0&&(t.anisotropyRotation=a.anisotropyRotation),a.anisotropyTexture!==void 0&&s.push(n.assignTexture(t,"anisotropyMap",a.anisotropyTexture)),Promise.all(s)}}class tD{constructor(e){this.parser=e,this.name=Lt.KHR_TEXTURE_BASISU}loadTexture(e){const t=this.parser,n=t.json,i=n.textures[e];if(!i.extensions||!i.extensions[this.name])return null;const s=i.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures");return null}return t.loadTextureImage(e,s.source,a)}}class nD{constructor(e){this.parser=e,this.name=Lt.EXT_TEXTURE_WEBP,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,i=n.json,s=i.textures[e];if(!s.extensions||!s.extensions[t])return null;const a=s.extensions[t],l=i.images[a.source];let u=n.textureLoader;if(l.uri){const h=n.options.manager.getHandler(l.uri);h!==null&&(u=h)}return this.detectSupport().then(function(h){if(h)return n.loadTextureImage(e,a.source,u);if(i.extensionsRequired&&i.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: WebP required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/webp;base64,UklGRiIAAABXRUJQVlA4IBYAAAAwAQCdASoBAAEADsD+JaQAA3AAAAAA",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class iD{constructor(e){this.parser=e,this.name=Lt.EXT_TEXTURE_AVIF,this.isSupported=null}loadTexture(e){const t=this.name,n=this.parser,i=n.json,s=i.textures[e];if(!s.extensions||!s.extensions[t])return null;const a=s.extensions[t],l=i.images[a.source];let u=n.textureLoader;if(l.uri){const h=n.options.manager.getHandler(l.uri);h!==null&&(u=h)}return this.detectSupport().then(function(h){if(h)return n.loadTextureImage(e,a.source,u);if(i.extensionsRequired&&i.extensionsRequired.indexOf(t)>=0)throw new Error("THREE.GLTFLoader: AVIF required by asset but unsupported.");return n.loadTexture(e)})}detectSupport(){return this.isSupported||(this.isSupported=new Promise(function(e){const t=new Image;t.src="data:image/avif;base64,",t.onload=t.onerror=function(){e(t.height===1)}})),this.isSupported}}class rD{constructor(e){this.name=Lt.EXT_MESHOPT_COMPRESSION,this.parser=e}loadBufferView(e){const t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){const i=n.extensions[this.name],s=this.parser.getDependency("buffer",i.buffer),a=this.parser.options.meshoptDecoder;if(!a||!a.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw new Error("THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files");return null}return s.then(function(l){const u=i.byteOffset||0,h=i.byteLength||0,f=i.count,p=i.byteStride,m=new Uint8Array(l,u,h);return a.decodeGltfBufferAsync?a.decodeGltfBufferAsync(f,p,m,i.mode,i.filter).then(function(g){return g.buffer}):a.ready.then(function(){const g=new ArrayBuffer(f*p);return a.decodeGltfBuffer(new Uint8Array(g),f,p,m,i.mode,i.filter),g})})}else return null}}class sD{constructor(e){this.name=Lt.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){const t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;const i=t.meshes[n.mesh];for(const h of i.primitives)if(h.mode!==di.TRIANGLES&&h.mode!==di.TRIANGLE_STRIP&&h.mode!==di.TRIANGLE_FAN&&h.mode!==void 0)return null;const a=n.extensions[this.name].attributes,l=[],u={};for(const h in a)l.push(this.parser.getDependency("accessor",a[h]).then(f=>(u[h]=f,u[h])));return l.length<1?null:(l.push(this.parser.createNodeMesh(e)),Promise.all(l).then(h=>{const f=h.pop(),p=f.isGroup?f.children:[f],m=h[0].count,g=[];for(const x of p){const E=new bt,v=new F,_=new Pt,R=new F(1,1,1),A=new LP(x.geometry,x.material,m);for(let S=0;S<m;S++)u.TRANSLATION&&v.fromBufferAttribute(u.TRANSLATION,S),u.ROTATION&&_.fromBufferAttribute(u.ROTATION,S),u.SCALE&&R.fromBufferAttribute(u.SCALE,S),A.setMatrixAt(S,E.compose(v,_,R));for(const S in u)if(S==="_COLOR_0"){const k=u[S];A.instanceColor=new nd(k.array,k.itemSize,k.normalized)}else S!=="TRANSLATION"&&S!=="ROTATION"&&S!=="SCALE"&&x.geometry.setAttribute(S,u[S]);on.prototype.copy.call(A,x),this.parser.assignFinalMaterial(A),g.push(A)}return f.isGroup?(f.clear(),f.add(...g),f):g[0]}))}}const s_="glTF",Go=12,sg={JSON:1313821514,BIN:5130562};class oD{constructor(e){this.name=Lt.KHR_BINARY_GLTF,this.content=null,this.body=null;const t=new DataView(e,0,Go),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==s_)throw new Error("THREE.GLTFLoader: Unsupported glTF-Binary header.");if(this.header.version<2)throw new Error("THREE.GLTFLoader: Legacy binary file detected.");const i=this.header.length-Go,s=new DataView(e,Go);let a=0;for(;a<i;){const l=s.getUint32(a,!0);a+=4;const u=s.getUint32(a,!0);if(a+=4,u===sg.JSON){const h=new Uint8Array(e,Go+a,l);this.content=n.decode(h)}else if(u===sg.BIN){const h=Go+a;this.body=e.slice(h,h+l)}a+=l}if(this.content===null)throw new Error("THREE.GLTFLoader: JSON content not found.")}}class aD{constructor(e,t){if(!t)throw new Error("THREE.GLTFLoader: No DRACOLoader instance provided.");this.name=Lt.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){const n=this.json,i=this.dracoLoader,s=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,l={},u={},h={};for(const f in a){const p=od[f]||f.toLowerCase();l[p]=a[f]}for(const f in e.attributes){const p=od[f]||f.toLowerCase();if(a[f]!==void 0){const m=n.accessors[e.attributes[f]],g=$s[m.componentType];h[p]=g.name,u[p]=m.normalized===!0}}return t.getDependency("bufferView",s).then(function(f){return new Promise(function(p,m){i.decodeDracoFile(f,function(g){for(const x in g.attributes){const E=g.attributes[x],v=u[x];v!==void 0&&(E.normalized=v)}p(g)},l,h,Xn,m)})})}}class lD{constructor(){this.name=Lt.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0||(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0),e}}class cD{constructor(){this.name=Lt.KHR_MESH_QUANTIZATION}}class o_ extends oa{constructor(e,t,n,i){super(e,t,n,i)}copySampleValue_(e){const t=this.resultBuffer,n=this.sampleValues,i=this.valueSize,s=e*i*3+i;for(let a=0;a!==i;a++)t[a]=n[s+a];return t}interpolate_(e,t,n,i){const s=this.resultBuffer,a=this.sampleValues,l=this.valueSize,u=l*2,h=l*3,f=i-t,p=(n-t)/f,m=p*p,g=m*p,x=e*h,E=x-h,v=-2*g+3*m,_=g-m,R=1-v,A=_-m+p;for(let S=0;S!==l;S++){const k=a[E+S+l],N=a[E+S+u]*f,O=a[x+S+l],H=a[x+S]*f;s[S]=R*k+A*N+v*O+_*H}return s}}const uD=new Pt;class hD extends o_{interpolate_(e,t,n,i){const s=super.interpolate_(e,t,n,i);return uD.fromArray(s).normalize().toArray(s),s}}const di={POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6},$s={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},og={9728:jn,9729:li,9984:pg,9985:Ml,9986:Wo,9987:Ji},ag={33071:br,33648:Fl,10497:eo},ch={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},od={POSITION:"position",NORMAL:"normal",TANGENT:"tangent",TEXCOORD_0:"uv",TEXCOORD_1:"uv1",TEXCOORD_2:"uv2",TEXCOORD_3:"uv3",COLOR_0:"color",WEIGHTS_0:"skinWeight",JOINTS_0:"skinIndex"},vr={scale:"scale",translation:"position",rotation:"quaternion",weights:"morphTargetInfluences"},dD={CUBICSPLINE:void 0,LINEAR:ta,STEP:ea},uh={OPAQUE:"OPAQUE",MASK:"MASK",BLEND:"BLEND"};function fD(r){return r.DefaultMaterial===void 0&&(r.DefaultMaterial=new hs({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:ir})),r.DefaultMaterial}function is(r,e,t){for(const n in t.extensions)r[n]===void 0&&(e.userData.gltfExtensions=e.userData.gltfExtensions||{},e.userData.gltfExtensions[n]=t.extensions[n])}function Qi(r,e){e.extras!==void 0&&(typeof e.extras=="object"?Object.assign(r.userData,e.extras):console.warn("THREE.GLTFLoader: Ignoring primitive type .extras, "+e.extras))}function pD(r,e,t){let n=!1,i=!1,s=!1;for(let h=0,f=e.length;h<f;h++){const p=e[h];if(p.POSITION!==void 0&&(n=!0),p.NORMAL!==void 0&&(i=!0),p.COLOR_0!==void 0&&(s=!0),n&&i&&s)break}if(!n&&!i&&!s)return Promise.resolve(r);const a=[],l=[],u=[];for(let h=0,f=e.length;h<f;h++){const p=e[h];if(n){const m=p.POSITION!==void 0?t.getDependency("accessor",p.POSITION):r.attributes.position;a.push(m)}if(i){const m=p.NORMAL!==void 0?t.getDependency("accessor",p.NORMAL):r.attributes.normal;l.push(m)}if(s){const m=p.COLOR_0!==void 0?t.getDependency("accessor",p.COLOR_0):r.attributes.color;u.push(m)}}return Promise.all([Promise.all(a),Promise.all(l),Promise.all(u)]).then(function(h){const f=h[0],p=h[1],m=h[2];return n&&(r.morphAttributes.position=f),i&&(r.morphAttributes.normal=p),s&&(r.morphAttributes.color=m),r.morphTargetsRelative=!0,r})}function mD(r,e){if(r.updateMorphTargets(),e.weights!==void 0)for(let t=0,n=e.weights.length;t<n;t++)r.morphTargetInfluences[t]=e.weights[t];if(e.extras&&Array.isArray(e.extras.targetNames)){const t=e.extras.targetNames;if(r.morphTargetInfluences.length===t.length){r.morphTargetDictionary={};for(let n=0,i=t.length;n<i;n++)r.morphTargetDictionary[t[n]]=n}else console.warn("THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.")}}function gD(r){let e;const t=r.extensions&&r.extensions[Lt.KHR_DRACO_MESH_COMPRESSION];if(t?e="draco:"+t.bufferView+":"+t.indices+":"+hh(t.attributes):e=r.indices+":"+hh(r.attributes)+":"+r.mode,r.targets!==void 0)for(let n=0,i=r.targets.length;n<i;n++)e+=":"+hh(r.targets[n]);return e}function hh(r){let e="";const t=Object.keys(r).sort();for(let n=0,i=t.length;n<i;n++)e+=t[n]+":"+r[t[n]]+";";return e}function ad(r){switch(r){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw new Error("THREE.GLTFLoader: Unsupported normalized accessor component type.")}}function _D(r){return r.search(/\.jpe?g($|\?)/i)>0||r.search(/^data\:image\/jpeg/)===0?"image/jpeg":r.search(/\.webp($|\?)/i)>0||r.search(/^data\:image\/webp/)===0?"image/webp":r.search(/\.ktx2($|\?)/i)>0||r.search(/^data\:image\/ktx2/)===0?"image/ktx2":"image/png"}const vD=new bt;class yD{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new HC,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,i=-1,s=!1,a=-1;if(typeof navigator<"u"){const l=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(l)===!0;const u=l.match(/Version\/(\d+)/);i=n&&u?parseInt(u[1],10):-1,s=l.indexOf("Firefox")>-1,a=s?l.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>"u"||n&&i<17||s&&a<98?this.textureLoader=new qP(this.options.manager):this.textureLoader=new JP(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new Ad(this.options.manager),this.fileLoader.setResponseType("arraybuffer"),this.options.crossOrigin==="use-credentials"&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){const n=this,i=this.json,s=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(a){return a._markDefs&&a._markDefs()}),Promise.all(this._invokeAll(function(a){return a.beforeRoot&&a.beforeRoot()})).then(function(){return Promise.all([n.getDependencies("scene"),n.getDependencies("animation"),n.getDependencies("camera")])}).then(function(a){const l={scene:a[0][i.scene||0],scenes:a[0],animations:a[1],cameras:a[2],asset:i.asset,parser:n,userData:{}};return is(s,l,i),Qi(l,i),Promise.all(n._invokeAll(function(u){return u.afterRoot&&u.afterRoot(l)})).then(function(){for(const u of l.scenes)u.updateMatrixWorld();e(l)})}).catch(t)}_markDefs(){const e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let i=0,s=t.length;i<s;i++){const a=t[i].joints;for(let l=0,u=a.length;l<u;l++)e[a[l]].isBone=!0}for(let i=0,s=e.length;i<s;i++){const a=e[i];a.mesh!==void 0&&(this._addNodeRef(this.meshCache,a.mesh),a.skin!==void 0&&(n[a.mesh].isSkinnedMesh=!0)),a.camera!==void 0&&this._addNodeRef(this.cameraCache,a.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;const i=n.clone(),s=(a,l)=>{const u=this.associations.get(a);u!=null&&this.associations.set(l,u);for(const[h,f]of a.children.entries())s(f,l.children[h])};return s(n,i),i.name+="_instance_"+e.uses[t]++,i}_invokeOne(e){const t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){const i=e(t[n]);if(i)return i}return null}_invokeAll(e){const t=Object.values(this.plugins);t.unshift(this);const n=[];for(let i=0;i<t.length;i++){const s=e(t[i]);s&&n.push(s)}return n}getDependency(e,t){const n=e+":"+t;let i=this.cache.get(n);if(!i){switch(e){case"scene":i=this.loadScene(t);break;case"node":i=this._invokeOne(function(s){return s.loadNode&&s.loadNode(t)});break;case"mesh":i=this._invokeOne(function(s){return s.loadMesh&&s.loadMesh(t)});break;case"accessor":i=this.loadAccessor(t);break;case"bufferView":i=this._invokeOne(function(s){return s.loadBufferView&&s.loadBufferView(t)});break;case"buffer":i=this.loadBuffer(t);break;case"material":i=this._invokeOne(function(s){return s.loadMaterial&&s.loadMaterial(t)});break;case"texture":i=this._invokeOne(function(s){return s.loadTexture&&s.loadTexture(t)});break;case"skin":i=this.loadSkin(t);break;case"animation":i=this._invokeOne(function(s){return s.loadAnimation&&s.loadAnimation(t)});break;case"camera":i=this.loadCamera(t);break;default:if(i=this._invokeOne(function(s){return s!=this&&s.getDependency&&s.getDependency(e,t)}),!i)throw new Error("Unknown type: "+e);break}this.cache.add(n,i)}return i}getDependencies(e){let t=this.cache.get(e);if(!t){const n=this,i=this.json[e+(e==="mesh"?"es":"s")]||[];t=Promise.all(i.map(function(s,a){return n.getDependency(e,a)})),this.cache.add(e,t)}return t}loadBuffer(e){const t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!=="arraybuffer")throw new Error("THREE.GLTFLoader: "+t.type+" buffer type is not supported.");if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[Lt.KHR_BINARY_GLTF].body);const i=this.options;return new Promise(function(s,a){n.load(Qo.resolveURL(t.uri,i.path),s,void 0,function(){a(new Error('THREE.GLTFLoader: Failed to load buffer "'+t.uri+'".'))})})}loadBufferView(e){const t=this.json.bufferViews[e];return this.getDependency("buffer",t.buffer).then(function(n){const i=t.byteLength||0,s=t.byteOffset||0;return n.slice(s,s+i)})}loadAccessor(e){const t=this,n=this.json,i=this.json.accessors[e];if(i.bufferView===void 0&&i.sparse===void 0){const a=ch[i.type],l=$s[i.componentType],u=i.normalized===!0,h=new l(i.count*a);return Promise.resolve(new dn(h,a,u))}const s=[];return i.bufferView!==void 0?s.push(this.getDependency("bufferView",i.bufferView)):s.push(null),i.sparse!==void 0&&(s.push(this.getDependency("bufferView",i.sparse.indices.bufferView)),s.push(this.getDependency("bufferView",i.sparse.values.bufferView))),Promise.all(s).then(function(a){const l=a[0],u=ch[i.type],h=$s[i.componentType],f=h.BYTES_PER_ELEMENT,p=f*u,m=i.byteOffset||0,g=i.bufferView!==void 0?n.bufferViews[i.bufferView].byteStride:void 0,x=i.normalized===!0;let E,v;if(g&&g!==p){const _=Math.floor(m/g),R="InterleavedBuffer:"+i.bufferView+":"+i.componentType+":"+_+":"+i.count;let A=t.cache.get(R);A||(E=new h(l,_*g,i.count*g/f),A=new PP(E,g/f),t.cache.add(R,A)),v=new Md(A,u,m%g/f,x)}else l===null?E=new h(i.count*u):E=new h(l,m,i.count*u),v=new dn(E,u,x);if(i.sparse!==void 0){const _=ch.SCALAR,R=$s[i.sparse.indices.componentType],A=i.sparse.indices.byteOffset||0,S=i.sparse.values.byteOffset||0,k=new R(a[1],A,i.sparse.count*_),N=new h(a[2],S,i.sparse.count*u);l!==null&&(v=new dn(v.array.slice(),v.itemSize,v.normalized)),v.normalized=!1;for(let O=0,H=k.length;O<H;O++){const D=k[O];if(v.setX(D,N[O*u]),u>=2&&v.setY(D,N[O*u+1]),u>=3&&v.setZ(D,N[O*u+2]),u>=4&&v.setW(D,N[O*u+3]),u>=5)throw new Error("THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.")}v.normalized=x}return v})}loadTexture(e){const t=this.json,n=this.options,s=t.textures[e].source,a=t.images[s];let l=this.textureLoader;if(a.uri){const u=n.manager.getHandler(a.uri);u!==null&&(l=u)}return this.loadTextureImage(e,s,l)}loadTextureImage(e,t,n){const i=this,s=this.json,a=s.textures[e],l=s.images[t],u=(l.uri||l.bufferView)+":"+a.sampler;if(this.textureCache[u])return this.textureCache[u];const h=this.loadImageSource(t,n).then(function(f){f.flipY=!1,f.name=a.name||l.name||"",f.name===""&&typeof l.uri=="string"&&l.uri.startsWith("data:image/")===!1&&(f.name=l.uri);const m=(s.samplers||{})[a.sampler]||{};return f.magFilter=og[m.magFilter]||li,f.minFilter=og[m.minFilter]||Ji,f.wrapS=ag[m.wrapS]||eo,f.wrapT=ag[m.wrapT]||eo,f.generateMipmaps=!f.isCompressedTexture&&f.minFilter!==jn&&f.minFilter!==li,i.associations.set(f,{textures:e}),f}).catch(function(){return null});return this.textureCache[u]=h,h}loadImageSource(e,t){const n=this,i=this.json,s=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(p=>p.clone());const a=i.images[e],l=self.URL||self.webkitURL;let u=a.uri||"",h=!1;if(a.bufferView!==void 0)u=n.getDependency("bufferView",a.bufferView).then(function(p){h=!0;const m=new Blob([p],{type:a.mimeType});return u=l.createObjectURL(m),u});else if(a.uri===void 0)throw new Error("THREE.GLTFLoader: Image "+e+" is missing URI and bufferView");const f=Promise.resolve(u).then(function(p){return new Promise(function(m,g){let x=m;t.isImageBitmapLoader===!0&&(x=function(E){const v=new An(E);v.needsUpdate=!0,m(v)}),t.load(Qo.resolveURL(p,s.path),x,void 0,g)})}).then(function(p){return h===!0&&l.revokeObjectURL(u),Qi(p,a),p.userData.mimeType=a.mimeType||_D(a.uri),p}).catch(function(p){throw console.error("THREE.GLTFLoader: Couldn't load texture",u),p});return this.sourceCache[e]=f,f}assignTexture(e,t,n,i){const s=this;return this.getDependency("texture",n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),s.extensions[Lt.KHR_TEXTURE_TRANSFORM]){const l=n.extensions!==void 0?n.extensions[Lt.KHR_TEXTURE_TRANSFORM]:void 0;if(l){const u=s.associations.get(a);a=s.extensions[Lt.KHR_TEXTURE_TRANSFORM].extendTexture(a,l),s.associations.set(a,u)}}return i!==void 0&&(a.colorSpace=i),e[t]=a,a})}assignFinalMaterial(e){const t=e.geometry;let n=e.material;const i=t.attributes.tangent===void 0,s=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){const l="PointsMaterial:"+n.uuid;let u=this.cache.get(l);u||(u=new Xg,Ii.prototype.copy.call(u,n),u.color.copy(n.color),u.map=n.map,u.sizeAttenuation=!1,this.cache.add(l,u)),n=u}else if(e.isLine){const l="LineBasicMaterial:"+n.uuid;let u=this.cache.get(l);u||(u=new Gl,Ii.prototype.copy.call(u,n),u.color.copy(n.color),u.map=n.map,this.cache.add(l,u)),n=u}if(i||s||a){let l="ClonedMaterial:"+n.uuid+":";i&&(l+="derivative-tangents:"),s&&(l+="vertex-colors:"),a&&(l+="flat-shading:");let u=this.cache.get(l);u||(u=n.clone(),s&&(u.vertexColors=!0),a&&(u.flatShading=!0),i&&(u.normalScale&&(u.normalScale.y*=-1),u.clearcoatNormalScale&&(u.clearcoatNormalScale.y*=-1)),this.cache.add(l,u),this.associations.set(u,this.associations.get(n))),n=u}e.material=n}getMaterialType(){return hs}loadMaterial(e){const t=this,n=this.json,i=this.extensions,s=n.materials[e];let a;const l={},u=s.extensions||{},h=[];if(u[Lt.KHR_MATERIALS_UNLIT]){const p=i[Lt.KHR_MATERIALS_UNLIT];a=p.getMaterialType(),h.push(p.extendParams(l,s,t))}else{const p=s.pbrMetallicRoughness||{};if(l.color=new ht(1,1,1),l.opacity=1,Array.isArray(p.baseColorFactor)){const m=p.baseColorFactor;l.color.setRGB(m[0],m[1],m[2],Xn),l.opacity=m[3]}p.baseColorTexture!==void 0&&h.push(t.assignTexture(l,"map",p.baseColorTexture,wn)),l.metalness=p.metallicFactor!==void 0?p.metallicFactor:1,l.roughness=p.roughnessFactor!==void 0?p.roughnessFactor:1,p.metallicRoughnessTexture!==void 0&&(h.push(t.assignTexture(l,"metalnessMap",p.metallicRoughnessTexture)),h.push(t.assignTexture(l,"roughnessMap",p.metallicRoughnessTexture))),a=this._invokeOne(function(m){return m.getMaterialType&&m.getMaterialType(e)}),h.push(Promise.all(this._invokeAll(function(m){return m.extendMaterialParams&&m.extendMaterialParams(e,l)})))}s.doubleSided===!0&&(l.side=Zn);const f=s.alphaMode||uh.OPAQUE;if(f===uh.BLEND?(l.transparent=!0,l.depthWrite=!1):(l.transparent=!1,f===uh.MASK&&(l.alphaTest=s.alphaCutoff!==void 0?s.alphaCutoff:.5)),s.normalTexture!==void 0&&a!==pi&&(h.push(t.assignTexture(l,"normalMap",s.normalTexture)),l.normalScale=new mt(1,1),s.normalTexture.scale!==void 0)){const p=s.normalTexture.scale;l.normalScale.set(p,p)}if(s.occlusionTexture!==void 0&&a!==pi&&(h.push(t.assignTexture(l,"aoMap",s.occlusionTexture)),s.occlusionTexture.strength!==void 0&&(l.aoMapIntensity=s.occlusionTexture.strength)),s.emissiveFactor!==void 0&&a!==pi){const p=s.emissiveFactor;l.emissive=new ht().setRGB(p[0],p[1],p[2],Xn)}return s.emissiveTexture!==void 0&&a!==pi&&h.push(t.assignTexture(l,"emissiveMap",s.emissiveTexture,wn)),Promise.all(h).then(function(){const p=new a(l);return s.name&&(p.name=s.name),Qi(p,s),t.associations.set(p,{materials:e}),s.extensions&&is(i,p,s),p})}createUniqueName(e){const t=Wt.sanitizeNodeName(e||"");return t in this.nodeNamesUsed?t+"_"+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){const t=this,n=this.extensions,i=this.primitiveCache;function s(l){return n[Lt.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(l,t).then(function(u){return lg(u,l,t)})}const a=[];for(let l=0,u=e.length;l<u;l++){const h=e[l],f=gD(h),p=i[f];if(p)a.push(p.promise);else{let m;h.extensions&&h.extensions[Lt.KHR_DRACO_MESH_COMPRESSION]?m=s(h):m=lg(new xn,h,t),i[f]={primitive:h,promise:m},a.push(m)}}return Promise.all(a)}loadMesh(e){const t=this,n=this.json,i=this.extensions,s=n.meshes[e],a=s.primitives,l=[];for(let u=0,h=a.length;u<h;u++){const f=a[u].material===void 0?fD(this.cache):this.getDependency("material",a[u].material);l.push(f)}return l.push(t.loadGeometries(a)),Promise.all(l).then(function(u){const h=u.slice(0,u.length-1),f=u[u.length-1],p=[];for(let g=0,x=f.length;g<x;g++){const E=f[g],v=a[g];let _;const R=h[g];if(v.mode===di.TRIANGLES||v.mode===di.TRIANGLE_STRIP||v.mode===di.TRIANGLE_FAN||v.mode===void 0)_=s.isSkinnedMesh===!0?new Gg(E,R):new Re(E,R),_.isSkinnedMesh===!0&&_.normalizeSkinWeights(),v.mode===di.TRIANGLE_STRIP?_.geometry=rg(_.geometry,Mg):v.mode===di.TRIANGLE_FAN&&(_.geometry=rg(_.geometry,Jh));else if(v.mode===di.LINES)_=new jg(E,R);else if(v.mode===di.LINE_STRIP)_=new xi(E,R);else if(v.mode===di.LINE_LOOP)_=new FP(E,R);else if(v.mode===di.POINTS)_=new NP(E,R);else throw new Error("THREE.GLTFLoader: Primitive mode unsupported: "+v.mode);Object.keys(_.geometry.morphAttributes).length>0&&mD(_,s),_.name=t.createUniqueName(s.name||"mesh_"+e),Qi(_,s),v.extensions&&is(i,_,v),t.assignFinalMaterial(_),p.push(_)}for(let g=0,x=p.length;g<x;g++)t.associations.set(p[g],{meshes:e,primitives:g});if(p.length===1)return s.extensions&&is(i,p[0],s),p[0];const m=new tr;s.extensions&&is(i,m,s),t.associations.set(m,{meshes:e});for(let g=0,x=p.length;g<x;g++)m.add(p[g]);return m})}loadCamera(e){let t;const n=this.json.cameras[e],i=n[n.type];if(!i){console.warn("THREE.GLTFLoader: Missing camera parameters.");return}return n.type==="perspective"?t=new Wn(Ag.radToDeg(i.yfov),i.aspectRatio||1,i.znear||1,i.zfar||2e6):n.type==="orthographic"&&(t=new bd(-i.xmag,i.xmag,i.ymag,-i.ymag,i.znear,i.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Qi(t,n),Promise.resolve(t)}loadSkin(e){const t=this.json.skins[e],n=[];for(let i=0,s=t.joints.length;i<s;i++)n.push(this._loadNodeShallow(t.joints[i]));return t.inverseBindMatrices!==void 0?n.push(this.getDependency("accessor",t.inverseBindMatrices)):n.push(null),Promise.all(n).then(function(i){const s=i.pop(),a=i,l=[],u=[];for(let h=0,f=a.length;h<f;h++){const p=a[h];if(p){l.push(p);const m=new bt;s!==null&&m.fromArray(s.array,h*16),u.push(m)}else console.warn('THREE.GLTFLoader: Joint "%s" could not be found.',t.joints[h])}return new ra(l,u)})}loadAnimation(e){const t=this.json,n=this,i=t.animations[e],s=i.name?i.name:"animation_"+e,a=[],l=[],u=[],h=[],f=[];for(let p=0,m=i.channels.length;p<m;p++){const g=i.channels[p],x=i.samplers[g.sampler],E=g.target,v=E.node,_=i.parameters!==void 0?i.parameters[x.input]:x.input,R=i.parameters!==void 0?i.parameters[x.output]:x.output;E.node!==void 0&&(a.push(this.getDependency("node",v)),l.push(this.getDependency("accessor",_)),u.push(this.getDependency("accessor",R)),h.push(x),f.push(E))}return Promise.all([Promise.all(a),Promise.all(l),Promise.all(u),Promise.all(h),Promise.all(f)]).then(function(p){const m=p[0],g=p[1],x=p[2],E=p[3],v=p[4],_=[];for(let R=0,A=m.length;R<A;R++){const S=m[R],k=g[R],N=x[R],O=E[R],H=v[R];if(S===void 0)continue;S.updateMatrix&&S.updateMatrix();const D=n._createAnimationTracks(S,k,N,O,H);if(D)for(let w=0;w<D.length;w++)_.push(D[w])}return new oo(s,void 0,_)})}createNodeMesh(e){const t=this.json,n=this,i=t.nodes[e];return i.mesh===void 0?null:n.getDependency("mesh",i.mesh).then(function(s){const a=n._getNodeRef(n.meshCache,i.mesh,s);return i.weights!==void 0&&a.traverse(function(l){if(l.isMesh)for(let u=0,h=i.weights.length;u<h;u++)l.morphTargetInfluences[u]=i.weights[u]}),a})}loadNode(e){const t=this.json,n=this,i=t.nodes[e],s=n._loadNodeShallow(e),a=[],l=i.children||[];for(let h=0,f=l.length;h<f;h++)a.push(n.getDependency("node",l[h]));const u=i.skin===void 0?Promise.resolve(null):n.getDependency("skin",i.skin);return Promise.all([s,Promise.all(a),u]).then(function(h){const f=h[0],p=h[1],m=h[2];m!==null&&f.traverse(function(g){g.isSkinnedMesh&&g.bind(m,vD)});for(let g=0,x=p.length;g<x;g++)f.add(p[g]);return f})}_loadNodeShallow(e){const t=this.json,n=this.extensions,i=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];const s=t.nodes[e],a=s.name?i.createUniqueName(s.name):"",l=[],u=i._invokeOne(function(h){return h.createNodeMesh&&h.createNodeMesh(e)});return u&&l.push(u),s.camera!==void 0&&l.push(i.getDependency("camera",s.camera).then(function(h){return i._getNodeRef(i.cameraCache,s.camera,h)})),i._invokeAll(function(h){return h.createNodeAttachment&&h.createNodeAttachment(e)}).forEach(function(h){l.push(h)}),this.nodeCache[e]=Promise.all(l).then(function(h){let f;if(s.isBone===!0?f=new Vl:h.length>1?f=new tr:h.length===1?f=h[0]:f=new on,f!==h[0])for(let p=0,m=h.length;p<m;p++)f.add(h[p]);if(s.name&&(f.userData.name=s.name,f.name=a),Qi(f,s),s.extensions&&is(n,f,s),s.matrix!==void 0){const p=new bt;p.fromArray(s.matrix),f.applyMatrix4(p)}else s.translation!==void 0&&f.position.fromArray(s.translation),s.rotation!==void 0&&f.quaternion.fromArray(s.rotation),s.scale!==void 0&&f.scale.fromArray(s.scale);return i.associations.has(f)||i.associations.set(f,{}),i.associations.get(f).nodes=e,f}),this.nodeCache[e]}loadScene(e){const t=this.extensions,n=this.json.scenes[e],i=this,s=new tr;n.name&&(s.name=i.createUniqueName(n.name)),Qi(s,n),n.extensions&&is(t,s,n);const a=n.nodes||[],l=[];for(let u=0,h=a.length;u<h;u++)l.push(i.getDependency("node",a[u]));return Promise.all(l).then(function(u){for(let f=0,p=u.length;f<p;f++)s.add(u[f]);const h=f=>{const p=new Map;for(const[m,g]of i.associations)(m instanceof Ii||m instanceof An)&&p.set(m,g);return f.traverse(m=>{const g=i.associations.get(m);g!=null&&p.set(m,g)}),p};return i.associations=h(s),s})}_createAnimationTracks(e,t,n,i,s){const a=[],l=e.name?e.name:e.uuid,u=[];vr[s.path]===vr.weights?e.traverse(function(m){m.morphTargetInfluences&&u.push(m.name?m.name:m.uuid)}):u.push(l);let h;switch(vr[s.path]){case vr.weights:h=so;break;case vr.rotation:h=wr;break;case vr.position:case vr.scale:h=Ar;break;default:switch(n.itemSize){case 1:h=so;break;case 2:case 3:default:h=Ar;break}break}const f=i.interpolation!==void 0?dD[i.interpolation]:ta,p=this._getArrayFromAccessor(n);for(let m=0,g=u.length;m<g;m++){const x=new h(u[m]+"."+vr[s.path],t.array,p,f);i.interpolation==="CUBICSPLINE"&&this._createCubicSplineTrackInterpolant(x),a.push(x)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){const n=ad(t.constructor),i=new Float32Array(t.length);for(let s=0,a=t.length;s<a;s++)i[s]=t[s]*n;t=i}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(n){const i=this instanceof wr?hD:o_;return new i(this.times,this.values,this.getValueSize()/3,n)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}}function xD(r,e,t){const n=e.attributes,i=new Ti;if(n.POSITION!==void 0){const l=t.json.accessors[n.POSITION],u=l.min,h=l.max;if(u!==void 0&&h!==void 0){if(i.set(new F(u[0],u[1],u[2]),new F(h[0],h[1],h[2])),l.normalized){const f=ad($s[l.componentType]);i.min.multiplyScalar(f),i.max.multiplyScalar(f)}}else{console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.");return}}else return;const s=e.targets;if(s!==void 0){const l=new F,u=new F;for(let h=0,f=s.length;h<f;h++){const p=s[h];if(p.POSITION!==void 0){const m=t.json.accessors[p.POSITION],g=m.min,x=m.max;if(g!==void 0&&x!==void 0){if(u.setX(Math.max(Math.abs(g[0]),Math.abs(x[0]))),u.setY(Math.max(Math.abs(g[1]),Math.abs(x[1]))),u.setZ(Math.max(Math.abs(g[2]),Math.abs(x[2]))),m.normalized){const E=ad($s[m.componentType]);u.multiplyScalar(E)}l.max(u)}else console.warn("THREE.GLTFLoader: Missing min/max properties for accessor POSITION.")}}i.expandByVector(l)}r.boundingBox=i;const a=new Li;i.getCenter(a.center),a.radius=i.min.distanceTo(i.max)/2,r.boundingSphere=a}function lg(r,e,t){const n=e.attributes,i=[];function s(a,l){return t.getDependency("accessor",a).then(function(u){r.setAttribute(l,u)})}for(const a in n){const l=od[a]||a.toLowerCase();l in r.attributes||i.push(s(n[a],l))}if(e.indices!==void 0&&!r.index){const a=t.getDependency("accessor",e.indices).then(function(l){r.setIndex(l)});i.push(a)}return Bt.workingColorSpace!==Xn&&"COLOR_0"in n&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${Bt.workingColorSpace}" not supported.`),Qi(r,e),xD(r,e,t),Promise.all(i).then(function(){return e.targets!==void 0?pD(r,e.targets,t):r})}const a_=new zC,bD=new n_;let ao=0;async function SD(r,e){return new Promise((t,n)=>{a_.load(r,i=>{const s=i.scene;e.add(s),s.traverse(u=>{u.isMesh&&(u.castShadow=!0,u.receiveShadow=!0)}),ao++;const a=`Asset ${ao}`,l=Id();l&&Ld(l,a,s),t(s)},void 0,i=>n(i))})}async function ED(r,e){const t=URL.createObjectURL(r);try{return await SD(t,e)}finally{URL.revokeObjectURL(t)}}const MD=[{color:13935988,roughness:.55,metalness:0},{color:13935988,roughness:.55,metalness:0},{color:1118481,roughness:.8,metalness:0},{color:657930,roughness:.1,metalness:0},{color:16052456,roughness:.2,metalness:0},{color:16052456,roughness:.05,metalness:0,opacity:.3,transparent:!0},{color:4881051,roughness:.15,metalness:0},{color:11885162,roughness:.7,metalness:0},{color:15789280,roughness:.3,metalness:0},{color:14723210,roughness:.4,metalness:0},{color:14723210,roughness:.4,metalness:0}];function Ll(r){const e=atob(r),t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return new Float32Array(t.buffer)}function l_(r){const e=atob(r),t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return new Uint32Array(t.buffer)}function ld(r){for(let e=0;e<r.length;e+=3){const t=r[e+1],n=r[e+2];r[e+1]=n,r[e+2]=-t}}function TD(r){const e=Ll(r.vertices),t=l_(r.faces);ld(e);const n=new xn,i=new dn(e,3),s=new dn(t,1);if(n.setAttribute("position",i),n.setIndex(s),r.uvs){const f=Ll(r.uvs);n.setAttribute("uv",new dn(f,2))}if(r.normals){const f=Ll(r.normals);ld(f),n.setAttribute("normal",new dn(f,3))}else n.computeVertexNormals();const a=MD.map(f=>new hs({color:f.color,roughness:f.roughness,metalness:f.metalness,side:Zn,transparent:f.transparent||!1,opacity:f.opacity!==void 0?f.opacity:1})),l=r.groups||[];let u;if(s&&l.length>0){for(const f of l)n.addGroup(f.start,f.count,f.materialIndex);u=new Re(n,a)}else u=new Re(n,a[0]);u.castShadow=!0,u.receiveShadow=!0;const h=new tr;return h.add(u),h}async function dh(r,e,t){const n=new URLSearchParams;if(e.body_type&&n.set("body_type",e.body_type),e.morphs&&typeof e.morphs=="object")for(const[m,g]of Object.entries(e.morphs))g!=null&&n.set(`morph_${m}`,String(g));if(e.user_morphs&&typeof e.user_morphs=="object")for(const[m,g]of Object.entries(e.user_morphs))g!=null&&n.set(`morph_${m}`,String(g));const i=["age","mass","tone","height"],s=e.meta||{};for(const m of i){const g=s[m]??e[`meta_${m}`];g!=null&&n.set(`meta_${m}`,String(g))}const a=`/api/character/mesh/?${n.toString()}`,l=await fetch(a);if(!l.ok)throw new Error(`Character mesh API error: ${l.status}`);const u=await l.json(),h=TD(u);if(r.add(h),h.userData.bodyType=e.body_type||"Female_Caucasian",h.userData.morphs={...e.morphs||{},...e.user_morphs||{}},h.userData.meta={...e.meta||{}},h.userData.presetName=t,e.hair_style&&e.hair_style.url)try{const m=await wD(e.hair_style.url);m.userData.isHair=!0,m.traverse(g=>{g.isMesh&&(g.userData.isHair=!0)}),h.add(m),console.log("✓ Hair loaded:",e.hair_style.name)}catch(m){console.error("Failed to load hair:",m)}if(e.garments&&Array.isArray(e.garments))for(const m of e.garments)try{const g=await AD(m,e.body_type);g.userData.isGarment=!0,h.add(g),console.log("✓ Garment loaded:",m.id)}catch(g){console.error("Failed to load garment:",m.id,g)}ao++;const f=t||`Character ${ao}`,p=Id();return p&&Ld(p,f,h),h}async function wD(r){return new Promise((e,t)=>{a_.load(r,n=>{const i=n.scene;i.traverse(s=>{if(s.isMesh&&(s.castShadow=!0,s.receiveShadow=!0,s.material)){if(s.material.color){const a=s.material.color;a.r>.9&&a.g>.9&&a.b>.9&&s.material.color.setRGB(.1,.08,.06)}s.material.roughness===void 0&&(s.material.roughness=.8),s.material.metalness===void 0&&(s.material.metalness=0)}}),e(i)},void 0,n=>t(n))})}async function AD(r,e){const{id:t,offset:n=.006,stiffness:i=.8,color:s=[.3,.35,.5],roughness:a=.8,metalness:l=0}=r,u=s[0]??.3,h=s[1]??.35,f=s[2]??.5,p=`garment_id=${encodeURIComponent(t)}&body_type=${encodeURIComponent(e)}&offset=${n}&stiffness=${i}&color_r=${u.toFixed(3)}&color_g=${h.toFixed(3)}&color_b=${f.toFixed(3)}`,m=await fetch(`/api/character/garment/fit/?${p}`);if(!m.ok)throw new Error(`Garment fit API error: ${m.status}`);const g=await m.json();if(g.error)throw new Error(g.error);const x=Ll(g.vertices);ld(x);const E=l_(g.faces),v=new xn;v.setAttribute("position",new dn(x,3)),v.setIndex(new dn(E,1)),v.computeVertexNormals();const _=new ht(g.color[0],g.color[1],g.color[2]),R=new hs({color:_,roughness:a,metalness:l,side:Zn,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnit:-1}),A=new Re(v,R);return A.castShadow=!0,A.receiveShadow=!0,A.userData.garmentId=t,A.userData.offset=n,A.userData.stiffness=i,A.userData.originalColor=[u,h,f],A.userData.roughness=a,A.userData.metalness=l,A.name=t,A}function RD(r,e,t){const n=bD.parse(r),i=new Jg(n.skeleton.bones[0]);i.skeleton=n.skeleton,i.visible=!0,i.userData.isRig=!0,i.renderOrder=999,i.material&&(i.material.depthTest=!1,i.material.depthWrite=!1);const s=n.skeleton.bones[0];s.userData.isRig=!0,e.add(s),e.add(i);const a=new Zg(s),l=a.clipAction(n.clip);l.setLoop(gd),l.play(),l.paused=!0,ao++;const u=Id();u&&Ld(u,t||`BVH ${ao}`,s);const h=n.clip.duration||1;return{mixer:a,action:l,skeleton:i,clip:n.clip,rootBone:s,duration:h}}class PD{constructor(e){this._canvas=e,this._recorder=null,this._chunks=[]}start(e=30){const t=this._canvas.captureStream(e);this._chunks=[];const n=MediaRecorder.isTypeSupported("video/webm;codecs=vp9")?"video/webm;codecs=vp9":"video/webm;codecs=vp8";this._recorder=new MediaRecorder(t,{mimeType:n,videoBitsPerSecond:8e6}),this._recorder.ondataavailable=i=>{i.data.size>0&&this._chunks.push(i.data)},this._recorder.start()}stop(){return new Promise(e=>{this._recorder.onstop=()=>{const t=new Blob(this._chunks,{type:"video/webm"});this._chunks=[],e(t)},this._recorder.stop()})}get isRecording(){var e;return((e=this._recorder)==null?void 0:e.state)==="recording"}async stopAndDownload(e="theatre-export.webm"){const t=await this.stop(),n=URL.createObjectURL(t),i=document.createElement("a");i.href=n,i.download=e,i.click(),URL.revokeObjectURL(n)}}async function CD(){const r=await fetch("/api/character/scenes/");if(!r.ok)throw new Error(`Scene list error: ${r.status}`);return(await r.json()).scenes||[]}async function DD(r){const e=await fetch(`/api/character/scene/${encodeURIComponent(r)}/`);if(!e.ok)throw new Error(`Scene load error: ${e.status}`);return e.json()}async function ID(r,e){const t=await fetch("/api/character/scene/save/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({name:r,data:e})});if(!t.ok){const n=await t.json().catch(()=>({}));throw new Error(n.error||`Scene save error: ${t.status}`)}return t.json()}async function LD(){const r=await fetch("/api/character/models/");if(!r.ok)throw new Error(`Model list error: ${r.status}`);return(await r.json()).presets||[]}async function cg(r){const e=await fetch(`/api/character/model/${encodeURIComponent(r)}/`);if(!e.ok)throw new Error(`Model load error: ${e.status}`);return e.json()}async function FD(){const r=await fetch("/api/character/animations/");if(!r.ok)throw new Error(`Animation list error: ${r.status}`);return(await r.json()).categories||{}}async function ND(r,e){const t=`/api/character/bvh/${encodeURIComponent(r)}/${encodeURIComponent(e)}/`,n=await fetch(t);if(!n.ok)throw new Error(`BVH load error: ${n.status}`);return n.text()}const fh={ballet_stage:{name:"Ballet Stage",description:"Warme Spotlights, theatralisch dunkel",camera:{position:{x:0,y:1.6,z:5},fov:35},lights:{spotLeft:{intensity:60,color:{r:1,g:.933,b:.867},position:{x:-3,y:6,z:3}},spotRight:{intensity:60,color:{r:1,g:.933,b:.867},position:{x:3,y:6,z:3}},backLight:{intensity:25,color:{r:.4,g:.267,b:.667},position:{x:0,y:5,z:-4}}}},studio_bright:{name:"Studio Bright",description:"Helle, gleichmäßige Beleuchtung für Details",camera:{position:{x:0,y:1.6,z:4},fov:40},lights:{spotLeft:{intensity:80,color:{r:1,g:1,b:1},position:{x:-2,y:5,z:4}},spotRight:{intensity:80,color:{r:1,g:1,b:1},position:{x:2,y:5,z:4}},backLight:{intensity:30,color:{r:.9,g:.95,b:1},position:{x:0,y:4,z:-3}}}},cinematic_moody:{name:"Cinematic Moody",description:"Dramatisches Film-noir-Licht, starke Schatten",camera:{position:{x:2,y:1.4,z:4},fov:28},lights:{spotLeft:{intensity:15,color:{r:1,g:.8,b:.6},position:{x:-4,y:7,z:2}},spotRight:{intensity:2,color:{r:.6,g:.7,b:.9},position:{x:4,y:3,z:3}},backLight:{intensity:10,color:{r:.3,g:.5,b:1},position:{x:1,y:6,z:-5}}}},fashion_show:{name:"Fashion Show",description:"Laufsteg-Beleuchtung, kühles Weiß von oben",camera:{position:{x:0,y:1.2,z:6},fov:50},lights:{spotLeft:{intensity:10,color:{r:.95,g:.97,b:1},position:{x:-2,y:8,z:2}},spotRight:{intensity:10,color:{r:.95,g:.97,b:1},position:{x:2,y:8,z:2}},backLight:{intensity:5,color:{r:1,g:1,b:1},position:{x:0,y:3,z:-2}}}},sunset_warm:{name:"Sunset Warm",description:"Goldene Stunde, warmes Orange-Gold",camera:{position:{x:-1,y:1.5,z:4.5},fov:42},lights:{spotLeft:{intensity:14,color:{r:1,g:.7,b:.4},position:{x:-5,y:4,z:3}},spotRight:{intensity:6,color:{r:1,g:.85,b:.7},position:{x:3,y:5,z:2}},backLight:{intensity:8,color:{r:.8,g:.4,b:.6},position:{x:2,y:5,z:-4}}}}};function ph(r,e,t,n){console.log(`[Preset] Applying: ${r.name}`),e.position.set(r.camera.position.x,r.camera.position.y,r.camera.position.z),e.fov=r.camera.fov,e.updateProjectionMatrix(),n&&(n.target.set(0,.9,0),n.update()),mh(t.spotLeft,r.lights.spotLeft),mh(t.spotRight,r.lights.spotRight),mh(t.backLight,r.lights.backLight),console.log(`✓ Preset "${r.name}" applied (direct Three.js)`)}function mh(r,e){r&&(r.intensity=e.intensity,r.color.setRGB(e.color.r,e.color.g,e.color.b),r.position.set(e.position.x,e.position.y,e.position.z))}const OD={Hips:"DEF-spine",Spine:"DEF-spine.001",Spine1:"DEF-spine.003",Neck:null,Neck1:"DEF-spine.004",Head:"DEF-spine.006",LeftShoulder:"DEF-shoulder.L",LeftArm:"DEF-upper_arm.L",LeftForeArm:"DEF-forearm.L",LeftHand:"DEF-hand.L",RightShoulder:"DEF-shoulder.R",RightArm:"DEF-upper_arm.R",RightForeArm:"DEF-forearm.R",RightHand:"DEF-hand.R",LeftUpLeg:"DEF-thigh.L",LeftLeg:"DEF-shin.L",LeftFoot:"DEF-foot.L",LeftToeBase:"DEF-toe.L",RightUpLeg:"DEF-thigh.R",RightLeg:"DEF-shin.R",RightFoot:"DEF-foot.R",RightToeBase:"DEF-toe.R",LHipJoint:null,RHipJoint:null,LowerBack:null,LeftFingerBase:null,RightFingerBase:null,LThumb:null,RThumb:null},UD={Hips:"DEF-spine",Spine:"DEF-spine.001",Spine1:"DEF-spine.002",Spine2:"DEF-spine.003",Neck:null,Neck1:"DEF-spine.004",Head:"DEF-spine.006",LeftShoulder:"DEF-shoulder.L",LeftArm:"DEF-upper_arm.L",LeftForeArm:"DEF-forearm.L",LeftHand:"DEF-hand.L",RightShoulder:"DEF-shoulder.R",RightArm:"DEF-upper_arm.R",RightForeArm:"DEF-forearm.R",RightHand:"DEF-hand.R",LeftUpLeg:"DEF-thigh.L",LeftLeg:"DEF-shin.L",LeftFoot:"DEF-foot.L",LeftToeBase:"DEF-toe.L",RightUpLeg:"DEF-thigh.R",RightLeg:"DEF-shin.R",RightFoot:"DEF-foot.R",RightToeBase:"DEF-toe.R",LeftHandThumb1:"DEF-thumb.01.L",LeftHandThumb2:"DEF-thumb.02.L",LeftHandThumb3:"DEF-thumb.03.L",LeftHandIndex1:"DEF-f_index.01.L",LeftHandIndex2:"DEF-f_index.02.L",LeftHandIndex3:"DEF-f_index.03.L",LeftHandMiddle1:"DEF-f_middle.01.L",LeftHandMiddle2:"DEF-f_middle.02.L",LeftHandMiddle3:"DEF-f_middle.03.L",LeftHandRing1:"DEF-f_ring.01.L",LeftHandRing2:"DEF-f_ring.02.L",LeftHandRing3:"DEF-f_ring.03.L",LeftHandPinky1:"DEF-f_pinky.01.L",LeftHandPinky2:"DEF-f_pinky.02.L",LeftHandPinky3:"DEF-f_pinky.03.L",RightHandThumb1:"DEF-thumb.01.R",RightHandThumb2:"DEF-thumb.02.R",RightHandThumb3:"DEF-thumb.03.R",RightHandIndex1:"DEF-f_index.01.R",RightHandIndex2:"DEF-f_index.02.R",RightHandIndex3:"DEF-f_index.03.R",RightHandMiddle1:"DEF-f_middle.01.R",RightHandMiddle2:"DEF-f_middle.02.R",RightHandMiddle3:"DEF-f_middle.03.R",RightHandRing1:"DEF-f_ring.01.R",RightHandRing2:"DEF-f_ring.02.R",RightHandRing3:"DEF-f_ring.03.R",RightHandPinky1:"DEF-f_pinky.01.R",RightHandPinky2:"DEF-f_pinky.02.R",RightHandPinky3:"DEF-f_pinky.03.R"},BD={hip:"DEF-spine",abdomen:"DEF-spine.001",chest:"DEF-spine.003",neck1:"DEF-spine.004",head:"DEF-spine.006",lcollar:"DEF-shoulder.L",rcollar:"DEF-shoulder.R",lshoulder:"DEF-upper_arm.L",rshoulder:"DEF-upper_arm.R",lelbow:"DEF-forearm.L",relbow:"DEF-forearm.R",lhand:"DEF-hand.L",rhand:"DEF-hand.R",lhip:"DEF-thigh.L",rhip:"DEF-thigh.R",lknee:"DEF-shin.L",rknee:"DEF-shin.R",lfoot:"DEF-foot.L",rfoot:"DEF-foot.R","toe1-1.l":"DEF-toe.L","toe1-1.r":"DEF-toe.R",lCollar:"DEF-shoulder.L",rCollar:"DEF-shoulder.R",lShldr:"DEF-upper_arm.L",rShldr:"DEF-upper_arm.R",lForeArm:"DEF-forearm.L",rForeArm:"DEF-forearm.R",lHand:"DEF-hand.L",rHand:"DEF-hand.R",lThigh:"DEF-thigh.L",rThigh:"DEF-thigh.R",lShin:"DEF-shin.L",rShin:"DEF-shin.R",lFoot:"DEF-foot.L",rFoot:"DEF-foot.R",lButtock:null,rButtock:null,"toe1-1.L":"DEF-toe.L","toe1-1.R":"DEF-toe.R",lthumb:"DEF-thumb.01.L","finger1-2.l":"DEF-thumb.02.L","finger1-3.l":"DEF-thumb.03.L","finger2-1.l":"DEF-f_index.01.L","finger2-2.l":"DEF-f_index.02.L","finger2-3.l":"DEF-f_index.03.L","finger3-1.l":"DEF-f_middle.01.L","finger3-2.l":"DEF-f_middle.02.L","finger3-3.l":"DEF-f_middle.03.L","finger4-1.l":"DEF-f_ring.01.L","finger4-2.l":"DEF-f_ring.02.L","finger4-3.l":"DEF-f_ring.03.L","finger5-1.l":"DEF-f_pinky.01.L","finger5-2.l":"DEF-f_pinky.02.L","finger5-3.l":"DEF-f_pinky.03.L",rthumb:"DEF-thumb.01.R","finger1-2.r":"DEF-thumb.02.R","finger1-3.r":"DEF-thumb.03.R","finger2-1.r":"DEF-f_index.01.R","finger2-2.r":"DEF-f_index.02.R","finger2-3.r":"DEF-f_index.03.R","finger3-1.r":"DEF-f_middle.01.R","finger3-2.r":"DEF-f_middle.02.R","finger3-3.r":"DEF-f_middle.03.R","finger4-1.r":"DEF-f_ring.01.R","finger4-2.r":"DEF-f_ring.02.R","finger4-3.r":"DEF-f_ring.03.R","finger5-1.r":"DEF-f_pinky.01.R","finger5-2.r":"DEF-f_pinky.02.R","finger5-3.r":"DEF-f_pinky.03.R","metacarpal1.l":"DEF-palm.01.L","metacarpal2.l":"DEF-palm.02.L","metacarpal3.l":"DEF-palm.03.L","metacarpal4.l":"DEF-palm.04.L","metacarpal1.r":"DEF-palm.01.R","metacarpal2.r":"DEF-palm.02.R","metacarpal3.r":"DEF-palm.03.R","metacarpal4.r":"DEF-palm.04.R",jaw:"DEF-jaw",tongue01:"DEF-tongue",tongue02:"DEF-tongue.001",tongue03:"DEF-tongue.002","eye.l":"MCH-eye.L","eye.r":"MCH-eye.R","oris04.l":"DEF-lip.T.L","oris04.r":"DEF-lip.T.R","oris03.l":"DEF-lip.T.L.001","oris03.r":"DEF-lip.T.R.001","oris06.l":"DEF-lip.B.L","oris06.r":"DEF-lip.B.R","oris07.l":"DEF-lip.B.L.001","oris07.r":"DEF-lip.B.R.001","orbicularis03.l":"DEF-lid.T.L","orbicularis03.r":"DEF-lid.T.R","orbicularis04.l":"DEF-lid.B.L","orbicularis04.r":"DEF-lid.B.R"},kD={Pelvis:"DEF-spine",Spine1:"DEF-spine.001",Spine2:"DEF-spine.002",Spine3:"DEF-spine.003",Neck:"DEF-spine.004",Head:"DEF-spine.006",Left_collar:"DEF-shoulder.L",Left_shoulder:"DEF-upper_arm.L",Left_elbow:"DEF-forearm.L",Left_wrist:"DEF-hand.L",Left_palm:null,Right_collar:"DEF-shoulder.R",Right_shoulder:"DEF-upper_arm.R",Right_elbow:"DEF-forearm.R",Right_wrist:"DEF-hand.R",Right_palm:null,Left_hip:"DEF-thigh.L",Left_knee:"DEF-shin.L",Left_ankle:"DEF-foot.L",Left_foot:"DEF-toe.L",Right_hip:"DEF-thigh.R",Right_knee:"DEF-shin.R",Right_ankle:"DEF-foot.R",Right_foot:"DEF-toe.R"},zD={hip:"DEF-spine",abdomen:"DEF-spine.001",chest:"DEF-spine.003",neck:null,neck1:"DEF-spine.004",head:"DEF-spine.006",lCollar:"DEF-shoulder.L",rCollar:"DEF-shoulder.R",lShldr:"DEF-upper_arm.L",rShldr:"DEF-upper_arm.R",lForeArm:"DEF-forearm.L",rForeArm:"DEF-forearm.R",lHand:"DEF-hand.L",rHand:"DEF-hand.R",lButtock:null,rButtock:null,lThigh:"DEF-thigh.L",rThigh:"DEF-thigh.R",lShin:"DEF-shin.L",rShin:"DEF-shin.R",lFoot:"DEF-foot.L",rFoot:"DEF-foot.R","toe1-1.L":"DEF-toe.L","toe1-1.R":"DEF-toe.R",lthumb:"DEF-thumb.01.L","finger1-2.l":"DEF-thumb.02.L","finger1-3.l":"DEF-thumb.03.L","finger2-1.l":"DEF-f_index.01.L","finger2-2.l":"DEF-f_index.02.L","finger2-3.l":"DEF-f_index.03.L","finger3-1.l":"DEF-f_middle.01.L","finger3-2.l":"DEF-f_middle.02.L","finger3-3.l":"DEF-f_middle.03.L","finger4-1.l":"DEF-f_ring.01.L","finger4-2.l":"DEF-f_ring.02.L","finger4-3.l":"DEF-f_ring.03.L","finger5-1.l":"DEF-f_pinky.01.L","finger5-2.l":"DEF-f_pinky.02.L","finger5-3.l":"DEF-f_pinky.03.L",rthumb:"DEF-thumb.01.R","finger1-2.r":"DEF-thumb.02.R","finger1-3.r":"DEF-thumb.03.R","finger2-1.r":"DEF-f_index.01.R","finger2-2.r":"DEF-f_index.02.R","finger2-3.r":"DEF-f_index.03.R","finger3-1.r":"DEF-f_middle.01.R","finger3-2.r":"DEF-f_middle.02.R","finger3-3.r":"DEF-f_middle.03.R","finger4-1.r":"DEF-f_ring.01.R","finger4-2.r":"DEF-f_ring.02.R","finger4-3.r":"DEF-f_ring.03.R","finger5-1.r":"DEF-f_pinky.01.R","finger5-2.r":"DEF-f_pinky.02.R","finger5-3.r":"DEF-f_pinky.03.R","metacarpal1.l":"DEF-palm.01.L","metacarpal2.l":"DEF-palm.02.L","metacarpal3.l":"DEF-palm.03.L","metacarpal4.l":"DEF-palm.04.L","metacarpal1.r":"DEF-palm.01.R","metacarpal2.r":"DEF-palm.02.R","metacarpal3.r":"DEF-palm.03.R","metacarpal4.r":"DEF-palm.04.R",jaw:"DEF-jaw",tongue01:"DEF-tongue",tongue02:"DEF-tongue.001",tongue03:"DEF-tongue.002","eye.l":"MCH-eye.L","eye.r":"MCH-eye.R","oris04.l":"DEF-lip.T.L","oris04.r":"DEF-lip.T.R","oris03.l":"DEF-lip.T.L.001","oris03.r":"DEF-lip.T.R.001","oris06.l":"DEF-lip.B.L","oris06.r":"DEF-lip.B.R","oris07.l":"DEF-lip.B.L.001","oris07.r":"DEF-lip.B.R.001","orbicularis03.l":"DEF-lid.T.L","orbicularis03.r":"DEF-lid.T.R","orbicularis04.l":"DEF-lid.B.L","orbicularis04.r":"DEF-lid.B.R"},HD={Hips:"DEF-spine",Spine:"DEF-spine.001",Chest:"DEF-spine.003",Neck:"DEF-spine.004",Head:"DEF-spine.006",Shoulder_L:"DEF-shoulder.L",UpperArm_L:"DEF-upper_arm.L",LowerArm_L:"DEF-forearm.L",Hand_L:"DEF-hand.L",Shoulder_R:"DEF-shoulder.R",UpperArm_R:"DEF-upper_arm.R",LowerArm_R:"DEF-forearm.R",Hand_R:"DEF-hand.R",UpperLeg_L:"DEF-thigh.L",LowerLeg_L:"DEF-shin.L",Foot_L:"DEF-foot.L",Toes_L:"DEF-toe.L",UpperLeg_R:"DEF-thigh.R",LowerLeg_R:"DEF-shin.R",Foot_R:"DEF-foot.R",Toes_R:"DEF-toe.R",joint_Root:null};function VD(r,e,t,n={}){const i=r.skeleton.bones,s=r.clip,a=t==="CMU"?OD:t==="MIXAMO"?UD:t==="BANDAI"?HD:t==="AIST"?kD:t==="OPENPOSE"?zD:BD;e.rootBone.updateWorldMatrix(!0,!0);const l={},u={},h=new Map;for(const[fe,Me]of Object.entries(e.boneByName))h.set(Me,fe);for(const[fe,Me]of Object.entries(e.boneByName)){l[fe]=new Pt,Me.getWorldQuaternion(l[fe]);const De=h.get(Me.parent);De&&l[De]?u[fe]=l[De]:Me.parent&&(u[fe]=new Pt,Me.parent.getWorldQuaternion(u[fe]))}const f={};for(const fe of i)f[fe.name]=fe;const p=i[0],m=[],g={};function x(fe){m.push(fe.name);for(const Me of fe.children)Me.isBone&&(g[Me.name]=fe.name,x(Me))}x(p);const E={};for(const[fe,Me]of Object.entries(a))Me&&f[fe]&&e.boneByName[Me]&&(E[Me]=fe);const v=new Set(Object.keys(E));console.log(`[RETARGET] ${v.size} bones mapped`);const _={},R={};for(const fe of s.tracks){const Me=fe.name.lastIndexOf(".");if(Me<0)continue;const De=fe.name.substring(0,Me),V=fe.name.substring(Me+1);V==="quaternion"&&(_[De]=fe),V==="position"&&(R[De]=fe)}const A=new Ti,S=new Pt,k=new F;function N(fe,Me,De){k.copy(fe.position).applyQuaternion(Me);const V=De.clone().add(k);A.expandByPoint(V),S.copy(Me).multiply(fe.quaternion);for(const ct of fe.children)ct.isBone&&N(ct,S.clone(),V)}N(p,new Pt,new F);const O=Math.max(A.max.y-A.min.y,.01);let H=1.68;if(n.bodyMesh){const fe=new Ti().setFromObject(n.bodyMesh);fe.isEmpty()||(H=fe.max.y-fe.min.y)}const D=H/O,w={};for(const[fe,Me]of Object.entries(e.boneByName))u[fe]?w[fe]=u[fe].clone().invert().multiply(l[fe]):w[fe]=l[fe].clone();const U={},Q=t==="BANDAI";if(Q){const fe=new Pt;for(const Me of m){const De=_[Me];De?fe.set(De.values[0],De.values[1],De.values[2],De.values[3]):fe.set(0,0,0,1);const V=g[Me];V&&U[V]?U[Me]=U[V].clone().multiply(fe):U[Me]=fe.clone()}}const Z=new F(0,0,-1),re={},le=Object.values(a).find(fe=>fe&&e.boneByName[fe]),X=new Set;t==="AIST"&&(X.add("DEF-foot.L"),X.add("DEF-foot.R"),X.add("DEF-toe.L"),X.add("DEF-toe.R"),X.add("DEF-spine.004"),X.add("DEF-spine.006")),t==="MOCAPNET"&&(X.add("DEF-foot.L"),X.add("DEF-foot.R"),X.add("DEF-toe.L"),X.add("DEF-toe.R"),X.add("DEF-jaw"),X.add("DEF-spine.004"),X.add("DEF-spine.006")),t==="OPENPOSE"&&(X.add("DEF-foot.L"),X.add("DEF-foot.R"),X.add("DEF-toe.L"),X.add("DEF-toe.R"),X.add("DEF-jaw"),X.add("DEF-spine.004"),X.add("DEF-spine.006"),X.add("DEF-shoulder.L"),X.add("DEF-shoulder.R"));for(const[fe,Me]of Object.entries(E)){if(fe===le||X.has(fe)){re[fe]=l[fe].clone();continue}const De=Z.clone().applyQuaternion(l[fe]).normalize(),V=f[Me];let ct=null,st=-1/0;for(const $e of V.children)if($e.isBone&&$e.position.lengthSq()>1e-10){let ze;Q&&U[Me]?ze=$e.position.clone().applyQuaternion(U[Me]).normalize():ze=$e.position.clone().normalize();const dt=ze.dot(De);dt>st&&(st=dt,ct=ze)}if(!ct&&V.position.lengthSq()>1e-10)if(Q){const $e=g[Me];$e&&U[$e]?ct=V.position.clone().applyQuaternion(U[$e]).normalize():ct=V.position.clone().normalize()}else ct=V.position.clone().normalize();if(!ct||ct.lengthSq()<1e-10)re[fe]=l[fe].clone();else{const $e=new Pt().setFromUnitVectors(De,ct);re[fe]=$e.multiply(l[fe])}}const de=Object.keys(e.boneByName).sort((fe,Me)=>{let De=0,V=e.boneByName[fe];for(;V.parent;)De++,V=V.parent;let ct=0,st=e.boneByName[Me];for(;st.parent;)ct++,st=st.parent;return De-ct}),te=Object.values(_)[0];if(!te)return new oo("retargeted",0,[]);const ve=te.times,Se=ve.length,Be={};for(const fe of v)Be[fe]=new Float32Array(Se*4);const je=new Pt,Tt=new Pt,ue={},ge={};let ke=null;if(n.footCorrection){ke={};const fe=new Pt,Me=new F,De=180/Math.PI,V=15,ct=1.5;for(const st of["DEF-foot.L","DEF-foot.R"]){const $e=E[st];if(!$e)continue;const ze=[];let dt=$e;for(;dt;)ze.unshift(dt),dt=g[dt];const He=new Float32Array(Se);let L=0,T=0;for(let K=0;K<Se;K++){const ce=K*4;let pe=new Pt;for(const Ge of ze){const we=_[Ge];we?fe.set(we.values[ce],we.values[ce+1],we.values[ce+2],we.values[ce+3]):fe.set(0,0,0,1),pe.multiply(fe)}Me.set(0,0,-1).applyQuaternion(pe);const he=Math.asin(Math.max(-1,Math.min(1,-Me.y)))*De;if(he>T&&(T=he),he>V){const Ge=Math.min(90,he+(he-V)*ct),we=90-he;He[K]=we>.1?Math.min((Ge-he)/we,1):0}He[K]>L&&(L=He[K])}ke[st]=He,console.log(`[FOOT-CORRECTION] ${st}: maxAngle=${T.toFixed(1)}, thresh=${V}, boost=${ct}x, maxCorr=${L.toFixed(2)}`)}Object.keys(ke).length===0&&(ke=null)}for(let fe=0;fe<Se;fe++){const Me=fe*4;for(const De of m){const V=_[De];V?je.set(V.values[Me],V.values[Me+1],V.values[Me+2],V.values[Me+3]):je.set(0,0,0,1);const ct=g[De];ct&&ge[ct]?ge[De]=ge[ct].clone().multiply(je):ge[De]=je.clone()}for(const De of de){const V=e.boneByName[De],ct=h.get(V.parent),st=ct&&ue[ct]?ue[ct]:new Pt;if(v.has(De)){const $e=E[De];if(Q){const dt=ge[$e],He=U[$e];dt&&He?(Tt.copy(dt).multiply(He.clone().invert()).multiply(re[De]).normalize(),je.copy(st).invert().multiply(Tt).normalize()):je.copy(w[De]||new Pt)}else{const dt=ge[$e];dt?(Tt.copy(dt).multiply(re[De]).normalize(),je.copy(st).invert().multiply(Tt).normalize()):je.copy(w[De]||new Pt)}if(ke&&ke[De]){const dt=ke[De][fe];if(dt>.01){const He=st.clone().multiply(je),L=new F(0,0,-1).applyQuaternion(He).normalize(),T=new F(0,-1,0),ce=new Pt().setFromUnitVectors(L,T).multiply(He),pe=st.clone().invert().multiply(ce).normalize();je.slerp(pe,dt)}}const ze=Be[De];ze[Me]=je.x,ze[Me+1]=je.y,ze[Me+2]=je.z,ze[Me+3]=je.w,ue[De]=st.clone().multiply(je)}else ue[De]=st.clone().multiply(w[De]||new Pt)}}const Ee=[];for(const fe of v){const Me=e.boneByName[fe];Ee.push(new wr(`${Me.name}.quaternion`,ve,Be[fe]))}const Ye=i[0].name;let at=a[Ye];const rt=R[Ye];if(!at&&rt){for(const fe of i[0].children)if(fe.isBone&&a[fe.name]){at=a[fe.name];break}}if(at&&rt){const fe=e.boneByName[at];if(fe){const Me=new F(rt.values[0],rt.values[1],rt.values[2]),De=fe.position.clone(),V=new Float32Array(rt.values.length);for(let ct=0;ct<rt.values.length;ct+=3)V[ct]=De.x+(rt.values[ct]-Me.x)*D,V[ct+1]=De.y+(rt.values[ct+1]-Me.y)*D,V[ct+2]=De.z+(rt.values[ct+2]-Me.z)*D;Ee.push(new Ar(`${fe.name}.position`,rt.times,V))}}return console.log(`[RETARGET] ${Ee.length} tracks, ${Se} frames`),new oo("retargeted",s.duration,Ee)}window.addEventListener("DOMContentLoaded",()=>{const r=document.getElementById("theatre-canvas");if(!r){console.error("theatre-canvas not found");return}const{scene:e,camera:t,renderer:n,controls:i,lights:s,lightIcons:a,transformControls:l}=OC(r);window.scene=e,window.lights=s,window.lightIcons=a,window.transformControls=l,window.activeMixer=null,window.isPlaying=!1,window.currentTime=0,window.animDuration=1;const u=new Qg,h=new mt;let f=null,p=null;const m=[];let g=null,x=null,E=null,v=null,_=null,R=!1;function A(z,J){const ie={};for(const tt of z.bones)ie[tt.name]=tt;const _e=[],Ze={};let Ce=null;for(const tt of J.bone_names){const vt=new Vl;vt.name=tt.replace(/\./g,"_"),_e.push(vt),Ze[tt]=vt}for(let tt=0;tt<J.bone_names.length;tt++){const vt=J.bone_names[tt],At=_e[tt],Ft=ie[vt];if(!Ft)continue;const Xe=Ft.local_position;At.position.set(Xe[0],Xe[2],-Xe[1]);const We=Ft.local_quaternion;At.quaternion.set(We[1],We[3],-We[2],We[0]),Ft.parent&&Ze[Ft.parent]?Ze[Ft.parent].add(At):Ce||(Ce=At)}for(let tt=0;tt<_e.length;tt++){const vt=J.bone_names[tt],At=ie[vt];At&&!At.parent&&_e[tt]!==Ce&&Ce&&Ce.add(_e[tt])}return!Ce&&_e.length>0&&(Ce=_e[0]),Ce.updateWorldMatrix(!0,!0),{skeleton:new ra(_e),rootBone:Ce,bones:_e,boneByName:Ze}}async function S(){return E||(E=(async()=>{var z;try{const[J,ie]=await Promise.all([fetch("/api/character/def-skeleton/"),fetch("/api/character/skin-weights/")]);J.ok&&(g=await J.json()),ie.ok&&(x=await ie.json()),console.log("✓ Loaded skeleton and skin weights:",((z=g==null?void 0:g.bones)==null?void 0:z.length)||0,"bones"),g&&x&&(v=A(g,x),console.log("✓ Built defSkeleton:",v.bones.length,"bones"),window.defSkeletonData=g,window.defSkeleton=v);for(const _e of m)_e.userData.isSkinnedMesh||k(_e)}catch(J){console.warn("Failed to load skeleton/weights:",J)}})(),E)}S();function k(z){g&&x&&!z.userData.isSkinnedMesh&&setTimeout(()=>{try{O(z,e),console.log("✓ Auto-converted to SkinnedMesh:",z.userData.presetName)}catch(J){console.warn("Auto-convert failed:",J)}},100)}function N(z,J,ie,_e){const Ce=new n_().parse(z);if(!g)throw console.error("DEF skeleton data not loaded - cannot retarget animation"),new Error("Skeleton data not loaded");if(!J||!J.skeleton)throw console.error("SkinnedMesh has no skeleton"),new Error("SkinnedMesh not properly initialized");if(!J.skeleton.bones||J.skeleton.bones.length===0)throw console.error("SkinnedMesh skeleton has no bones"),new Error("Skeleton has no bones");const ot={skeleton:J.skeleton,rootBone:J.skeleton.bones[0],bones:J.skeleton.bones,boneByName:{}};for(const Xe of J.skeleton.bones)ot.boneByName[Xe.name]=Xe;const tt=VD(Ce,ot,_e||Ce.clip.name);if(!tt||tt.tracks.length===0)throw console.error("Retargeting failed - no tracks generated"),new Error("Retargeting failed");const vt=new Zg(J),At=vt.clipAction(tt);At.setLoop(gd),At.play(),At.paused=!0;const Ft=tt.duration||1;return console.log("✓ BVH animation retargeted and loaded on SkinnedMesh:",_e,Ft+"s",tt.tracks.length,"tracks"),{mixer:vt,action:At,duration:Ft}}function O(z,J){if(!g||!x)return console.warn("Cannot convert to SkinnedMesh: skeleton/weights not loaded"),null;if(z.userData.isSkinnedMesh)return console.log("Already a SkinnedMesh"),z.userData.skinnedMesh;const ie=z.children.find(We=>We.isMesh&&!We.userData.isHair&&!We.userData.isGarment);if(!ie)return console.warn("No body mesh found in character group"),null;console.log("Converting to SkinnedMesh...");const _e=ie.geometry.clone(),Ze=_e.attributes.position.count,Ce=new Float32Array(Ze*4),ot=new Float32Array(Ze*4);for(let We=0;We<Ze;We++){const Ct=(x.weights[We]||[]).slice().sort((nt,Rn)=>Rn[1]-nt[1]).slice(0,4);let Nt=Ct.reduce((nt,Rn)=>nt+Rn[1],0);Nt<1e-6&&(Nt=1);for(let nt=0;nt<4;nt++)Ce[We*4+nt]=nt<Ct.length?Ct[nt][0]:0,ot[We*4+nt]=nt<Ct.length?Ct[nt][1]/Nt:0}_e.setAttribute("skinIndex",new en(Ce,4)),_e.setAttribute("skinWeight",new en(ot,4)),v||(v=A(g,x));const tt=ie.material,vt=ie.position.clone(),At=ie.rotation.clone(),Ft=ie.scale.clone(),Xe=new Gg(_e,tt);return Xe.position.copy(vt),Xe.rotation.copy(At),Xe.scale.copy(Ft),Xe.castShadow=!0,Xe.receiveShadow=!0,Xe.add(v.rootBone),Xe.bind(v.skeleton),z.remove(ie),z.add(Xe),z.userData.isSkinnedMesh=!0,z.userData.skinnedMesh=Xe,z.userData.skeleton=v.skeleton,z.userData.rootBone=v.rootBone,console.log("✓ SkinnedMesh created:","bones:",v.skeleton.bones.length,"skinIndex:",!!_e.attributes.skinIndex,"skinWeight:",!!_e.attributes.skinWeight),window.loadedCharacters=window.loadedCharacters||[],window.loadedCharacters.includes(z)||window.loadedCharacters.push(z),Xe}r.addEventListener("click",z=>{const J=r.getBoundingClientRect();h.x=(z.clientX-J.left)/J.width*2-1,h.y=-((z.clientY-J.top)/J.height)*2+1,u.setFromCamera(h,t);const ie=[a.spotLeftIcon,a.spotRightIcon,a.backLightIcon],_e=u.intersectObjects(ie,!0);if(_e.length>0){let Ce=_e[0].object;for(;Ce.parent&&!Ce.userData.light;)Ce=Ce.parent;if(Ce.userData.light){f=Ce,p=null,l.attach(Ce),console.log("✓ Licht ausgewählt:",Ce.userData.light),kt(Ce.userData.light);return}}const Ze=u.intersectObjects(m,!0);if(Ze.length>0){const Ce=Ze[0].object;if(Ce.userData.isGarment){p=null,f=null,l.attach(Ce),console.log("✓ Garment ausgewählt:",Ce.name),W(Ce);return}let ot=Ce;for(;ot.parent&&!ot.userData.isCharacter;)ot=ot.parent;if(ot.userData.isCharacter){p=ot,f=null,l.attach(ot),console.log("✓ Character ausgewählt:",ot.userData.presetName),Ae(ot);return}}l.detach(),f=null,p=null,Ie()});const{sheet:H}=BC();kC(H,t),El(H,"Spot Left",s.spotLeft),El(H,"Spot Right",s.spotRight),El(H,"Back Light",s.backLight);const D=new PD(n.domElement);let w=null,U=null;const Q=new eC;document.querySelectorAll(".menu-item").forEach(z=>{const J=z.querySelector(".menu-dropdown");J&&(z.addEventListener("click",ie=>{ie.stopPropagation(),document.querySelectorAll(".menu-item").forEach(_e=>_e.classList.remove("active")),z.classList.toggle("active")}),J.addEventListener("click",ie=>{ie.stopPropagation()}))}),document.addEventListener("click",()=>{document.querySelectorAll(".menu-item").forEach(z=>z.classList.remove("active"))}),document.querySelectorAll("[data-preset]").forEach(z=>{z.addEventListener("click",()=>{const J=z.getAttribute("data-preset"),ie=fh[J];ie?(ph(ie,t,s,i),console.log("✓ Applied preset:",ie.name),document.querySelectorAll(".menu-item").forEach(_e=>_e.classList.remove("active"))):console.error("Preset not found:",J)})}),document.querySelectorAll(".panel-tab").forEach(z=>{z.addEventListener("click",()=>{const J=z.getAttribute("data-tab");document.querySelectorAll(".panel-tab").forEach(_e=>_e.classList.remove("active")),document.querySelectorAll(".tab-pane").forEach(_e=>_e.classList.remove("active")),z.classList.add("active");const ie=document.getElementById(J);ie&&ie.classList.add("active")})});const Z=document.getElementById("btn-translate-mode"),re=document.getElementById("btn-rotate-mode"),le=document.getElementById("btn-toggle-lights");Z&&Z.addEventListener("click",()=>{l.setMode("translate"),Z.classList.add("active"),re.classList.remove("active")}),re&&re.addEventListener("click",()=>{l.setMode("rotate"),re.classList.add("active"),Z.classList.remove("active")});let X=!0;le&&le.addEventListener("click",()=>{X=!X,Object.values(a).forEach(z=>{z.visible=X}),X?le.classList.add("active"):le.classList.remove("active")});const de=document.getElementById("btn-toggle-model");let te=!0;de&&de.addEventListener("click",()=>{te=!te,e.traverse(z=>{z.isMesh&&!z.userData.isGarment&&!z.userData.isHair&&!z.userData.isRig&&(z.visible=te)}),de.classList.toggle("active",te)});const ve=document.getElementById("btn-toggle-clothes");let Se=!0;ve&&ve.addEventListener("click",()=>{Se=!Se,e.traverse(z=>{z.isMesh&&(z.userData.isGarment||z.userData.isHair)&&(z.visible=Se)}),ve.classList.toggle("active",Se)});const Be=document.getElementById("btn-toggle-rig");Be&&Be.addEventListener("click",()=>{R=!R,R?(!_&&v&&(_=new Jg(v.rootBone),_.material.depthTest=!1,_.material.depthWrite=!1,_.material.color.set(65450),_.material.linewidth=2,_.renderOrder=999,e.add(_),console.log("✓ SkeletonHelper created")),_&&(_.visible=!0)):_&&(_.visible=!1),Be.classList.toggle("active",R)});const je=document.getElementById("btn-play-animation");je&&je.addEventListener("click",()=>{const z=document.getElementById("btnPlayPause");z&&z.click()});function Tt(z){const J=document.getElementById(z);J&&(J.style.display="flex")}function ue(z){const J=document.getElementById(z);J&&(J.style.display="none")}document.querySelectorAll("[data-close-modal]").forEach(z=>{z.addEventListener("click",()=>{var J;(J=z.closest(".theatre-modal-overlay"))==null||J.style.removeProperty("display")})}),document.querySelectorAll(".theatre-modal-overlay").forEach(z=>{z.addEventListener("click",J=>{J.target===z&&z.style.removeProperty("display")})});const ge=document.getElementById("menu-scene-load");ge&&ge.addEventListener("click",async()=>{const z=document.getElementById("scene-list-body");z.innerHTML='<div class="loading-msg">Lade Scenes...</div>',Tt("modal-scene-load");try{const J=await CD();if(J.length===0){z.innerHTML='<div class="loading-msg">Keine Scenes gefunden.</div>';return}z.innerHTML="";for(const ie of J){const _e=document.createElement("div");_e.style.cssText="padding:10px 14px;border-radius:6px;cursor:pointer;color:#ccc;font-size:0.85rem;",_e.innerHTML=`<span>${ie.label||ie.name}</span>`,_e.addEventListener("click",()=>ke(ie.name)),_e.addEventListener("mouseenter",()=>_e.style.background="rgba(124, 92, 191, 0.2)"),_e.addEventListener("mouseleave",()=>_e.style.background=""),z.appendChild(_e)}}catch(J){z.innerHTML=`<div class="loading-msg">Fehler: ${J.message}</div>`}});async function ke(z){ue("modal-scene-load");try{const J=await DD(z);if(console.log("Scene loaded:",z,J),J.characters&&Array.isArray(J.characters))for(const ie of J.characters){const _e=await dh(e,ie,ie.name||z);_e.userData.isCharacter=!0,_e.userData.presetName=ie.name||z,_e.userData.bodyType=ie.body_type||"Unknown",m.push(_e),k(_e)}}catch(J){console.error("Scene load error:",J),alert("Scene laden fehlgeschlagen: "+J.message)}}const Ee=document.getElementById("menu-scene-save"),Ye=document.getElementById("scene-save-btn"),at=document.getElementById("scene-save-name");Ee&&Ee.addEventListener("click",()=>{Tt("modal-scene-save"),at&&(at.value="",at.focus())}),Ye&&at&&(Ye.addEventListener("click",async()=>{const z=at.value.trim();if(z){Ye.disabled=!0,Ye.textContent="Speichere...";try{const J={camera:{position:t.position.toArray(),fov:t.fov,target:i.target.toArray()},lights:{spotLeft:{position:s.spotLeft.position.toArray(),intensity:s.spotLeft.intensity,color:"#"+s.spotLeft.color.getHexString()},spotRight:{position:s.spotRight.position.toArray(),intensity:s.spotRight.intensity,color:"#"+s.spotRight.color.getHexString()},backLight:{position:s.backLight.position.toArray(),intensity:s.backLight.intensity,color:"#"+s.backLight.color.getHexString()}},characters:[]},ie=await ID(z,J);console.log("Scene saved:",ie),ue("modal-scene-save")}catch(J){console.error("Scene save error:",J),alert("Scene speichern fehlgeschlagen: "+J.message)}Ye.disabled=!1,Ye.textContent="Speichern"}}),at.addEventListener("keydown",z=>{z.key==="Enter"&&Ye.click()}));const rt=document.getElementById("model-list"),fe=document.getElementById("menu-model-load");async function Me(){try{const z=await LD();if(z.length===0){rt.innerHTML='<div style="padding:12px;color:var(--text-muted);font-size:0.8rem;">Keine Modelle gefunden.</div>';return}rt.innerHTML="";for(const J of z){const ie=document.createElement("div");ie.className="anim-item",ie.textContent=J.label||J.name,ie.addEventListener("click",async()=>{try{const _e=await cg(J.name),Ze=await dh(e,_e,J.name);Ze.userData.isCharacter=!0,Ze.userData.presetName=J.name,Ze.userData.bodyType=_e.body_type||"Unknown",m.push(Ze),k(Ze),console.log("Model loaded:",J.name),document.querySelectorAll("#model-list .anim-item").forEach(Ce=>Ce.classList.remove("active")),ie.classList.add("active")}catch(_e){console.error("Model load error:",_e),alert("Modell laden fehlgeschlagen: "+_e.message)}}),rt.appendChild(ie)}}catch(z){rt.innerHTML=`<div style="padding:12px;color:#e74c3c;font-size:0.8rem;">Fehler: ${z.message}</div>`}}Me(),fe&&fe.addEventListener("click",()=>{document.querySelectorAll(".panel-tab").forEach(ie=>ie.classList.remove("active")),document.querySelectorAll(".tab-pane").forEach(ie=>ie.classList.remove("active"));const z=document.querySelector('[data-tab="tab-models"]'),J=document.getElementById("tab-models");z&&z.classList.add("active"),J&&J.classList.add("active")});const De=document.getElementById("anim-tree");async function V(){try{const z=await FD(),J=Object.keys(z);if(J.length===0){De.innerHTML='<div style="padding:12px;color:var(--text-muted);font-size:0.8rem;">Keine Animationen gefunden.</div>';return}De.innerHTML="";for(const ie of J){const _e=z[ie],Ze=document.createElement("div");Ze.className="anim-cat";const Ce=document.createElement("div");Ce.className="anim-cat-header",Ce.innerHTML=`<i class="fas fa-chevron-right"></i> ${ie} (${_e.length})`,Ce.addEventListener("click",()=>{Ze.classList.toggle("open")}),Ze.appendChild(Ce);const ot=document.createElement("div");ot.className="anim-cat-body";for(const tt of _e){const vt=document.createElement("div");vt.className="anim-item",vt.textContent=tt.name,vt.addEventListener("click",async()=>{await ct(tt.category,tt.name),document.querySelectorAll("#anim-tree .anim-item").forEach(At=>At.classList.remove("active")),vt.classList.add("active")}),ot.appendChild(vt)}Ze.appendChild(ot),De.appendChild(Ze)}}catch(z){De.innerHTML=`<div style="padding:12px;color:#e74c3c;font-size:0.8rem;">Fehler: ${z.message}</div>`}}async function ct(z,J){try{const ie=await ND(z,J);let _e=null;p&&(_e=O(p,e));const{mixer:Ze,action:Ce,duration:ot}=_e?N(ie,_e,e,`${z}/${J}`):RD(ie,e,`${z}/${J}`);w&&w.stopAllAction(),w=Ze,U=Ce,window.activeMixer=w,qe(ot),Pe=!1,gt=0,ye=ot,window.isPlaying=!1,window.currentTime=0,window.animDuration=ot,Ue(),console.log("Animation loaded:",z,J,ot)}catch(ie){console.error("Animation load error:",ie),alert("Animation laden fehlgeschlagen: "+ie.message)}}V();const st=document.getElementById("menu-add-glb"),$e=document.getElementById("glb-file-input");st&&$e&&(st.addEventListener("click",()=>$e.click()),$e.addEventListener("change",async()=>{const z=$e.files[0];if(z){try{await ED(z,e)}catch(J){console.error("GLB load error:",J),alert("Fehler beim Laden der GLB-Datei: "+J.message)}$e.value=""}})),document.querySelectorAll("[data-preset]").forEach(z=>{z.addEventListener("click",()=>{const J=z.getAttribute("data-preset"),ie=fh[J];ie?(ph(ie,t,s,i),console.log("✓ Applied preset:",ie.name)):console.error("Preset not found:",J)})});const ze=document.getElementById("menu-add-light");let dt=0;ze&&ze.addEventListener("click",()=>{dt++;const z=new $g(16777215,1,15);z.position.set((Math.random()-.5)*6,2+Math.random()*3,(Math.random()-.5)*6),e.add(z);const J=new Re(new sa(.08,8,8),new pi({color:16776960}));z.add(J),El(H,`Light ${dt}`,z)});const He=document.getElementById("menu-export-video");He&&He.addEventListener("click",async()=>{D.isRecording?(He.innerHTML='<i class="fas fa-file-video"></i> Export Video',await D.stopAndDownload()):(D.start(30),He.innerHTML='<i class="fas fa-stop"></i> Stop Recording')});const L=document.getElementById("btnPlayPause"),T=document.getElementById("btnStop"),K=document.getElementById("btnFrameBack"),ce=document.getElementById("btnFrameFwd"),pe=document.getElementById("timelineSlider"),he=document.getElementById("timeCurrent"),Ge=document.getElementById("timeDuration"),we=document.getElementById("playIcon");let Pe=!1,gt=0,ye=1,Ve=1;function qe(z){ye=z||1,Ge.textContent=ut(ye),pe.max=ye}function ut(z){const J=Math.floor(z/60),ie=Math.floor(z%60);return`${String(J).padStart(2,"0")}:${String(ie).padStart(2,"0")}`}function Ue(){he.textContent=ut(gt),pe.value=gt,we&&(we.className=Pe?"fas fa-pause":"fas fa-play")}function St(z){!w||!U||(gt=Math.max(0,Math.min(z,ye)),U.time=gt,w.update(0),Ue())}L&&L.addEventListener("click",()=>{w&&(Pe=!Pe,window.isPlaying=Pe,Pe&&U?(U.paused=!1,U.play()):U&&(U.paused=!0),Ue())}),T&&T.addEventListener("click",()=>{w&&(Pe=!1,gt=0,St(0),U&&(U.stop(),U.paused=!0),Ue())}),K&&K.addEventListener("click",()=>{St(gt-1/30)}),ce&&ce.addEventListener("click",()=>{St(gt+1/30)}),pe&&(pe.addEventListener("mousedown",()=>{}),pe.addEventListener("mouseup",()=>{}),pe.addEventListener("input",()=>{const z=parseFloat(pe.value);St(z)})),document.querySelectorAll(".speed-btn").forEach(z=>{z.addEventListener("click",()=>{const J=parseFloat(z.getAttribute("data-speed"));Ve=J,w&&(w.timeScale=J),document.querySelectorAll(".speed-btn").forEach(ie=>ie.classList.remove("active")),z.classList.add("active")})}),document.addEventListener("keydown",z=>{z.target.tagName!=="INPUT"&&(z.code==="Space"?(z.preventDefault(),L&&L.click()):z.code==="ArrowLeft"?(z.preventDefault(),K&&K.click()):z.code==="ArrowRight"&&(z.preventDefault(),ce&&ce.click()))});async function xt(){try{const z=await fetch("/api/settings/theatre/");if(!z.ok)return;const J=await z.json();if(J.preset){const ie=fh[J.preset];ie&&(ph(ie,t,s,i),console.log("✓ Auto-applied preset:",ie.name))}if(J.model)try{const ie=await cg(J.model),_e=await dh(e,ie,J.model);if(_e.userData.isCharacter=!0,_e.userData.presetName=J.model,_e.userData.bodyType=ie.body_type||"Unknown",m.push(_e),k(_e),console.log("✓ Auto-loaded model:",J.model),J.animation){const[Ze,Ce]=J.animation.split("/");Ze&&Ce&&(await ct(Ze,Ce),console.log("✓ Auto-loaded animation:",J.animation))}}catch(ie){console.warn("Auto-load model/animation failed:",ie)}}catch(z){console.warn("Failed to load Theatre defaults:",z)}}setTimeout(xt,500);function kt(z){document.querySelectorAll(".panel-tab").forEach(Nt=>Nt.classList.remove("active")),document.querySelectorAll(".tab-pane").forEach(Nt=>Nt.classList.remove("active"));const J=document.querySelector('[data-tab="tab-properties"]'),ie=document.getElementById("tab-properties");J&&J.classList.add("active"),ie&&ie.classList.add("active");const _e=document.getElementById("properties-content");if(!_e)return;const Ze=z===s.spotLeft?"Spot Left":z===s.spotRight?"Spot Right":z===s.backLight?"Back Light":"Light",Ce="#"+z.color.getHexString();_e.innerHTML=`
        ...
        `;const ot=document.getElementById("light-intensity"),tt=document.getElementById("light-intensity-value"),vt=document.getElementById("light-color"),At=document.getElementById("light-pos-x"),Ft=document.getElementById("light-pos-y"),Xe=document.getElementById("light-pos-z");if(ot&&(ot.oninput=Nt=>{z.intensity=parseFloat(Nt.target.value),tt.textContent=z.intensity.toFixed(1)}),vt&&(vt.oninput=Nt=>{z.color.setHex(parseInt(Nt.target.value.substring(1),16)),f&&f.children.forEach(nt=>{nt.material&&(nt.material.color.copy(z.color),nt.material.emissive&&nt.material.emissive.copy(z.color))})}),At&&Ft&&Xe){const Nt=()=>{z.position.set(parseFloat(At.value),parseFloat(Ft.value),parseFloat(Xe.value)),f&&(f.position.copy(z.position),f.lookAt(z.target.position))};At.oninput=Nt,Ft.oninput=Nt,Xe.oninput=Nt}const We=document.getElementById("light-rot-x"),Kt=document.getElementById("light-rot-y"),Ct=document.getElementById("light-rot-z");if(We&&Kt&&Ct){const Nt=()=>{z.rotation.set(parseFloat(We.value)*Math.PI/180,parseFloat(Kt.value)*Math.PI/180,parseFloat(Ct.value)*Math.PI/180),f&&f.rotation.copy(z.rotation)};We.oninput=Nt,Kt.oninput=Nt,Ct.oninput=Nt}}function W(z){document.querySelectorAll(".panel-tab").forEach(nt=>nt.classList.remove("active")),document.querySelectorAll(".tab-pane").forEach(nt=>nt.classList.remove("active"));const J=document.querySelector('[data-tab="tab-properties"]'),ie=document.getElementById("tab-properties");J&&J.classList.add("active"),ie&&ie.classList.add("active");const _e=document.getElementById("properties-content");if(!_e)return;const Ze=z.userData.garmentId||z.name||"Garment",Ce=z.material,tt="#"+Ce.color.getHexString(),vt=Ce.roughness??.8,At=Ce.metalness??0,Ft=z.userData.offset||.006,Xe=z.userData.stiffness||.8;_e.innerHTML=`
            <div style="padding:16px;max-height:calc(100vh - 200px);overflow-y:auto;">
                <h3 style="font-size:0.9rem;margin-bottom:16px;color:var(--accent-purple);border-bottom:1px solid var(--border);padding-bottom:8px;">
                    <i class="fas fa-tshirt"></i> ${Ze}
                </h3>
                ...
                <div class="slider-row"><label>Offset</label>
                    <input type="range" id="garment-offset" min="0" max="30" value="${Math.round(Ft*1e3)}" step="1">
                    <span class="slider-val" id="garment-offset-val">${Ft.toFixed(3)}</span>
                </div>
                <div class="slider-row"><label>Stiffness</label>
                    <input type="range" id="garment-stiffness" min="0" max="100" value="${Math.round(Xe*100)}" step="1">
                    <span class="slider-val" id="garment-stiffness-val">${Xe.toFixed(2)}</span>
                </div>
                ...
                <div class="slider-row"><label>Color</label>
                    <input type="color" id="garment-color" value="${tt}" style="width:40px;height:24px;border:none;cursor:pointer;">
                </div>
                <div class="slider-row"><label>Roughness</label>
                    <input type="range" id="garment-roughness" min="0" max="100" value="${Math.round(vt*100)}" step="1">
                    <span class="slider-val" id="garment-roughness-val">${vt.toFixed(2)}</span>
                </div>
                <div class="slider-row"><label>Metalness</label>
                    <input type="range" id="garment-metalness" min="0" max="100" value="${Math.round(At*100)}" step="1">
                    <span class="slider-val" id="garment-metalness-val">${At.toFixed(2)}</span>
                </div>
        ...
        `;const We=(nt,Rn,mi)=>{const P=document.getElementById(nt),j=document.getElementById(Rn);P&&j&&(P.oninput=()=>{j.textContent=mi?mi(P.value):P.value})};We("garment-offset","garment-offset-val",nt=>(nt/1e3).toFixed(3)),We("garment-stiffness","garment-stiffness-val",nt=>(nt/100).toFixed(2)),We("garment-min-dist","garment-min-dist-val",nt=>nt+" mm"),We("garment-crotch-floor","garment-crotch-floor-val",nt=>nt+" mm"),We("garment-lift","garment-lift-val",nt=>nt+" mm"),We("garment-crotch-depth","garment-crotch-depth-val",nt=>nt+" mm"),We("garment-roughness","garment-roughness-val",nt=>(nt/100).toFixed(2)),We("garment-metalness","garment-metalness-val",nt=>(nt/100).toFixed(2)),We("garment-pos-x","garment-pos-x-val",nt=>(nt/100).toFixed(2)+" m"),We("garment-pos-y","garment-pos-y-val",nt=>(nt/100).toFixed(2)+" m"),We("garment-pos-z","garment-pos-z-val",nt=>(nt/100).toFixed(2)+" m"),We("garment-scale-x","garment-scale-x-val",nt=>(nt/100).toFixed(2)),We("garment-scale-y","garment-scale-y-val",nt=>(nt/100).toFixed(2)),We("garment-scale-z","garment-scale-z-val",nt=>(nt/100).toFixed(2));for(const nt of["top","upper","mid","lower","bottom"])We(`garment-region-${nt}`,`garment-region-${nt}-val`,Rn=>(Rn/100).toFixed(2)+" m");const Kt=document.getElementById("garment-color");Kt&&(Kt.oninput=()=>{Ce.color.setHex(parseInt(Kt.value.substring(1),16))});const Ct=document.getElementById("garment-roughness");Ct&&(Ct.oninput=()=>{Ce.roughness=parseInt(Ct.value)/100});const Nt=document.getElementById("garment-metalness");Nt&&(Nt.oninput=()=>{Ce.metalness=parseInt(Nt.value)/100}),console.log("✓ Garment properties panel populated")}function Ae(z){document.querySelectorAll(".panel-tab").forEach(Ct=>Ct.classList.remove("active")),document.querySelectorAll(".tab-pane").forEach(Ct=>Ct.classList.remove("active"));const J=document.querySelector('[data-tab="tab-properties"]'),ie=document.getElementById("tab-properties");J&&J.classList.add("active"),ie&&ie.classList.add("active");const _e=document.getElementById("properties-content");if(!_e)return;const Ze=z.userData.presetName||"Character",Ce=z.userData.bodyType||"Unknown",ot=z.position,tt=z.rotation;_e.innerHTML=`
            <div style="padding:16px;">
                <h3 style="font-size:0.9rem;margin-bottom:16px;color:var(--accent-purple);border-bottom:1px solid var(--border);padding-bottom:8px;">
                    <i class="fas fa-user"></i> ${Ze}
                </h3>
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:6px;font-size:0.75rem;">
                        <div>
                            <span style="color:var(--text-muted);">X:</span>
                            <input type="number" id="char-rot-x" value="${(tt.x*180/Math.PI).toFixed(1)}" step="5"
                                   style="width:100%;padding:4px;background:var(--bg-primary);border:1px solid var(--border);border-radius:4px;color:var(--text);" />
                        </div>
                        <div>
                            <span style="color:var(--text-muted);">Y:</span>
                            <input type="number" id="char-rot-y" value="${(tt.y*180/Math.PI).toFixed(1)}" step="5"
                                   style="width:100%;padding:4px;background:var(--bg-primary);border:1px solid var(--border);border-radius:4px;color:var(--text);" />
                        </div>
                        <div>
                            <span style="color:var(--text-muted);">Z:</span>
                            <input type="number" id="char-rot-z" value="${(tt.z*180/Math.PI).toFixed(1)}" step="5"
                                   style="width:100%;padding:4px;background:var(--bg-primary);border:1px solid var(--border);border-radius:4px;color:var(--text);" />
                        </div>
                    </div>
                </div>
        ...
        `;const vt=document.getElementById("char-pos-x"),At=document.getElementById("char-pos-y"),Ft=document.getElementById("char-pos-z");if(vt&&At&&Ft){const Ct=()=>{z.position.set(parseFloat(vt.value),parseFloat(At.value),parseFloat(Ft.value))};vt.oninput=Ct,At.oninput=Ct,Ft.oninput=Ct}const Xe=document.getElementById("char-rot-x"),We=document.getElementById("char-rot-y"),Kt=document.getElementById("char-rot-z");if(Xe&&We&&Kt){const Ct=()=>{z.rotation.set(parseFloat(Xe.value)*Math.PI/180,parseFloat(We.value)*Math.PI/180,parseFloat(Kt.value)*Math.PI/180)};Xe.oninput=Ct,We.oninput=Ct,Kt.oninput=Ct}ae(z),Fe(z)}function ae(z){const J=document.getElementById("meta-sliders-container");if(!J)return;const ie={age:{min:-1,max:1,label:"Alter",step:.01},mass:{min:-1,max:1,label:"Gewicht",step:.01},tone:{min:-1,max:1,label:"Muskeltonus",step:.01},height:{min:-1,max:1,label:"Höhe",step:.01}},_e=z.userData.meta||{age:0,mass:0,tone:0,height:0};let Ze="";for(const[Ce,ot]of Object.entries(ie)){const tt=_e[Ce]||0,vt=ot.min,At=ot.max;Ze+=`
                <div style="margin-bottom:12px;">
                    <div style="display:flex;justify-content:space-between;margin-bottom:4px;font-size:0.75rem;">
                        ...
                        <span id="meta-${Ce}-value" style="color:var(--text);">${tt.toFixed(2)}</span>
                    </div>
                    <input type="range" id="meta-${Ce}" min="${vt}" max="${At}" step="${ot.step}" value="${tt}"
                           style="width:100%;cursor:pointer;" />
                </div>
            `}J.innerHTML=Ze;for(const Ce of Object.keys(ie)){const ot=document.getElementById(`meta-${Ce}`),tt=document.getElementById(`meta-${Ce}-value`);ot&&tt&&(ot.oninput=async()=>{const vt=parseFloat(ot.value);tt.textContent=vt.toFixed(2),_e[Ce]=vt,z.userData.meta=_e,await me(z)})}}async function me(z){try{let At=function(Xe){const We=atob(Xe),Kt=new Uint8Array(We.length);for(let Ct=0;Ct<We.length;Ct++)Kt[Ct]=We.charCodeAt(Ct);return new Float32Array(Kt.buffer)};var J=At;const ie=new URLSearchParams;ie.set("body_type",z.userData.bodyType||"Female_Caucasian");const _e=z.userData.morphs||{};for(const[Xe,We]of Object.entries(_e))We!=null&&ie.set(`morph_${Xe}`,String(We));const Ze=z.userData.meta||{};for(const[Xe,We]of Object.entries(Ze))We!=null&&ie.set(`meta_${Xe}`,String(We));const Ce=`/api/character/mesh/?${ie.toString()}`,ot=await fetch(Ce);if(!ot.ok)throw new Error(`Character mesh API error: ${ot.status}`);const tt=await ot.json(),vt=z.children.find(Xe=>Xe.isMesh&&!Xe.userData.isHair&&!Xe.userData.isGarment);if(!vt){console.warn("Could not find body mesh to update");return}const Ft=At(tt.vertices);for(let Xe=0;Xe<Ft.length;Xe+=3){const We=Ft[Xe+1],Kt=Ft[Xe+2];Ft[Xe+1]=Kt,Ft[Xe+2]=-We}if(vt.geometry.attributes.position.array.set(Ft),vt.geometry.attributes.position.needsUpdate=!0,tt.normals){const Xe=At(tt.normals);for(let We=0;We<Xe.length;We+=3){const Kt=Xe[We+1],Ct=Xe[We+2];Xe[We+1]=Ct,Xe[We+2]=-Kt}vt.geometry.attributes.normal.array.set(Xe),vt.geometry.attributes.normal.needsUpdate=!0}else vt.geometry.computeVertexNormals();console.log("✓ Character mesh reloaded")}catch(ie){console.error("Failed to reload character mesh:",ie)}}function Fe(z){const J=document.getElementById("morph-sliders-container");if(!J)return;const ie=z.userData.morphs||{};if(Object.keys(ie).length===0){J.innerHTML='<div style="font-size:0.75rem;color:var(--text-muted);text-align:center;padding:10px;">Keine Morphs</div>';return}let _e='<div style="max-height:300px;overflow-y:auto;padding-right:4px;">';for(const[Ze,Ce]of Object.entries(ie)){const ot=Ce||0;_e+=`
                <div style="margin-bottom:12px;">
                    <div style="display:flex;justify-content:space-between;margin-bottom:4px;font-size:0.75rem;">
                        <span style="color:var(--text-muted);">${Ze}</span>
                        <span id="morph-${Ze}-value" style="color:var(--text);">${ot.toFixed(2)}</span>
                    </div>
                    <input type="range" id="morph-${Ze}" min="0" max="1" step="0.01" value="${ot}"
                           style="width:100%;cursor:pointer;" />
                </div>
            `}_e+="</div>",J.innerHTML=_e;for(const Ze of Object.keys(ie)){const Ce=document.getElementById(`morph-${Ze}`),ot=document.getElementById(`morph-${Ze}-value`);Ce&&ot&&(Ce.oninput=async()=>{const tt=parseFloat(Ce.value);ot.textContent=tt.toFixed(2),ie[Ze]=tt,z.userData.morphs=ie,await me(z)})}}function Ie(){const z=document.getElementById("properties-content");z&&(z.innerHTML=`
        ...
        `)}function _t(){requestAnimationFrame(_t);const z=Q.getDelta();if(w&&Pe&&(w.update(z*Ve),gt=U?U.time:0,gt>=ye&&(gt=0,U&&(U.time=0)),Ue()),f&&f.userData.light){const J=f.userData.light;J.position.copy(f.position),f.lookAt(J.target.position)}i.update(),n.render(e,t)}_t()});
