...
`)+`
`+_);const w=A+v+a,b=A+_+c,k=pm(i,i.VERTEX_SHADER,w),U=pm(i,i.FRAGMENT_SHADER,b);i.attachShader(E,k),i.attachShader(E,U),t.index0AttributeName!==void 0?i.bindAttribLocation(E,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(E,0,"position"),i.linkProgram(E);function O(H){if(r.debug.checkShaderErrors){const J=i.getProgramInfoLog(E).trim(),ee=i.getShaderInfoLog(k).trim(),se=i.getShaderInfoLog(U).trim();let he=!0,q=!0;if(i.getProgramParameter(E,i.LINK_STATUS)===!1)if(he=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,E,k,U);else{const de=gm(i,k,"vertex"),ie=gm(i,U,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(E,i.VALIDATE_STATUS)+`
