...
<p>Die BVH Bibliothek links zeigt alle BVH-Dateien gruppiert nach Ordnern. Animationen können per <b>Doppelklick</b>
    oder <b>Drag &amp; Drop</b> zum ausgewählten Track hinzugefügt werden.</p>

<h4 class="hilfe-abschnitt">Bibliothek-Toolbar</h4>
<table class="hilfe-tabelle doku">
<tr class="hilfe-trennlinie"><td class="hilfe-zelle hilfe-mitte hilfe-schmal"><i
    class="fas fa-folder-plus"></i></td><td><b>Neuer Ordner</b> — Erstellt einen neuen Kategorie-Ordner</td></tr>
<tr class="hilfe-trennlinie"><td class="hilfe-zelle hilfe-mitte"><i
    class="fas fa-pen"></i></td><td><b>Umbenennen</b> — Benennt die ausgewählte Animation um</td></tr>
<tr class="hilfe-trennlinie"><td class="hilfe-zelle hilfe-mitte"><i
    class="fas fa-trash"></i></td><td><b>Löschen</b> — Löscht die ausgewählte Animation</td></tr>
<tr><td class="hilfe-zelle hilfe-mitte"><i
    class="fas fa-sync-alt"></i></td><td><b>Aktualisieren</b> — Lädt die Bibliothek neu</td></tr>
</table>
...
<ol>
<li><b>Szene vorbereiten:</b> Im Szenen-Editor ein generiertes Modell laden (z.B. <code>TriadischRock</code>) und eine
    BVH-Animation zuweisen (z.B. AIST <code>d01_mJS3_ch07</code>). Setze das Modell + die Animation ggf. als Default in
        <i>Einstellungen &rarr; Szene</i>.</li>
<li><b>Kleidungs-Bones markieren:</b> Im Szenen-Editor &rarr; Tab <b>Modell</b> pro Bone die Checkbox
    <b>&bdquo;Kleidungsst&uuml;ck&ldquo;</b>. Standard-aktiv bei <code>skirt</code>, <code>tutu</code>,
        <code>spiral_tutu</code>, <code>helix_ribbon</code>. Nur diese werden simuliert, der Rest bleibt rigid und
            dient als Kollisions-K&ouml;rper.</li>
...
<li><b>Engine-Button klicken:</b> einer der drei Buttons (Blender Cloth, Warp+Blender, Warp pur). Der Szenen-Editor
    wird automatisch in einem Popup ge&ouml;ffnet, die Sim + Render l&auml;uft, und die fertige MP4 wird nach Abschluss
        in einem neuen Tab ge&ouml;ffnet.</li>
<li>Die MP4 landet zus&auml;tzlich unter <code>media/cloth_exports/</code>.</li>
</ol>
<p class="hilfe-beispiel">
<b>Tipp:</b> Die Szenen-Popup bleibt offen — so kannst du zwischen den drei Engines vergleichen, ohne jedes Mal neu
    laden zu m&uuml;ssen.
</p>

<h4 class="hilfe-abschnitt hilfe-audio"><i class="fas fa-video"></i> Engine 1 &mdash; <code>blender_eevee</code></h4>
<p>Blender Cloth-Simulation (CPU) + EEVEE-Render (GPU). Stabilste Qualit&auml;t, keine CUDA n&ouml;tig f&uuml;r die
    Sim, nur f&uuml;r's Rendering.</p>
<ul>
...
<ul>
<li><b>Splitter:</b> Der merged-Body wird anhand <code>boneVertexRanges</code> + <code>is_garment</code>-Flag in
    Cloth-Segmente + Rigid-Collider aufgeteilt. Pro Cloth-Segment werden die obersten ~12% der Verts als
        <b>Pin-Group</b> bestimmt (folgen dem Bone-Head beim Tanz, statt frei zu fliegen).</li>
<li><b>Pipeline-Code:</b> <code>A:/3DTools/HumanBody/collision/</code></li>
<li><b>Server-Endpoint:</b> POST <code>/api/cloth/export/</code></li>
<li><b>Python-Envs:</b> Warp-Sim l&auml;uft in <code>A:/3DTools/python10</code> (braucht Python 3.10 + Warp 1.4.2
    f&uuml;r <code>warp.sim</code>). Django + pyrender in <code>A:/3DTools/python14</code>.</li>
<li><b>Qualit&auml;t-Stufen:</b> steuern Sim-Iterationen pro Frame sowie Render-Samples. <i>low</i> = 16 Substeps/32
    Samples, <i>medium</i> = 32/64, <i>high</i> = 64/128.</li>
</ul>

<h4 class="hilfe-abschnitt">Troubleshooting</h4>
<ul>
<li><b>&bdquo;warp_sim failed&ldquo;:</b> Warp braucht CUDA. Pr&uuml;fe <code>nvidia-smi</code>. Warp-Cache beim ersten
    Run &asymp; 20s Kompilierung normal.</li>
<li><b>&bdquo;blender not found&ldquo;:</b> Blender 5.0 muss unter <code>C:/Program Files/Blender Foundation/Blender
    5.0/</code> liegen.</li>
<li><b>Cloth klebt am K&ouml;rper:</b> Erh&ouml;he <i>quality</i> auf <code>high</code> oder erh&ouml;he den
    Bone-Radius.</li>
<li><b>Rock fliegt weg:</b> Pin-Group zu klein. Nur Bones mit genug Verts am Head funktionieren (Helix-Ribbon mit
    <code>spiralSkirt:true</code> ist ideal).</li>
</ul>
`},
};
