...
/**
 * MakehumanModell — der MakeHuman-Basiskörper (hm08), als `Modell` für jede Seite.
 *
 ...
 *
 * Seit 13.09.2026 in `gemeinsam/` (Edgar: „eine globale Klasse … die
 * Bauen-Methode implementieren"); die Szene erbt als `MakehumanModell` nur das Speichern.
 */
export class MakehumanModell extends Modell {
    ...
    constructor(id, daten = {}) {
        super(id, MakehumanModell.QUELLE);
        ...
        this.haut = { ...MakehumanModell.HAUT, ...(daten.haut || {}) };
    ...
    async koerperAufbauen() {
        ...
        Protokoll.debug('MakehumanModell',
     ...
     * animieren immer noch nicht"): `bauen()` zieht die Kleidung ZUERST an —
