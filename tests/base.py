...
class TestCase:
    ...
    def run(self):
        ...
        try:
            return Fallergebnis.aus_rueckgabe(self.fn(), self.name, self.description).als_dict()
        except Exception as fehler:  # noqa: BLE001
            # Absichtlich jede Ausnahme: Ein Fall darf den ganzen Lauf nicht
            # mitnehmen — sein Fehler ist sein Ergebnis.
            return Fallergebnis.aus_ausnahme(fehler, self.name, self.description).als_dict()
