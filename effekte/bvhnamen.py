# -*- coding: utf-8 -*-
"""Bvhnamen — die Gelenknamen einer VideoToBVH-Datei fuer den BVH-Retargeter.
...
class Bvhnamen:
    """Umbenennen und Kopfdaten (Bilder, Bildrate) einer BVH-Datei."""
    ...
    NAMEN = {
        ...
        'Neck': 'm_avg_Neck',
        'Head': 'm_avg_Head',
        'Left_collar': 'm_avg_L_Collar',
        'Left_shoulder': 'm_avg_L_Shoulder',
        'Left_elbow': 'm_avg_L_Elbow',
        'Left_wrist': 'm_avg_L_Wrist',
        'Left_palm': 'm_avg_L_Hand',
        'Right_collar': 'm_avg_R_Collar',
        'Right_shoulder': 'm_avg_R_Shoulder',
        'Right_elbow': 'm_avg_R_Elbow',
        'Right_wrist': 'm_avg_R_Wrist',
        'Right_palm': 'm_avg_R_Hand',
        'Left_hip': 'm_avg_L_Hip',
        'Left_knee': 'm_avg_L_Knee',
        'Left_ankle': 'm_avg_L_Ankle',
        'Left_foot': 'm_avg_L_Foot',
        'Right_hip': 'm_avg_R_Hip',
        'Right_knee': 'm_avg_R_Knee',
        'Right_ankle': 'm_avg_R_Ankle',
        'Right_foot': 'm_avg_R_Foot',
    }
    ...
    def bildrate(self):
        """Bilder je Sekunde, gerundet — 0.016667 s ergibt 60."""
