# -*- coding: utf-8 -*-
"""Figurparameter — die Stellgroessen der Pipeline „HumanBody-Figur (DEF-Skelett)".
...
class Figurparameter(Parametersatz):
    ...
    FELDER = (
        (
            ...
            2000,
            "Bilder",
            "Zahl der Videobilder; die BVH begrenzt sie (bei 30 fps sind 150 Bilder 5 Sekunden)",
        ),
        (
            "fps",
            int,
        ...
        (
            ...
            80.0,
            "Weichgewebe (mm)",
            "Velocity Skinning: höchster Zuschlag in Millimetern, 0 = aus (Hilfe → Körperphysik)",
        ),
        ("ab", float, 0.0, 0.0, 600.0, "Ab Sekunde", "Beginn in der BVH, in Sekunden"),
        ...
        (
            ...
            30.0,
            "Wind (m/s)",
            "Windgeschwindigkeit; die Kraft je Stoffpunkt ist der Staudruck auf seine Fläche. 0 = kein Wind",
        ),
        (
            "turbulenz",
            float,
            ...
            1.0,
            "Böen",
            "Anteil, um den die Windstärke schwankt (zeitlich und längs der Windrichtung)",
        ),
        (
            "dichte",
            float,
        ...
        (
            ...
            50.0,
            "Biegesteifigkeit",
            "Faktor auf die Biegesteifigkeit der Probe; höher = steifer Stoff, weniger kleine Falten",
        ),
        (
            "bund",
            float,
            ...
            30.0,
            "Fester Rand (cm)",
            "Das obere Band jedes Stücks folgt dem Körper starr (Bund, Schultern); darunter rechnet Newton",
        ),
        (
            "teilschritte",
            int,
            ...
            2,
            60,
            "Teilschritte je Bild",
            "Newton-Schritte je Videobild; 20 bei 30 fps sind 600 Schritte je Sekunde",
        ),
        ("iterationen", int, 10, 2, 40, "Löser-Iterationen", "Style3D-Iterationen je Teilschritt"),
        (
            "einlauf",
            float,
            0.5,
    ...
    def __init__(self, modell, bvh, ausgabe, windrichtung="seite", **werte):
        super().__init__(modell=modell, bvh=bvh, ausgabe=ausgabe, windrichtung=windrichtung, **werte)
